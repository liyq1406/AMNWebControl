...
public class AMN_PADDaoImp extends HibernateDaoSupport implements AMN_PADDao
{
//	@SuppressWarnings("unused")
//	@Resource(name="sessionFactory_PAD")
    private SessionFactory sessionFactory;

	private static Logger logger = Logger.getLogger(AMN_PADDaoImp.class.getName());
	...
	public AMN_PADDaoImp(){
	}
	
	public AMN_PADDaoImp( Class model ){
		this.model = model;
	}
