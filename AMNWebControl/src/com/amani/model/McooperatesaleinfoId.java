...
public class McooperatesaleinfoId  implements java.io.Serializable {
	...
	public McooperatesaleinfoId(String salecompid, String salebillid) {
         this.salecompid = salecompid;
         this.salebillid = salebillid;
     }
     public McooperatesaleinfoId() {
     }
