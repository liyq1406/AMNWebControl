...
public class DstaffrewardinfoId  implements java.io.Serializable {
	...
	public DstaffrewardinfoId(String entrycompid, String entrybillid ,double entryseqno) {
         this.entrycompid = entrycompid;
         this.entrybillid = entrybillid;
         this.entryseqno=entryseqno;
     }
     public DstaffrewardinfoId() {
     }
