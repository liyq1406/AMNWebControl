...
public class DstaffsubsidyinfoId  implements java.io.Serializable {
	...
	public DstaffsubsidyinfoId(String entrycompid, String entrybillid ,double entryseqno) {
         this.entrycompid = entrycompid;
         this.entrybillid = entrybillid;
         this.entryseqno=entryseqno;
     }
     public DstaffsubsidyinfoId() {
     }
