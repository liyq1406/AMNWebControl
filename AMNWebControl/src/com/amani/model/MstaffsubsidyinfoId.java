...
public class MstaffsubsidyinfoId  implements java.io.Serializable {
    ...
    // Fields    
     ...
     public MstaffsubsidyinfoId(String entrycompid, String entrybillid ) {
         this.entrycompid = entrycompid;
         this.entrybillid = entrybillid;
     }
     public MstaffsubsidyinfoId() {
     }
