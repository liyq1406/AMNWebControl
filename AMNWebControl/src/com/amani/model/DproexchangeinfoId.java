...
public class DproexchangeinfoId  implements java.io.Serializable {
    ...
    // Fields    
     ...
     public DproexchangeinfoId(String changecompid, String changebillid,double changeseqno ) {
         this.changecompid = changecompid;
         this.changebillid = changebillid;
         this.changeseqno=changeseqno;
     }
     public DproexchangeinfoId() {
     }
