...
@Service
public class PC008Service extends AMN_ReportService{
	
	public List<StaffWarkSalaryAnlanysis> loadDateSetByCompId(String strCompId,String strDateFrom,String strDateTo)
	{
		try
		{
			String strSql=" exec upg_prepare_ticheng_analysis_after '"+strCompId+"','"+strDateFrom+"','"+strDateTo+"' ";
				...
				public List<StaffWarkSalaryAnlanysis> anlyResultSet(ResultSet rs) {
					...
					try {
						while (rs != null && rs.next() == true) {
							...
							//record.setStrBackName(rs.getString("bankname"));
							//----------------应付工资Start 
