...
import com.amani.service.PersonnelControl.PC002Service;
import com.amani.tools.CommonTool;
import com.amani.tools.SystemFinal;
@Scope("prototype")
@ParentPackage("json-default")
@Namespace("/pc002")
public class PC002Action extends AMN_ModuleAction{
	@Autowired
	private PC002Service pc002Service;
	...
	public String loadDataSet() {
		...
		this.lsDataSet=this.pc002Service.loadDateSetByCompId(strCurCompId,CommonTool.setDateMask(strFromDate),CommonTool.setDateMask(strToDate),iSearchType,iSearchState,strCurStaffNo);
	...
	{
		this.strMessage="";
		if(this.pc002Service.getDataTool().hasSpecialRights(CommonTool.getLoginInfo("USERID"), "QX014")==false)
		{
		...
		boolean flag=this.pc002Service.handBill(strCompId, strBillId, iChangeType, 1,new StringBuffer());
		if(flag==false)
	...
	{
		this.strMessage="";
		if(this.pc002Service.getDataTool().hasSpecialRights(CommonTool.getLoginInfo("USERID"), "QX015")==false)
		{
			this.strMessage=SystemFinal.NO_OPERATE_RIGHT;
			return SystemFinal.POST_FAILURE;
		}
		this.checkEmpId=CommonTool.getLoginInfo("USERID");
		this.checkDate=CommonTool.getCurrDate();
		boolean flag=this.pc002Service.handBill(strCompId, strBillId, iChangeType, 2,new StringBuffer());
		if(flag==false)
			this.strMessage="操作失败!";
		return SystemFinal.POST_SUCCESS;
	}
	...
	{
		this.strMessage="";
		if(this.pc002Service.getDataTool().hasSpecialRights(CommonTool.getLoginInfo("USERID"), "QX016")==false)
		{
			this.strMessage=SystemFinal.NO_OPERATE_RIGHT;
			return SystemFinal.POST_FAILURE;
		}
		...
		boolean flag=this.pc002Service.handBill(strCompId, strBillId, iChangeType, 3,strBufMsg);
		this.strMessage=strBufMsg.toString();
		if(flag==false)
			this.strMessage="操作失败!";
		return SystemFinal.POST_SUCCESS;
	}
	...
	public String comfrimbackBill()
	{
		this.strMessage="";
		 if(this.pc002Service.getDataTool().hasSpecialRights(CommonTool.getLoginInfo("USERID"), "QX015")==false
		 && this.pc002Service.getDataTool().hasSpecialRights(CommonTool.getLoginInfo("USERID"), "QX016")==false)
		{
			this.strMessage=SystemFinal.NO_OPERATE_RIGHT;
			return SystemFinal.POST_FAILURE;
		}
		this.checkEmpId=CommonTool.getLoginInfo("USERID");
		this.checkDate=CommonTool.getCurrDate();
		boolean flag=this.pc002Service.handBill(strCompId, strBillId, iChangeType, 5,new StringBuffer());
		if(flag==false)
			this.strMessage="操作失败!";
		return SystemFinal.POST_SUCCESS;
	}
	...
	public String comfirmValodateButton()
	{
		...
		boolean flag=this.pc002Service.handValidateBill(strCompId, strBillId);
		if(flag==false)
			this.strMessage="操作失败!";
		return SystemFinal.POST_SUCCESS;
	}
	...
	{
		this.lsDataSet=this.pc002Service.loadMasterByCompId();
		return SystemFinal.LOAD_SUCCESS;
	}
	...
	public PC002Service getPc002Service() {
		return pc002Service;
	}
	@JSON(serialize=false)
	public void setPc002Service(PC002Service pc002Service) {
		this.pc002Service = pc002Service;
	}
