...
import com.amani.service.AdvancedOperations.AC016Service;
import com.amani.tools.CommonTool;
import com.amani.tools.SystemFinal;
@Scope("prototype")
@ParentPackage("json-default")
@Namespace("/ac016")
public class AC016Action {
	@Autowired
	private AC016Service ac016Service;
	...
	public String loadDataSet() {
		...
		if(!CommonTool.setDateMask(strFromDate).substring(6,8).equals("01"))
		{
			strMessage="结算日期只能从1号开始";
			return SystemFinal.LOAD_SUCCESS;
		}
		this.lsDataSet=this.ac016Service.loadDateSetByCompId(strCurCompId, CommonTool.setDateMask(strFromDate), CommonTool.setDateMask(strToDate),socialsourceflag);
		return SystemFinal.LOAD_SUCCESS;
	}
	
	@Action(value = "loadac016Excel",  results = { 
			 @Result(name = "load_success", location = "/AdvancedOperations/AC016/ac016Excel.jsp"),
			 @Result(name = "load_failure",  location = "/AdvancedOperations/AC016/ac016Excel.jsp")	
	}) 
	public String loadac016Excel() {  //查询工资
		if(strFromDate.equals(""))
			strFromDate=CommonTool.getCurrDate();
		if(strToDate.equals(""))
			strToDate=CommonTool.getCurrDate();
		strCurCompName=this.ac016Service.getDataTool().loadCompNameById(strCurCompId);
		this.lsDataSet=this.ac016Service.loadDateSetByCompIdNoCompute(strCurCompId, CommonTool.setDateMask(strFromDate), CommonTool.setDateMask(strToDate),socialsourceflag);
		return SystemFinal.LOAD_SUCCESS;
	...
	public void createExcelA3() throws WriteException, IOException
	{
		try
		{
			...
			sheet.mergeCells(2, 1, excelLength0-1, 1); //合并第一行，1到倒数第一行列
			//区分在职和非离职
			int leaveCount=0;
			int	daifaCount=0;
			...
			//标题
			Label head=new Label(0,0,strCurCompId+"["+strCurCompName+"]"+"门店在职员工工资汇总表("+CommonTool.setDateMask(strFromDate).substring(0,6)+"月)",titleFormate);
			sheet.setRowView(0, 500,false);
			sheet.addCell(head);
			
			sheet.addCell(new Label(0,1,"",titleFormate));
			//制表日期：
			Label makeDate=new Label(0,2,"制表人：",titleFormate);
			sheet.addCell(makeDate);

			//制表日期值
			Label makeDateData=new Label(1,2,CommonTool.getLoginInfo("USERNAME")+"["+CommonTool.getDateMask(CommonTool.getCurrDate())+"]",titleFormate);
			sheet.addCell(makeDateData);

			
			Label str0x=new Label(0,2," ",titleFormate);
			sheet.addCell(str0x);
			
			Label str0=new Label(1,2,"银行账号",titleFormate);
			sheet.addCell(str0);
			
			Label str2=new Label(2,2,"姓名",titleFormate);
			sheet.addCell(str2);
			
			Label str1=new Label(3,2,"编号",titleFormate);
			sheet.addCell(str1);
			
			Label str3=new Label(4,2,"职位",titleFormate);
			sheet.addCell(str3);
			
			Label str4=new Label(5,2,"身份证",titleFormate);
			sheet.addCell(str4);
			
			Label stra=new Label(6,2,"个人业绩",titleFormate);
			sheet.addCell(stra);
			
			Label str5=new Label(7,2,"门店业绩",titleFormate);
			sheet.addCell(str5);
			
			Label str7=new Label(8,2,"底薪",titleFormate);
			sheet.addCell(str7);
			
			Label str13=new Label(9,2,"奖励",titleFormate);
			sheet.addCell(str13);
			
			Label str11x=new Label(10,2,"补贴",titleFormate);
			sheet.addCell(str11x);
			
			Label str10=new Label(11,2,"保底",titleFormate);
			sheet.addCell(str10);
			
			Label str10x=new Label(12,2,"差异调整",titleFormate);
			sheet.addCell(str10x);
			

			Label str12=new Label(13,2,"迟到",titleFormate);
			sheet.addCell(str12);
			
			
			Label str9=new Label(14,2,"离职",titleFormate);
			sheet.addCell(str9);
	
			
			Label str11=new Label(15,2,"罚款",titleFormate);
			sheet.addCell(str11);
			
			Label str15x=new Label(16,2,"社保名称",titleFormate);
			sheet.addCell(str15x);
			
			Label str15=new Label(17,2,"社保",titleFormate);
			sheet.addCell(str15);
			
			Label str16=new Label(18,2,"税前工资",titleFormate);
			sheet.addCell(str16);
			
			Label str17=new Label(19,2,"所得税",titleFormate);
			sheet.addCell(str17);
			
			Label str11xx=new Label(20,2,"代扣+住宿+学习费+扣成本",titleFormate);
			sheet.addCell(str11xx);
			
		
			
			Label str20x=new Label(21,2,"责任金返还",titleFormate);
			sheet.addCell(str20x);
			
			Label str20xx=new Label(22,2,"责任金抵押",titleFormate);
			sheet.addCell(str20xx);
			
			Label str22=new Label(23,2,"税后工资",titleFormate);
			sheet.addCell(str22);
			
			Label str23=new Label(24,2,"补充工资",titleFormate);
			sheet.addCell(str23);
			
			Label str24=new Label(25,2,"签名",titleFormate);
			sheet.addCell(str24);
			
			Label str24x=new Label(26,2,"",titleFormate);
			sheet.addCell(str24x);
			Label labname=null;
			...
			if(this.lsDataSet!=null&&this.lsDataSet.size()>0)
			{
				...
				for(int i=0;i<this.lsDataSet.size();i++)
				{
					if(CommonTool.FormatInteger(this.lsDataSet.get(i).getStaffcurstate())!=2)
						continue;
					wcf1=null;
					sheet.addCell(new Label(0,k+3,""+i,titleFormate));
					sheet.addCell(new Label(1,k+3,""+this.lsDataSet.get(i).getStaffbankaccountno(),titleFormate));
					labname=new Label(2,k+3,""+this.lsDataSet.get(i).getStaffname(),titleFormate);
					...
					sheet.addCell(new Label(3,k+3,""+this.lsDataSet.get(i).getStaffno(),titleFormate));
					sheet.addCell(new Label(4,k+3,""+this.lsDataSet.get(i).getStaffpositionname(),titleFormate));
					sheet.addCell(new Label(5,k+3,""+this.lsDataSet.get(i).getStaffpcid(),titleFormate));
					sheet.addCell(new Number(6,k+3,CommonTool.FormatBigDecimal(this.lsDataSet.get(i).getStafftotalyeji()).doubleValue(),titleFormate));
					sheet.addCell(new Number(7,k+3,CommonTool.FormatBigDecimal(this.lsDataSet.get(i).getStaffshopyeji()).doubleValue(),titleFormate));
					sheet.addCell(new Number(8,k+3,CommonTool.FormatBigDecimal(this.lsDataSet.get(i).getStaffbasesalary()).doubleValue(),titleFormate));
			
					sheet.addCell(new Number(9,k+3,CommonTool.FormatBigDecimal(this.lsDataSet.get(i).getStaffreward()).doubleValue()+CommonTool.FormatBigDecimal(this.lsDataSet.get(i).getOldcustomerreward()).doubleValue(),titleFormate));
					sheet.addCell(new Number(10,k+3,CommonTool.FormatBigDecimal(this.lsDataSet.get(i).getStoresubsidy()).doubleValue()+CommonTool.FormatBigDecimal(this.lsDataSet.get(i).getBeatysubsidy()).doubleValue(),titleFormate));
					sheet.addCell(new Number(11,k+3,CommonTool.FormatBigDecimal(this.lsDataSet.get(i).getStaffsubsidy()).doubleValue(),titleFormate));
					sheet.addCell(new Number(12,k+3,CommonTool.FormatBigDecimal(this.lsDataSet.get(i).getStaffamtchange()).doubleValue(),titleFormate));
					
					sheet.addCell(new Number(13,k+3,CommonTool.FormatBigDecimal(this.lsDataSet.get(i).getLatdebit()).doubleValue(),titleFormate));
					sheet.addCell(new Number(14,k+3,CommonTool.FormatBigDecimal(this.lsDataSet.get(i).getLeaveldebit()).doubleValue(),titleFormate));
					sheet.addCell(new Number(15,k+3,CommonTool.FormatBigDecimal(this.lsDataSet.get(i).getStaffdebit()).doubleValue(),titleFormate));
					sheet.addCell(new Label(16,k+3,this.lsDataSet.get(i).getStaffsocialsource(),titleFormate));
					sheet.addCell(new Number(17,k+3,CommonTool.FormatBigDecimal(this.lsDataSet.get(i).getStaffsocials()).doubleValue(),titleFormate));
					sheet.addCell(new Number(18,k+3,CommonTool.FormatBigDecimal(this.lsDataSet.get(i).getNeedpaysalary()).doubleValue(),titleFormate));
					sheet.addCell(new Number(19,k+3,CommonTool.FormatBigDecimal(this.lsDataSet.get(i).getSalarydebit()).doubleValue(),titleFormate));
					sheet.addCell(new Number(20,k+3,CommonTool.FormatBigDecimal(this.lsDataSet.get(i).getStaffdaikou()).doubleValue()
					...
					sheet.addCell(new Number(21,k+3,CommonTool.FormatBigDecimal(this.lsDataSet.get(i).getZerenjinback()).doubleValue(),titleFormate));
					sheet.addCell(new Number(22,k+3,CommonTool.FormatBigDecimal(this.lsDataSet.get(i).getZerenjincost()).doubleValue(),titleFormate));
					sheet.addCell(new Number(23,k+3,CommonTool.FormatBigDecimalZ(this.lsDataSet.get(i).getExcelsalaryA()).doubleValue(),titleFormate));
					sheet.addCell(new Number(24,k+3,CommonTool.FormatBigDecimalZ(this.lsDataSet.get(i).getExcelsalaryB()).doubleValue(),titleFormate));
					sheet.addCell(new Label(25,k+3,"",titleFormate));
					sheet.addCell(new Label(26,k+3,""+i,titleFormate));
				...
				sheet.mergeCells(0, k+3, 21, k+3); //合并第一行，1到倒数第一行列
				sheet.addCell(new Label(22,k+3,"总计",titleFormate));
				sheet.addCell(new Number(23,k+3,CommonTool.GetGymAmt(totalExcelA,0),titleFormate));
				sheet.addCell(new Number(24,k+3,CommonTool.GetGymAmt(totalExcelB,0),titleFormate));
				sheet.addCell(new Label(25,k+3,"",titleFormate));
				sheet.addCell(new Label(26,k+3,"",titleFormate));
				if(leaveCount>0)
				{
					k=k+1;
					sheet.mergeCells(0, k+3, excelLength0-1, k+3); //合并第一行，1到倒数第一行列
					head=new Label(0,k+3,strCurCompId+"["+strCurCompName+"]"+"门店离职员工工资汇总表("+CommonTool.setDateMask(strFromDate).substring(0,6)+"月)",titleFormate);
					...
					str0x=new Label(0,k+3,"",titleFormate);
					sheet.addCell(str0x);
					
					 str0=new Label(1,k+3,"银行账号",titleFormate);
					sheet.addCell(str0);
					
					 str2=new Label(2,k+3,"姓名",titleFormate);
					sheet.addCell(str2);
					
					 str1=new Label(3,k+3,"编号",titleFormate);
					sheet.addCell(str1);
					
					 str3=new Label(4,k+3,"职位",titleFormate);
					sheet.addCell(str3);
					
					 str4=new Label(5,k+3,"身份证",titleFormate);
					sheet.addCell(str4);
					 stra=new Label(6,k+3,"个人业绩",titleFormate);
					sheet.addCell(stra);
					
					 str5=new Label(7,k+3,"门店业绩",titleFormate);
					sheet.addCell(str5);
					
					 str7=new Label(8,k+3,"底薪",titleFormate);
					sheet.addCell(str7);
					
					 str13=new Label(9,k+3,"奖励",titleFormate);
					sheet.addCell(str13);
					
					 str11x=new Label(10,k+3,"补贴",titleFormate);
					sheet.addCell(str11x);
					
					 str10=new Label(11,k+3,"保底",titleFormate);
					sheet.addCell(str10);
					
					 str10x=new Label(12,k+3,"差异调整",titleFormate);
					sheet.addCell(str10x);
					
			
					
					 str12=new Label(13,k+3,"迟到",titleFormate);
					sheet.addCell(str12);
					 str9=new Label(14,k+3,"离职",titleFormate);
					sheet.addCell(str9);
					
					 str11=new Label(15,k+3,"罚款",titleFormate);
					sheet.addCell(str11);

					 str15x=new Label(16,k+3,"社保名称",titleFormate);
					sheet.addCell(str15x);
					
					 str15=new Label(17,k+3,"社保",titleFormate);
					sheet.addCell(str15);
					
					 str16=new Label(18,k+3,"税前工资",titleFormate);
					sheet.addCell(str16);
					
					 str17=new Label(19,k+3,"所得税",titleFormate);
					sheet.addCell(str17);
					
					 str11xx=new Label(20,k+3,"代扣+住宿+学习费+扣成本",titleFormate);
					sheet.addCell(str11xx);
					
				
					
					 str20x=new Label(21,k+3,"责任金返还",titleFormate);
					sheet.addCell(str20x);
					
					 str20xx=new Label(22,k+3,"责任金抵押",titleFormate);
					sheet.addCell(str20xx);
					
					 str22=new Label(23,k+3,"税后工资",titleFormate);
					sheet.addCell(str22);
					
					 str23=new Label(24,k+3,"补充工资",titleFormate);
					sheet.addCell(str23);
					
					 str24=new Label(25,k+3,"签名",titleFormate);
					sheet.addCell(str24);
					
					 str24x=new Label(26,k+3,"",titleFormate);
					sheet.addCell(str24x);
					k++;
				}
				//离职员工
				...
				if(daifaCount>0)
				{
					k=k+1;
					sheet.mergeCells(0, k+3, excelLength0-1, k+3); //合并第一行，1到倒数第一行列
					head=new Label(0,k+3,strCurCompId+"["+strCurCompName+"]"+"门店待发员工工资汇总表("+CommonTool.setDateMask(strFromDate).substring(0,6)+"月)",titleFormate);
					sheet.setRowView(k+3, 500,false);
					sheet.addCell(head);
					totalExcelA=0;
					totalExcelB=0;
		...
		try
		{
			...
			if(this.lsDataSet!=null&&this.lsDataSet.size()>0)
			{
				...
				for(int i=0;i<this.lsDataSet.size();i++)
				{
					...
					sheet.addCell(new Number(13,k+4,CommonTool.FormatBigDecimal(this.lsDataSet.get(i).getStaffreward()).doubleValue()+CommonTool.FormatBigDecimal(this.lsDataSet.get(i).getOldcustomerreward()).doubleValue()));
				...
				if(leaveCount>0)
				{
					...
					head=new Label(0,k+4,strCurCompId+"["+strCurCompName+"]"+"门店离职员工工资汇总表("+CommonTool.setDateMask(strFromDate).substring(0,6)+"月)",titleFormate);
				...
				if(daifaCount>0)
				{
					k=k+1;
					sheet.mergeCells(0, k+4, excelLength0-1, k+4); //合并第一行，1到倒数第一行列
					head=new Label(0,k+4,strCurCompId+"["+strCurCompName+"]"+"门店待发员工工资汇总表("+CommonTool.setDateMask(strFromDate).substring(0,6)+"月)",titleFormate);
					sheet.setRowView(k+4, 500,false);
					sheet.addCell(head);
					totalExcelA=0;
					totalExcelB=0;
	...
	/*public void createExcel() throws WriteException, IOException
	{
		try
		{
			...
			//标题
			Label head=new Label(0,0,strCurCompId+"["+strCurCompName+"]"+"门店员工工资汇总表(4月)",titleFormate);
			sheet.setRowView(0, 500,false);
			sheet.addCell(head);
   ...
   @Result(name = "load_failure", type = "json")	
	...
	public String loadStaffAbsence()
	{
		try
		{
			...
			if(strToDate.equals(""))
				strToDate=CommonTool.getCurrDate();
			this.lsStaffabsenceinfo=this.ac016Service.loadAbsenceInfos(this.strCurCompId, this.strStaffInNo, CommonTool.setDateMask(strFromDate),CommonTool.setDateMask(strToDate));
			return SystemFinal.LOAD_SUCCESS;
		}
		catch(Exception ex)
		{
  ...
  @Result(name = "load_failure", type = "json")	
	...
	public String postAbsenceStaff()
	{
		...
		{
			this.strMessage="";
			if(this.ac016Service.getDataTool().hasSpecialRights(CommonTool.getLoginInfo("USERID"), "QX015")==false)
			{
			...
			boolean flag=this.ac016Service.validateStaffAbsence(strStaffInNo, this.strAbsencedate);
			if(flag==true)
			{
				this.strMessage="该员工当天的缺勤记录已录入系统!";
				return SystemFinal.LOAD_SUCCESS;
			}
			flag=this.ac016Service.postStaffabsenceinfo(this.strCurCompId, strStaffNo, strStaffInNo, strAbsencedate);
			if(flag==false)
			{
 ...
 @Result(name = "load_failure", type = "json")	
	...
	public String postAllAbsenceStaff()
	{
		try
		{
			...
			boolean flag=this.ac016Service.postAllStaffabsenceinfo(this.strCurCompId, strStaffNo, strStaffInNo, toDays);
			toDays=null;
			if(flag==false)
			{
				this.strMessage="录入失败!";
 ...
 @Result(name = "load_failure", type = "json")	
	...
	public String markOneDataSet()
	{
		try
		{
			...
			boolean flag=this.ac016Service.validateStaffmark(this.strCurCompId, strStaffInNo, this.strCurMonth);
			if(flag==true)
			{
				this.strMessage="该员工当天已经标记过!";
				return SystemFinal.LOAD_SUCCESS;
			}
			flag=this.ac016Service.postStaffMarkInfo(this.strCurCompId, strStaffInNo, strCurMonth);
			if(flag==false)
			{
				this.strMessage="录入失败!";
				return SystemFinal.LOAD_SUCCESS;
	...
	public String dmarkOneDataSet()
	{
		try
		{
			...
			boolean flag=this.ac016Service.deleteSalaryMark(this.strCurCompId, strStaffInNo, strCurMonth);
			if(flag==false)
			{
 ...
 @Result(name = "load_failure", type = "json")	
	...
	public String comfrimstopAbsence()
	{
		try
		{
			...
			boolean flag=this.ac016Service.deleteStaffAbsence(this.strCurCompId, strStaffInNo, strCurDate);
			if(flag==false)
			{
				this.strMessage="作废失败!";
				return SystemFinal.LOAD_SUCCESS;
	...
	public AC016Service getAc016Service() {
		return ac016Service;
	}
	@JSON(serialize=false)
	public void setAc016Service(AC016Service ac016Service) {
		this.ac016Service = ac016Service;
	}
