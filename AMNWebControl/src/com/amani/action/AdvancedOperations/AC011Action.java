...
import com.amani.service.AdvancedOperations.AC011Service;
import com.amani.tools.CommonTool;
import com.amani.tools.SystemFinal;
@Scope("prototype")
@ParentPackage("json-default")
@Namespace("/ac011")
public class AC011Action extends AMN_ModuleAction{
	@Autowired
	...
	@Action(value = "cardreturningbao",  results = { 
			 @Result(name = "load_success", type = "json"),
   @Result(name = "load_failure", type = "json")	
	}) 
	public String cardreturningbao()
		{
				this.lsCallsWatingBean=this.ac011Service.cardreturning(calluserid);
				return SystemFinal.LOAD_SUCCESS;
		}
		@Action(value = "peiierbao",  results = { 
				 @Result(name = "load_success", type = "json"),
	    @Result(name = "load_failure", type = "json")	
		}) 
   public String peiierbao()
		{
				this.lsCallsWatingBean=this.ac011Service.peiierbao(calluserid);
				return SystemFinal.LOAD_SUCCESS;
		}
	@Action(value = "referbao",  results = { 
			 @Result(name = "load_success", type = "json"),
      @Result(name = "load_failure", type = "json")	
   }) 
   public String referbao()
	{
			this.lsCallsWatingBean=this.ac011Service.referbao(calluserid);
			return SystemFinal.LOAD_SUCCESS;
	}
	@Action(value = "orderbao",  results = { 
			 @Result(name = "load_success", type = "json"),
      @Result(name = "load_failure", type = "json")	
   }) 
   public String orderbao()
	{
			this.lsCallsWatingBean=this.ac011Service.orderbao(calluserid);
			return SystemFinal.LOAD_SUCCESS;
	}
	/**
	 * 电话报表
	 * @return
	 */
	@Action(value = "selectbao",  results = { 
			 @Result(name = "load_success", type = "json"),
       @Result(name = "load_failure", type = "json")	
    }) 
    public String selectbao()
	{
			this.lsCallingAdminBean=this.ac011Service.callbao(calltype,calluserid);
			return SystemFinal.LOAD_SUCCESS;
	}
   ...
   public String initpage()
	{
		try
		{
			this.lsCallingAdminBean=this.ac011Service.selectalluser();
			return SystemFinal.LOAD_SUCCESS;
		}
		catch(Exception ex)
		{
	...
	public AC011Service getAc011Service() {
		return ac011Service;
	}
	@JSON(serialize=false)
	public void setAc011Service(AC011Service ac011Service) {
		this.ac011Service = ac011Service;
	}
