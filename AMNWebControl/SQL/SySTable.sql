...
(
	...
	descriptions	varchar(100)	NULL,		--描述
...
(
	roleno			varchar(5)	Not NULL,   --角色编号
	position		varchar(10)	Not	NULL,	--岗位编号
...
(
	...
	compipaddress		varchar(15)		NULL,		-- 门店IP地址
	compipaddressex		varchar(15)		NULL,		-- 门店IP地址扩展
	...
	mangerPassword		varchar(20)		NULL,		-- 经理密码
	roomnumber int					null, --房间数量
	mirrornumber int				null, --镜台数量
	shopwf1  varchar(100)				null,--开店流程1
	shopwf2  varchar(100)				null,--开店流程2
	shopwf3  varchar(100)				null,--开店流程3
	shopwf4  varchar(100)				null,--开店流程4
	shopwf5  varchar(100)				null,--开店流程5
	shopwf6  varchar(100)				null,--开店流程6
	shopwf7  varchar(100)				null,--开店流程7
	shopwf8  varchar(100)				null,--开店流程8
	shopwf9  varchar(100)				null,--开店流程9
	shopwf10  varchar(100)				null,--开店流程10
	bilinginfo varchar(50) 				NULL --开票信息字段
...
---------------------------------------
-----compscheduling 门店班次信息 CREATE by liujie 20130628
---------------------------------------
if not exists(select 1 from sysobjects where type='U' and name='compscheduling')
CREATE table compscheduling
(
	compno				varchar(10)		Not  NULL,	-- 当前门店
	schedulno			varchar(10)		Not  NULL,	-- 班次编号
	schedulname		varchar(30)			 NULL,	-- 班次名称
	fromtime			varchar(10)			NULL,	-- 起始时间
	totime				varchar(10)			NULL,	-- 结束时间
...
(
    ...
    hairqualified	int				NULL	,-- 0 合格 1 不合格
    trkcqualified	int				NULL	,-- 0 合格 1 不合格
    mangerflag		int				NULL	,-- 是否为部门经理
    displayname		varchar(200)	NULL,--展示名称
...
(
	compno			varchar(10)		Not NULL,   -- 公司别
	curstaffno		varchar(20)		Not NULl,	-- 当前员工
	cstaffno		varchar(20)		Not NULL,   -- 员工编号
	staffname		varchar(20)		NULL    , 	-- 员工姓名
	department		varchar(10)		NULL    ,	-- 部门编号
	manageno		varchar(20)		NULL    ,	-- 内部管理号
...
(
	...
	manageno		varchar(20)				NULL,		--内部管理编号 
    absencedate		varchar(6)				NULL,		--标记月份
...
-----managershareinfo   区域经理基本工资分享 CREATE by liujie 20130628
---------------------------------------
...
(
	...
	useflag			int				null,			--使用范围 0 所有 1 门店 2 总部 
...
(
	...
	newcosttc			float			NULL,		--新客提成数
	oldcosttc			float			NULL,		--老客提成数
	markflag			int				NULL,		--疗程兑换是否需要备注
	morelongflag			int				NULL,       --  是否有超长价
	ipadname varchar(50)		null,				--ipad显示名称
...
(
	...
	minordercount		float NULL					--最小订货量
	bindgoodsno			varchar(50)		NULL,		--供应商绑定产品编号
	enablecompany 		varchar(1) 		NULL		--是否启用采购门店限制
    goodscompany 		varchar(200) 	NULL		--允许采购门店
    enablebarcode 		varchar(1) 		NULL		--是否启用条码校验
...
(
    ...
    sendamtflag			int				NULL default(0), --是否赠送卡金 1:'是',0:'否'
...
(
	...
	startdate			varchar(8)						null,		--起始日期
	enddate				varchar(8)						null,		--结束日期
	costrate			float(10)						null,		--项目消费折扣
	changerate			float(10)						null,		--项目消费折扣
...
(
	...
	yearsz				int 				NULL,	--来源类型 1：赠送，0：购买
	activinid			varchar(50)			NULL	--赠送疗程活动唯一编号
...
(
	...
	changemark			varchar(200)	NULL,	--修改备注
...
(
	...
	recommendempid		varchar(20)		NULL	,	--推荐员工
	recommendempinid	varchar(20)		NULL	,	--推荐员工
	sendpointflag		varchar(20)		null,
	cardphone			varchar(20)		null,
	randomno			varchar(50)		null,	--微信码
	ctypestate 			int 				null,--C类美容师体验活动标识1.已使用 NULL.未使用
 	scanpaytype 		int 				null,--扫码支付类型1.支付宝 2.微信
	scanbarcode 		nvarchar(20) 		null,--扫码支付条码
	scantradeno 		nvarchar(30) 		null,--扫码订单号
	ticketcode 			varchar(20) 		NULL--卡诗天猫活动券号
...
(
	...
	costpricetype	int				NULL,		--是否为体验价消费	0 不是 1 是 （活动标识）
	hairRecommendEmpId varchar(50)			null,   --总监首席介绍人
	hairRecommendEmpInid varchar(50)		null,   --总监首席内部工号
	yearinid		varchar(50)		null,--唯一编号
 	scanpaytype 	int 			null,			--扫码支付类型1.支付宝 2.微信
 	scanpayamt 		float 			null,			--扫码支付金额
    haircompamt		float 			null, 			--接发-公司业绩金额
	hairstaff		varchar(20)		null,			--接发-其他店介绍-推荐人（后改成标识位 0是本店 1是推荐店）
	integralcode	int				null			--添加积分支付（美容积分）的标识字段
	saledate		varchar(8)		NULL,   		--疗程账户开立日
	activinid		varchar(50)		NULL,			--活动唯一编号
...
(
	...
	sendpicflag 		int				NULL,			--1 积分 , 2 条码卡 3 储值金额
...
(
	...
	cardtype 		int 				null	,--卡类型 -- 1 抵用券，2条码卡 3活动券(项目+产品)
	...
	createtype		int					null	,-- 0普通券 1 五一活动券
	createcardtype	int					null	,-- 券1 券2 券3
...
(
	...
	costbillno		varchar(20)		null	,--消费单号
	entryremark	varchar(200)		null	,--备注
	packageNo	varchar(50)		null,	 --套餐编号
...
(
	...
	usecardno			varchar(20)			null	,--会员卡号
	usecardtype			varchar(10)			null    ,--会员卡类型
...
(
	...
	ratetype		int				NULL,		--打折标示 0 打折  1 不打折
	usemonths		int				NULL,		--有效期 单位 月
...
(
	...
	corpscardno			varchar(20)				NULL,	--团购号
	activtycardno		varchar(20)				NULL,	--活动券号
	saleremark			varchar(160)			NULL,   --备注
	bankcostno			varchar(10)				NULL,	--银行卡凭证号
	...
	sendpointflag		int						NULL,   --是否赠送积分: 0--不赠送 1--赠送
	backflag			int						NULL,	--是否反冲 0 未反冲 1 反冲
	billinsertype		int						NULL,	--充值主办方 1 美容 2 美发
	sendamtflag		int							NULL,   --是否赠送卡金: 0--不赠送 1--赠送
...
(
	...
	cursendaccountkeepamt	float				NULL    ,   --赠送账户余额
	...
	curfaceaccountamt		float				NULL       	--美容积分账户余额
...
CREATE table dproexchangeinfo( 
	...
	changebyaccountamt		float					NULL,			--金额(储值账户金额)
	changebysendaccountamt	float					NULL,			--金额(赠送账户金额)
	changepaymode			varchar(5)				NULL,			--支付方式
	changebycashamt			float					NULL,			--充值金额（现金金额）
	nointernalcardno		varchar(20)				NULL,			--抵用券号木
    ...
    salebakflag				int						NULL,  --单据类型: 0--正常单 1--已作废
    sendpointflag			int					NULL    ,  --是否赠送积分: 0--不赠送 1--赠送
	changebyfaceamt			float					NULL			--美容积分抵扣(美容积分抵扣)
...
(
	...
	curpointaccountkeepamt			float				NULL,   --积分账户余额
	cursendaccountkeepamt			float				NULL,   --赠送账户余额
	changelowamt				float				NULL,   --转卡最低余额
	changefillamt				float				NULL,   --转卡充值
	changdebtamt				float				NULL,   --转卡欠款
	cashfillamt					float				NULL,   --现金抵扣
	bankfillamt					float				NULL,   --银行卡抵扣
	keepamtfillamt				float				NULL,   --储值抵扣
	deductamt					float				NULL,   --成本
	...
	backflag				int						NULL,	--是否反冲 0 未反冲 1 反冲
	billinsertype			int						NULL,	--充值主办方 1 美容 2 美发
	salarytype				int						NULL,	--薪资模式 0 老模式 1 新模式
	sendamtflag				int						NULL,   --是否赠送卡金: 0--不赠送 1--赠送
...
(
	changecompid		varchar(10)     Not NULL,   --异动门店
	changebillid		varchar(20)		Not NULL,   --异动单号
	cardno				varchar(20)		Not	NULL,	--拆分卡号
	cardvesting			varchar(10)			NUll,	--卡归属
	cardtype			varchar(20)			NULL,	--卡类型
	membername			varchar(20)			NULL,	--会员姓名
	memberphone			varchar(20)			NULL,	--手机号码
	cardamt				float				NUll,	--储值金额
...
(
	...
	operationdate			varchar(8)				NULL,   --操作日期
	salebakflag				int						NULL,  --单据类型:0--正常单 1--已作废
	accounttype 			int						NULL,	--类型
	salescardpayment 		float					NULL,	--储值支付
	paymentmethod 			varchar(20)				NULL,	--支付方式
	paymentamount 			float					NULL,	--支付金额
...
(                                                                              
		 ...
		 tmkservice					float				NULL,   --销售条码卡服务  
		 tmksendservice				float				NULL,   --赠送条码卡服务  
...
(
	...
	appstaffname				varchar(20)					null,		--	保底申请人
	checkstaffname				varchar(20)					null,		--	保底审核人	
...
---------------------------------------
-----dgoodsbatchbegin  --产品期初批次结算表
---------------------------------------
if not exists(select 1 from sysobjects where type='U' and name='dgoodsbatchbegin')
CREATE TABLE dgoodsbatchbegin          -- 库存日异动统计明细档(所有异动单据明细 update) 
(
	changecompid		varchar(10)				NOT NULL,   -- 结算门店          
	changegoodsno		varchar(30)				NOT	NULL,   -- 产品代号   
	begindate			varchar(10)				NOT	null,	-- 结算日期 
	beginbillno			varchar(30)				NOT	NULL,   -- 结算单号
	beginprice			float					NOT	NULL,   -- 单价
	begincount			float						NULL,   -- 数量
...
(
	...
	invalid   				int  					NULL,		--是否作废
	arrivaldate 			varchar(10) 			NULL		--到货日期
...
---------------------------------------
-----mgoodsallotmentinfo     --配发主表主档
---------------------------------------
if not exists(select 1 from sysobjects where type='U' and name='mgoodsallotmentinfo')
create table mgoodsallotmentinfo	
(
	entrycompid 			varchar(10)			NOT NULL,		--公司编号
	entrybillid				varchar(30)			NOT NULL,		--配发号
	allotmentdate			varchar(8)				NULL,		--配发日期
	allotmenttime			varchar(8)				NULL,		--配发时间
	allotmenttaffid			varchar(20)				NULL,		--配发人
	allotmenttype			int						NULL,		--配发对象
	allotmentcompid			varchar(10)				NULL,		--配发门店
	recevicestaffid			varchar(20)				NULL,		--门店接受人
	apporderbillno			varchar(20)				NULL,		--配发生成的采购单
	orderopationerid		varchar(20)				NULL,		--操作收银员
	orderopationdate		varchar(10)				NULL,		--操作日期	
	invalid   				int  					NULL,		--是否作废
...
---------------------------------------
-----dgoodsallotmentinfo     --配发表明细
---------------------------------------
if not exists(select 1 from sysobjects where type='U' and name='dgoodsallotmentinfo')
create table dgoodsallotmentinfo
(
	entrycompid				varchar(10)			NOT NULL,		--公司编号
	entrybillid				varchar(30)			NOT NULL,		--配发单号
	allotmentseqno				float				NOT NULL,		--产品序号
	allotmentgoodsno			varchar(20)				NULL,		--产品编号
	allotmentgoodscount			float					NULL,		--数量
	allotmentgoodsunit			varchar(5)				NULL,		--单位
	allotmentgoodsprice			float					NULL,		--配发单价
	allotmentgoodsamt			float					NULL,		--金额
	headstockcount				float					NULL,		--总部库存
	supplierno					varchar(20)				NULL,		--供应商编号
	headwareno					varchar(20)				NULL,		--上级仓库编号
	goodssource					int  default(0)			NULL,		--物品来源0上级仓库,1供应商
...
(
	entrycompid				varchar(10)			NOT NULL,			--公司编号
	entrybillid				varchar(30)			NOT NULL,			--配发单号
	allotmentseqno			float				NOT NULL,			--配发序号
	allotmentcompno		varchar(20)				NULL,			--门店编号
	apporderbillno			varchar(20)				NULL,			--配发生成的采购单
...
(
	...
	receiptsenddate					varchar(8)				NULL		--供应商发货日期
	receiptsupplier 				varchar(20) 			NULL		--供应商编码
...
create table recordinfos(
			callid			INT  IDENTITY(1, 1)		PRIMARY KEY,  --等待编号
			callbillids		varchar(30)					NULL, --单据编号
...
if not exists(select 1 from sysobjects where type='U' and name='orders')
  create table orders(
		...
		orderstate			int				NULL,			--	状态(0表示确认单据，1表示单据未处理完 2 已发送短信确认)
		orderfactdate		varchar(10)		NULL,			--	实际预约日期
		orderfacttime		varchar(10)		NULL,			--	实际预约时间
		orderfactproject	varchar(100)		NULL,			--	实际预约项目
		orderfactempid		varchar(20)		NULL,			--	实际预约人员
		orderconfirmmsg		varchar(200)	NULL,			--	预约确认短信
		confirmdate			varchar(10)		NULL,			--	确认预约日期
		confirmemp			varchar(20)		NULL,			--	确认预约员工
  )
...
-- from [MasterDatabase2014].dbo.spadDconsumeInfo
 ...
 (
	...
	brachcode		 VARCHAR(10)		NULL,		--门店号
    SMALL_NO		VARCHAR(50)			NULL,--小单号
    EMPLOYEE_NO		VARCHAR(255)		NULL,--员工号 
    CUSTOM			VARCHAR(50)			NULL,--手牌号	
    STATUS			int DEFAULT 0		NULL,--小单状态					-未传  3 已结单
    CDATE			VARCHAR(30)			NULL,--开单时间
    SUMMARY			VARCHAR(2000)		NULL,--备注
    PSMALL_NO		VARCHAR(50)			NULL,--合并单 付款小单号
    SMERGE			int DEFAULT 0		NULL,-- 1 合并到其他小			-未传
 )
 ...
 (
	...
	brachcode		 VARCHAR(10)		NULL,		--门店号
    SMALL_NO        VARCHAR(50)			NULL,		--小单号
    SORTID          int					NULL,--类型id 0产品 1服务 2 会员卡
    CODE            VARCHAR(50)			NULL,--项目编码
    PRODUCT         VARCHAR(50)			NULL,--项目名称
    AMOUNT          float				NULL,--次数				-未传
    PRICE           float				NULL,--单价
	COST            NUMERIC(8,2) DEFAULT 1	NULL,--折扣率
    CDATE           varchar(30)			NULL,--录入时间
    ISDELETED       int DEFAULT 0		NULL,-- 0正常 1删除
    ISFORTREATMENT  int					NULL,-- 1疗程卡
	EMPLOYEE_NO     VARCHAR(50)			NULL,--员工号 1
    EMPLOYEE_NO2    VARCHAR(50)			NULL,--员工号 2
    EMPLOYEE_NO3    VARCHAR(50)			NULL,--员工号 3
    ISNEW           int DEFAULT 0		NULL,-- 0非指定 1 指定
    ISNEW2          int DEFAULT 0		NULL,-- 0非指定 1 指定
    ISNEW3          int DEFAULT 0		NULL,-- 0非指定 1 指定
    CSPROSEQNO 		float			NULL,		--疗程消耗序号
	SCORE           NUMERIC(8,2)		NULL,--业绩1
    SCORE2          NUMERIC(8,2)		NULL,--业绩2
    SCORE3          NUMERIC(8,2)		NULL,--业绩3
    REWARD          NUMERIC(8,2) DEFAULT 0	NULL,--提成1
    REWARD2         NUMERIC(8,2) DEFAULT 0	NULL,--提成2
    REWARD3         NUMERIC(8,2) DEFAULT 0--提成3
...
--门店人脸考勤机版本控制
  ...
  (
		compno				varchar(10)			not null,		--门店编号
		machineno			varchar(20)			not	null,		--考勤机序号
		createseqno			int					not	null,		--创建序号
		machineversion		varchar(5)				null,		--考勤机版本
		createfromdate		varchar(10)				null,		--起始使用日期
		createtodate		varchar(10)				null,		--结束使用日期
 ...
 --人脸考勤系统
  ...
  (
		faceip			varchar(20)			not null,		--机器所在IP
		emplooyid		varchar(10)			not	null,		--员工ID
		emplooyname		varchar(20)				null,		--员工姓名
		emplooycalid	varchar(20)				null,		--工卡标示符
		emplooycardnum	varchar(20)				null,		--刷卡号码
		faceimageA		varchar(2500)			null,		--人脸图片字符1
		faceimageB		varchar(2500)			null,		--人脸图片字符2
		faceimageC		varchar(2500)			null,		--人脸图片字符3
		faceimageD		varchar(2500)			null,		--人脸图片字符4
		faceimageE		varchar(2500)			null,		--人脸图片字符5
		faceimageF		varchar(2500)			null,		--人脸图片字符6
		faceimageG		varchar(2500)			null,		--人脸图片字符7
		faceimageH		varchar(2500)			null,		--人脸图片字符8
		faceimageI		varchar(2500)			null,		--人脸图片字符9
		faceimageJ		varchar(2500)			null,		--人脸图片字符10
		faceimageK		varchar(2500)			null,		--人脸图片字符11
		faceimageL		varchar(2500)			null,		--人脸图片字符12
		faceimageM		varchar(2500)			null,		--人脸图片字符13
		faceimageN		varchar(2500)			null,		--人脸图片字符14
		faceimageO		varchar(2500)			null,		--人脸图片字符15
		faceimageP		varchar(2500)			null,		--人脸图片字符16
		faceimageQ		varchar(2500)			null,		--人脸图片字符17
		faceimageR		varchar(2500)			null,		--人脸图片字符18
  )		
  ...
  (
		...
		entrybillid 				varchar(20)				not null,		--	登记单号
		compid					varchar(10)					null,			--	门店编号
		targetmonth				varchar(10)					null,			--	指标设置月份
		ttotalyeji				float						null,			--	总虚业绩指标
		trealtotalyeji			float						null,			--	总实业绩指标
		tbeatyyeji				float						null,			--	美容虚业绩指标
		ttrhyeji				float						null,			--	烫染指标
		tcostcount				float						null,			--	总客单指标
		tstaffleavelcount		float						null,			--	门店流失数
		targetflag				int							null,			--	是否作废 0 登记中   1已审核  2 已驳回 3 已作废
		operationer				varchar(20)					null,			--	操作人
		operationdate			varchar(10)					null,			--	操作时间
		checkempid				varchar(20)					null,			--	审核人
		checkdate				varchar(10)					null,			--	审核时间
  )
  ...
  (
		compid				varchar(10)			null,		--员工编号	
		staffid				varchar(20)			null,		--员工编号	
		staffname			varchar(20)			null,		--员工名称
		staffinid			varchar(20)			null,		--员工内部编号
		mmonth				varchar(10)			null,		--设定月份
		stafftype			int					null,		--员工性质	--1拿业绩 2不拿业绩
  )
...
---------------------------------------
-----compscheduling 门店排班信息 CREATE by liujie 20130628
---------------------------------------
...
(
	compno				varchar(10)		Not  NULL,	-- 当前门店
	schedulno			varchar(10)		Not  NULL,	-- 班次编号
	scheduldate			varchar(10)		Not  NULL,	-- 排班日期
	schedulemp			varchar(20)		Not	 NULL,	-- 排班人员
	schedulempname		varchar(30)			 NULL,	-- 排班人员
	schedulempmanger	varchar(30)			 NULL,	-- 排班人员
	fromtime			varchar(10)			 NULL,	-- 起始时间
	totime				varchar(10)			 NULL,	-- 结束时间
	schedulmark			varchar(100)		 NULL,	-- 排班备注
...
(
	staffinid			varchar(20)			Not NULL,	-- 员工内部编号
	leavedate			varchar(10)			Not NULL,	-- 请假日期
	leavetype			int						NULL,	-- 请假类型
	fromtime			varchar(10)				NULL,	-- 起始时间
	totime				varchar(10)				NULL,	-- 结束时间
	schedulmark			varchar(100)			NULL,	-- 请假备注
	checkdate			varchar(10)				null	,
	checkuseid			varchar(20)				null	,
	checkflag			int						null	   -- 0未复合  1 已复核
...
CREATE TABLE projectcostinfo          -- 项目消耗设定      
(
	prjno				varchar(20) NOT NULL,   -- 项目编号 
	goodsno				varchar(30) NOT NULL,   -- 产品编号         
	costunitcount		float       NULL,       -- 标准消耗数量       
...
(
	...
	optionuserno		varchar(20)				NULL,	--修改人
	optiondate			varchar(10)				NULL,	--修改日期
	optiontime			varchar(10)				NULL,	--修改时间
) 
go
...
(
	seqno					int identity			NOT NULL, 
	changecompid			varchar(10)				NULL,   --异动门店
	changebillid			varchar(20)				NULL,   --异动单号
...
CREATE tAbLE    mcardrechargeinfolog              -- 帐户异动单
(
	seqno					int identity			NOT NULL,  
	rechargecompid			varchar(10)				NULL,   --充值门店
	rechargebillid			varchar(20)				NULL,   --充值单号 
	rechargedate			varchar(8)				NULL,   --充值日期 
	rechargecardno			varchar(20)				NULL,   --会员卡号
	firstsalerid			varchar(20)				NULL,   --第一销售工号
    firstsalerinid			varchar(20)				NULL,   --第一销售内部编号
...
(
	returncompid				varchar(10)			NOT NULL,		--公司编号
	returnbillid				varchar(20)			NOT NULL,		--退疗程单号
	returndate					varchar(10)			NULL    ,		--退疗程日期
    returntime					varchar(10)			NULL    ,		--退疗程时间  
	returncardno				varchar(20)			NULL	,		--退卡卡号
	cardvesting					varchar(10)			NULL	,		--卡归属
	cardtype					varchar(10)			NULL	,		--卡类型
	membername					varchar(20)			NULL	,		--会员姓名
	memberphone					varchar(20)			NULL	,		--会员手机
	curkeepamt					float				NULL	,		--储值余额
	curkeepproamt				float				NULL	,		--疗程余额
	cursendamt					float				NULl	,		--赠送余额
	curpointamt					float				NULL	,		--积分金额
	changecardno				varchar(20)			NULL	,		--新开卡
	opencardtype				varchar(10)			NULL	,		--新开卡类型
	opentotalamt				float				NULL	,		--新卡卡疗程总额
	returnkeeptotalamt			float				NULL	,		--退换储值总额
	changetotalamt				float				NULL	,		--转换疗程总额	
	costproamt					float				NULL	,		--扣除差额							
...
(
	returncompid				varchar(10)			NOT NULL,			--公司编号
	returnbillid				varchar(20)			NOT NULL,			--退疗程单号
	returnprotype				int					NOT NULL,			--退疗程类型  1 退疗程  2换疗程
	returnseqno					float				NOT NULL,			--序号
    changeproid					varchar(20) 			NULL,			--项目编号
    lastcount					float					NULL,			--剩余次数
	lastamt						float					NULL,			--剩余金额
    ...
    secondsalerinid				varchar(20)				NULL,			--第二销售内部编号
    secondsaleamt				float					NULL,			--第二销售分享金额	
    changemark					varchar(200)			NULL,			--备注
    changeflag					int						 NULL,			--0 退疗程  1换疗程
...
(
	id varchar(50) not null primary key,   --标识列
	mobilephone varchar(30) null,---手机号码
	acceptdate varchar(30) null,--回复日期，时间
	content varchar(1000)  null,--内容
	operdate varchar(20)  null,--系统日期接受日期
)
go
...
(
	compno				varchar(10)		Not  NULL,	-- 公司编号
	roomno			varchar(10)		Not  NULL,	-- 房间编号
	roomname		varchar(100)		  NULL,	-- 房间名称
...
CREATE table schoolinfo(
	id 				int IDENTITY(1,1) 	NOT NULL,	--流水编号
	no  			AS (right(CONVERT(varchar,(1000)+id,(0)),(3))),	--学校编号
	name 			varchar(50) 	NOT NULL,		--学校名称
	website 		varchar(20) 	NULL,			--网址
	address 		varchar(100) 	NULL,			--地址
	telephone 		varchar(20) 	NULL,			--电话
	contacts 		varchar(20) 	NULL,			--联系人
	mobile 			varchar(20) 	NULL,			--联系人电话
	describe 		varchar(1000) 	NULL,			--学校简介
	remark 			varchar(255) 	NULL,			--备注
	state 			int 			NULL,			--状态 1:启用 0:未启用
...
CREATE table schoolcredit(
	id 				bigint 			IDENTITY(1,1) NOT NULL,	--流水编号
	no  			AS (right(CONVERT(varchar,(1000)+id,(0)),(3))),	--课程编号
	name 			varchar(50) 	NOT NULL,				--课程名称
	type 			int 			NOT NULL,				--课程类别 0:美容 1:美发
	school_no 		varchar(10) 	NOT NULL,				--学校编号
	state 			int 			NULL,					--状态 1:启用 0:未启用
...
(
	...
	staffno			varchar(20)		Not NULL,	--员工编号
	remark			nvarchar(100)	NULL,		--备注
	actno			varchar(10)		Not NULL,	--活动编号
	acttype			int				Not NULL,	--活动类型
...
CREATE table schoolindex(
	postion_no varchar(20) NOT NULL,--职位编号
	time varchar(20) NOT NULL,--月份 yyyyMM
	type nvarchar(20) NOT NULL,--类型（项目数指标，疗程业绩指标）
	num float NULL,--金额/数量
...
CREATE table Schoollowestscore(
	syear int NOT NULL,--年份
	score float NULL,--最低学分
	state int NULL,--状态1为启用
...
CREATE TABLE credit(
	compno varchar(10) NOT NULL,	--门店编号
	staffno varchar(20) NOT NULL,	--员工编号
	staffname varchar(20) NOT NULL, --名称
	positionname varchar(40) NOT NULL,--职位
	credit int NOT NULL--积分
);
...
create table creditdetail(
	staffno varchar(20) NOT NULL,--员工编号
	classify varchar(100) NOT NULL,--类型
	number int NOT NULL,--次数
...
CREATE table suppliermode(
	id 				int IDENTITY(1,1) 	NOT NULL,	--流水编号
	no  			AS (right(CONVERT(varchar,(1000)+id,(0)),(3))),	--供应商编号
	name 			varchar(50) 	NOT NULL,		--供应商名称
	contractno		varchar(20)		NULL,			--合同编号
	telephone 		varchar(20) 	NULL,			--电话
	fax 			varchar(20) 	NULL,			--传真
	address 		varchar(100) 	NULL,			--地址
	startdate		varchar(10)   	NULL,			--开始日期
	login			varchar(10)		NULL,			--登录编号
...
---------------------------------------
-----supplierlink 供应商联系人信息
---------------------------------------
if not exists(select 1 from sysobjects where type='U' and name='supplierlink')
CREATE table supplierlink(
	id 				int 	IDENTITY(1,1) NOT NULL,	--联系人编号
	supplierno 		varchar(10) 	NOT NULL,		--供应商编号
	name 			varchar(10) 	NULL,			--联系人名称
	mobile 			varchar(20) 	NULL,			--联系人电话
	ismain			int		default(0)		NULL,	--是否主要 1:是 0:否
	state 			int 	default(1)		NULL,	--状态 1:启用 0:未启用
...
---------------------------------------
-----mmedicalcare 合作疗程套餐主档
---------------------------------------
if not exists(select 1 from sysobjects where type='U' and name='mmedicalcare')
CREATE table mmedicalcare(
	id 				int IDENTITY(1,1) 	NOT NULL,	--流水编号
	compno			varchar(10)		Not NULL,	    -- 门店编号
	salebillid		varchar(20)		Not NULL,   	--合作项目单号
	telephone 		varchar(15) 	NULL,			--电话
	onlyno			varchar(50)		NULL,			--唯一编号
...
CREATE table dmedicalcare(
	...
	telephone 		varchar(15) 	NULL,			--电话
	packageno		varchar(20) 	Not NULL,		--套餐编号
	itemno			varchar(20) 	NULL,			--项目编码
	onlyno			varchar(50)		NULL,			--唯一编号
	salecount		int				NULL,			--次数
	saleamt			float			NULL,			--金额
	lastcount		int				NULL,			--剩余次数
	lastamt			float			NULL,			--剩余金额
	saledate		varchar(8)		NULL,			--购买日期
	state 			int 	default(1)		NULL,	--状态 1:启用 0:未启用
...
(
	...
	csbillid		varchar(20)		Not NULL,   	--消费单号
	scantradeno     nvarchar(30)    null,			--扫码订单号
	paydate			varchar(8)		null,     		--操作日期
	paytime			varchar(6)		null,     		--操作时间
	scanpaytype     int             null,           --扫码支付类型1.支付宝 2.微信
	payamt			float           null,			--扫码支付金额
	paytype         int 			null 			--操作类型 1,支付，2撤销，3退款
	CONSTRAINT PK_consumepayment PRIMARY KEY NONCLUSTERED(id)
)

---------------------------------------
-----dgoodsreceiptrecord     门店收货明细表-供应商发货Webservice记录表
---------------------------------------
...
(
	...
	receiptgoodsno			varchar(20)					NULL,		--产品编号
	receiptgoodsunit		varchar(10)					NULL,		--单位
	receiptprice			float						NULL,		--标准单价
	sendgoodscount			float						NULL,		--发货数量
	ordergoodscount			float						NULL,		--订单数量
	receiptsendbillid		varchar(30)					NULL,		--发货单号
	receiptstate			int							NULL   		--记录状态0:不在订单中;1:价格不一致;2:数量大于订单数3:正常(已存储在发货表中)
	constraint pk_dgoodsreceiptrecord primary key clustered(receiptcompid,receiptbillid,receiptseqno)
)

---------------------------------------
-----mactivityinfo     活动设定主档表
---------------------------------------
if not exists(select 1 from sysobjects where type='U' and name='mactivityinfo')
create table mactivityinfo	
(
	id 						int IDENTITY(11,1) 		NOT NULL,		--活动数字编号
	activcompid  			varchar(10)				NOT NULL,		--门店编号
	activbillid  			varchar(30)				NOT NULL,		--活动单号
	activname	  			varchar(100)			NOT NULL,		--活动名称
	activinid				varchar(50)				NOT NULL,		--活动唯一编号
	activtype				int						NOT	NULL,		--活动类型1:卡异动、2:疗程、3:产品
	activamt				float						NULL,		--金额
	activorand				int							NULL,		--活动逻辑1:或、2:且
	activcount				int							NULL,		--套数		
	startdate				varchar(10)   				NULL,		--开始日期
	enddate					varchar(10)   				NULL,		--结束日期
	activstate				int							NULL   		--活动状态0:停用、1:正常
	constraint pk_mactivityinfo primary key nonclustered(activinid)
)

---------------------------------------
-----dactivityinfo     活动设定明细表
---------------------------------------
if not exists(select 1 from sysobjects where type='U' and name='dactivityinfo')
create table dactivityinfo	
(
	id 						int IDENTITY(1,1) 		NOT NULL,		--流水编号
	activno	  				varchar(20)				NOT NULL,		--项目\产品\分类编号
	activname  				varchar(50)				NOT NULL,		--项目\产品\分类名称
	activtype				int							NULL,		--类型1:项目、2:分类
	activinid				varchar(50)				NOT NULL,		--活动唯一编号
	activcount				int							NULL		--套数/数量		
	constraint pk_dactivityinfo primary key nonclustered(id)
)

---------------------------------------
-----mactivitygive     活动赠送主档表
---------------------------------------
...
(
	...
	activcompid  			varchar(10)				NOT NULL,		--门店编号
	activinid				varchar(50)				NOT NULL,		--活动唯一编号
	activorand				int							NULL,		--活动逻辑1:或、2:且、3：只送产品
	constraint pk_mactivitygive primary key nonclustered(id)
)

---------------------------------------
-----mactivitygive     活动赠送明细表
---------------------------------------
...
(
	...
	activcompid  			varchar(10)				NOT NULL,		--门店编号
	activinid				varchar(50)				NOT NULL,		--活动唯一编号
	activtype				int							NULL,		--赠送类型1:套餐A、2:套餐B、3:产品C
	activno	  				varchar(20)					NULL,		--项目\产品编号
	activname  				varchar(50)					NULL,		--项目\产品名称
	onecountprice			float						NULL,		--单次金额 
	givecount				int							NULL,		--赠送次数
	givetotal				float						NULL,		--赠送合计
	takeway					int							NULL,		--提成方式1:正常提成、2：设定提成、3：原价卡提
	takeamt					float						NULL,		--提成金额
	constraint pk_dactivitygive primary key nonclustered(id)
)
---------------------------------------
-----dgoodsreceiptlog     望子发货记录日志信息表
---------------------------------------
if not exists(select 1 from sysobjects where type='U' and name='dgoodsreceiptlog')
create table dgoodsreceiptlog	
(
	receiptbillid  			varchar(30)				NOT NULL,		--收货单号
	sendbillid				varchar(30)				NOT NULL,		--发货单号
	jsondata				ntext					NULL,		--发货数据
	logrecord				ntext					NULL,  		--记录日志信息
	receipttime				datetime	default(getdate()) NULL		--录入时间
