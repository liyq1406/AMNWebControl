...
if exists(select 1 from sysobjects where type='P' and name='upg_get_empinfo_by_date_comps')
	drop procedure upg_get_empinfo_by_date_comps
go
CREATE procedure upg_get_empinfo_by_date_comps          
(          
  @compid varchar(10),          
  @datefrom varchar(8),          
  @dateto varchar(8)          
