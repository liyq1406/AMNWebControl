if exists(select 1 from sysobjects where type='P' and name='upg_hand_staff_instore')
	drop procedure upg_hand_staff_instore
go
CREATE procedure upg_hand_staff_instore            
(              
  @compid varchar(10),              
  @datefrom varchar(8),              
  @dateto varchar(8)              
