if exists(select 1 from sysobjects where type='P' and name='upg_prepare_yeji_analysis')
	drop procedure upg_prepare_yeji_analysis
go
CREATE procedure upg_prepare_yeji_analysis(          
