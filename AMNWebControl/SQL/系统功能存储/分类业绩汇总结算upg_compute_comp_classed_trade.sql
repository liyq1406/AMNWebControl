...
if exists(select 1 from sysobjects where type='P' and name='upg_compute_comp_classed_trade')
	drop procedure upg_compute_comp_classed_trade
go
create procedure upg_compute_comp_classed_trade    
(
