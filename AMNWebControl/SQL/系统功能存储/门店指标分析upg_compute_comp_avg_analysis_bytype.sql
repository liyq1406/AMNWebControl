...
if exists(select 1 from sysobjects where type='P' and name='upg_compute_comp_avg_analysis_bytype')
	drop procedure upg_compute_comp_avg_analysis_bytype
go
create procedure upg_compute_comp_avg_analysis_bytype 
(                                    
	@compid varchar(10) ,                                    
	@datefrom varchar(8),                                    
	@dateto varchar(8),
