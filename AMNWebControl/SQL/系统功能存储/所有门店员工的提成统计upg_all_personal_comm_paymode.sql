if exists(select 1 from sysobjects where type='P' and name='upg_all_personal_comm_paymode')
	drop procedure upg_all_personal_comm_paymode
go
CREATE procedure upg_all_personal_comm_paymode(                                
