if exists(select 1 from sysobjects where type='P' and name='upg_analysis_system_error_new')
	drop procedure upg_analysis_system_error_new
go
CREATE procedure upg_analysis_system_error_new                      
(                      
	@compid varchar(10),                      
	@fromdate varchar(8),                      
	@todate varchar(8)                      
...
begin                      
 ...
 CREATE tAbLE	#msalecardinfo               -- 会员卡销售单
	...
	select salecompid,salebillid,saledate,salecardno,salecardtype,firstsalerid,firstsalerinid,firstsaleamt,secondsalerid,secondsalerinid,secondsaleamt,
                     thirdsalerid,thirdsalerinid,thirdsaleamt,fourthsalerid,fourthsalerinid,fourthsaleamt,fifthsalerid,fifthsalerinid,fifthsaleamt,
                     sixthsalerid,sixthsalerinid,sixthsaleamt,seventhsalerid,seventhsalerinid,seventhsaleamt,eighthsalerid,eighthsalerinid,eighthsaleamt,
                     ninthsalerid,ninthsalerinid,ninthsaleamt,tenthsalerid,tenthsalerinid,tenthsaleamt,financedate,salekeepamt,'',0
    from msalecardinfo
    where salecompid=@compid and financedate between @fromdate and @todate and ISNULL(salekeepamt,0)<>0 and ISNULL(salebakflag,0)=0
   ...
   begin              
		...
		select salebillid,salecardno,
				isnull(firstsalerid,''),isnull(secondsalerid,''),isnull(thirdsalerid,''),isnull(fourthsalerid,''),isnull(fifthsalerid,''),isnull(sixthsalerid,''),isnull(seventhsalerid,''),isnull(eighthsalerid,''),isnull(ninthsalerid,''),isnull(tenthsalerid,''),
					firstsaleamt,secondsaleamt,thirdsaleamt,fourthsaleamt,fifthsaleamt,sixthsaleamt,seventhsaleamt,eighthsaleamt,ninthsaleamt,tenthsaleamt,salekeepamt
				 from #msalecardinfo                         
        ...
        @e0003_ninthsaleamt,@e0003_tenthsaleamt,@e0003_salekeepamt            
	...
	select rechargecompid,rechargebillid,rechargedate,rechargetype,rechargecardno,rechargecardtype,firstsalerid,firstsalerinid,firstsaleamt,secondsalerid,secondsalerinid,secondsaleamt,
                     thirdsalerid,thirdsalerinid,thirdsaleamt,fourthsalerid,fourthsalerinid,fourthsaleamt,fifthsalerid,fifthsalerinid,fifthsaleamt,
                     sixthsalerid,sixthsalerinid,sixthsaleamt,seventhsalerid,seventhsalerinid,seventhsaleamt,eighthsalerid,eighthsalerinid,eighthsaleamt,
                     ninthsalerid,ninthsalerinid,ninthsaleamt,tenthsalerid,tenthsalerinid,tenthsaleamt,financedate,rechargekeepamt,'',0
    from mcardrechargeinfo
    where  rechargecompid=@compid and financedate between @fromdate and @todate and ISNULL(rechargekeepamt,0)<>0 and ISNULL(salebakflag,0)=0
   ...
   begin                        
		...
		select rechargebillid,rechargecardno, 
				isnull(firstsalerid,''),isnull(secondsalerid,''),isnull(thirdsalerid,''),isnull(fourthsalerid,''),isnull(fifthsalerid,''),isnull(sixthsalerid,''),isnull(seventhsalerid,''),isnull(eighthsalerid,''),isnull(ninthsalerid,''),isnull(tenthsalerid,''),
				firstsaleamt,secondsaleamt,thirdsaleamt,fourthsaleamt,fifthsaleamt,sixthsaleamt,seventhsaleamt,eighthsaleamt,ninthsaleamt,tenthsaleamt,rechargekeepamt
		from #mcardrechargeinfo              
        ...
        @e0003_ninthsaleamt_cz,@e0003_tenthsaleamt_cz,@e0003_rechargekeepamt_cz               
		...
		begin         
			...
			if(convert(numeric(20,1),ISNULL(@totalshareamt,0)-ISNULL(@trstaffshareamt,0))<>convert(numeric(20,1),ISNULL(@e0003_rechargekeepamt_cz,0)))
			     set @e0003_bill_mcardrechargeinfo=isnull(@e0003_bill_msalecardinfo,'')+'没有完全分享'
	...
	select changecompid,changebillid,changetype,changedate,changeaftercardno,changeaftercardtype,firstsalerid,firstsalerinid,firstsaleamt,secondsalerid,secondsalerinid,secondsaleamt,
                     thirdsalerid,thirdsalerinid,thirdsaleamt,fourthsalerid,fourthsalerinid,fourthsaleamt,fifthsalerid,fifthsalerinid,fifthsaleamt,
                     sixthsalerid,sixthsalerinid,sixthsaleamt,seventhsalerid,seventhsalerinid,seventhsaleamt,eighthsalerid,eighthsalerinid,eighthsaleamt,
                     ninthsalerid,ninthsalerinid,ninthsaleamt,tenthsalerid,tenthsalerinid,tenthsaleamt,financedate,changefillamt,'',0
    from mcardchangeinfo
    where  changecompid=@compid and financedate between @fromdate and @todate and ISNULL(changefillamt,0)<>0 and ISNULL(salebakflag,0)=0
	...
	begin                        
		...
		select changebillid, 
				isnull(firstsalerid,''),isnull(secondsalerid,''),isnull(thirdsalerid,''),isnull(fourthsalerid,''),isnull(fifthsalerid,''),isnull(sixthsalerid,''),isnull(seventhsalerid,''),isnull(eighthsalerid,''),isnull(ninthsalerid,''),isnull(tenthsalerid,''),
				firstsaleamt,secondsaleamt,thirdsaleamt,fourthsaleamt,fifthsaleamt,sixthsaleamt,seventhsaleamt,eighthsaleamt,ninthsaleamt,tenthsaleamt,changefillamt
		from #mcardchangeinfo              
		...
		fetch cur_#mcardchangeinfoerr3 into  @e0003_changebillid,
				...
				@e0003_ninthsaleamt_zk,@e0003_tenthsaleamt_zk,@e0003_changefillamt_zk                     
		while(@@fetch_status=0)                        
		begin  
			set @e0003_bill_mcardchangeinfo=''
			set @mfstaffshareamt=0
			...
			if(ISNULL(@trstaffshareamt,0)>ISNULL(@mfstaffshareamt,0))
			 ...
			 if(ISNULL(@trstaffsharecount,0)>ISNULL(@mfstaffsharecount,0))
			  ...
			  if(convert(numeric(20,1),ISNULL(@totalshareamt,0)-ISNULL(@trstaffshareamt,0))<>convert(numeric(20,1),ISNULL(@e0003_changefillamt_zk,0)))
			     set @e0003_bill_mcardchangeinfo=isnull(@e0003_bill_msalecardinfo,'')+'没有完全分享'   
