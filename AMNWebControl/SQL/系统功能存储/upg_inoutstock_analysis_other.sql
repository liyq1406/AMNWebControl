...
begin              
	...
	(              
       ...
       and a.changetype='1'  and a.changebillno not like '%e'          
     ...
     select ordergoodsno,headwareno,isnull(sum(downordercount),0),isnull(sum(downorderamt),0)               
      ...
      where a.ordercompid=b.ordercompid and a.orderbillid=b.orderbillid                
       ...
       group by ordergoodsno,headwareno               
		...
		select goodsno=x.goodsno,goodsname=x.goodsname,garageno=x.goodswarehouse,garagename=z.warehousename,              
		...
		from goodsinfo x,  compwarehouse z, #endstockquan a            
		...
		group by x.goodsno,x.goodsname,x.goodswarehouse,z.warehousename,x.saleunit            
		order by x.goodsno            
