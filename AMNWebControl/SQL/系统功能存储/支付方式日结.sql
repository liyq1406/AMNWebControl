...
if exists(select 1 from sysobjects where type='P' and name='upg_compute_comp_trade_payinfo_daybyday')
	drop procedure upg_compute_comp_trade_payinfo_daybyday
go
create procedure upg_compute_comp_trade_payinfo_daybyday 
(
