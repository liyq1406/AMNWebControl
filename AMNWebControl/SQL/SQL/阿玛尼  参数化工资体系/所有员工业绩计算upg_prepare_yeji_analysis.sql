exec upg_compute_comp_satff_salary_daybyday  '002','20140913','20140913'
select * from msalecardinfo where salebillid='00220140913003'
select * from mcardrechargeinfo where rechargebillid='00220140913001'

select * from staffinfo

alter procedure upg_prepare_yeji_analysis(            
...
begin
 ...
 (  
  ...
  beautyManager varchar(20) null, --美容经理/顾问1
  beautyManagerinid  varchar(20) null,--美容经理/顾问1 内部编号
  consultant varchar(20) null,  ----美容经理/顾问2
  consultantinid varchar(20) null,--美容经理/顾问1   内部编号
  beautyPerf float null,  --美容经理/顾问1 业绩
  consultantPerf float null, --美容经理/顾问2 业绩
  consultant1Perf float null, --美容经理/顾问3业绩
  consultant1 varchar(20) null,--美容经理/顾问3
  consultant1inid varchar(20) null, --美容经理/顾问3 内部工号
  ...
  tenthsalecashamt		float					NULL,   --第十销售分享金额(实际现金业绩)
    ...
    insert #msalecardinfo(salecompid,salebillid,saledate,salecardno,salecardtype,firstsalerid,firstsalerinid,firstsaleamt,secondsalerid,secondsalerinid,secondsaleamt,  
                     ...
                     financedate,salekeepamt,paymode,payamt,billinsertype,beautyManager,beautyManagerinid,consultant,consultantinid,beautyPerf,consultantPerf,consultant1Perf,consultant1,consultant1inid)  
 select salecompid,salebillid,saledate,salecardno,salecardtype,firstsalerid,firstsalerinid,firstsaleamt,secondsalerid,secondsalerinid,secondsaleamt,  
                     ...
                     ninthsalerid,ninthsalerinid,ninthsaleamt,tenthsalerid,tenthsalerinid,tenthsaleamt,
                     firstsalecashamt,secondsalecashamt,thirdsalecashamt,fourthsalecashamt,fifthsalecashamt,sixthsalecashamt,seventhsalecashamt,eighthsalecashamt,ninthsalecashamt,tenthsalecashamt,
                     financedate,salekeepamt,paymode,payamt,case when isnull(@sp102,'0')='1' then ISNULL(billinsertype,0) else 0 end,beautyManager,beautyManagerinid,consultant,consultantinid,beautyPerf,consultantPerf,consultant1Perf,consultant1,consultant1inid  
 ...
 --卖卡第一销售人员            
 insert #allstaff_work_detail(compid,person_inid,action_id,srvdate,code,name,billamt,ccount,billid,paycode,staffshareyeji,staffyeji,billinsertype)            
 select @compid,firstsalerinid,1,financedate,salecardno,cardtypename,payamt,1,salebillid,paymode,firstsaleamt*payamt/isnull(salekeepamt,1),firstsalecashamt*payamt/isnull(salekeepamt,1) ,ISNULL(billinsertype,0)           
 ...
 where  isnull(firstsaleamt,0)<>0     and ISNULL(firstsalerinid,'')<>''            
    ...
    --卖卡第二销售人员            
 insert #allstaff_work_detail(compid,person_inid,action_id,srvdate,code,name,billamt,ccount,billid,paycode,staffshareyeji,staffyeji,billinsertype)            
 select @compid,secondsalerinid,1,financedate,salecardno,cardtypename,payamt,1,salebillid,paymode,secondsaleamt*payamt/isnull(salekeepamt,1),secondsalecashamt*payamt/isnull(salekeepamt,1) ,ISNULL(billinsertype,0)           
 from #msalecardinfo a,cardtypenameinfo c           
 where isnull(secondsaleamt,0)<>0     and ISNULL(secondsalerinid,'')<>''            
    and salecardtype=cardtypeno       
    --卖卡第三销售人员            
 insert #allstaff_work_detail(compid,person_inid,action_id,srvdate,code,name,billamt,ccount,billid,paycode,staffshareyeji,staffyeji,billinsertype)            
 select @compid,thirdsalerinid,1,financedate,salecardno,cardtypename,payamt,1,salebillid,paymode,thirdsaleamt*payamt/isnull(salekeepamt,1),thirdsalecashamt*payamt/isnull(salekeepamt,1) ,ISNULL(billinsertype,0)           
 from #msalecardinfo a,cardtypenameinfo c            
 where isnull(thirdsaleamt,0)<>0 and ISNULL(thirdsalerinid,'')<>''   
    and salecardtype=cardtypeno   
    --卖卡第四销售人员            
 insert #allstaff_work_detail(compid,person_inid,action_id,srvdate,code,name,billamt,ccount,billid,paycode,staffshareyeji,staffyeji,billinsertype)            
 select @compid,fourthsalerinid,1,financedate,salecardno,cardtypename,payamt,1,salebillid,paymode,fourthsaleamt*payamt/isnull(salekeepamt,1),fourthsalecashamt*payamt/isnull(salekeepamt,1) ,ISNULL(billinsertype,0)           
 from #msalecardinfo a ,cardtypenameinfo c          
 where isnull(fourthsaleamt,0)<>0  and ISNULL(fourthsalerinid,'')<>''   
    and salecardtype=cardtypeno   
    --卖卡第五销售人员            
 insert #allstaff_work_detail(compid,person_inid,action_id,srvdate,code,name,billamt,ccount,billid,paycode,staffshareyeji,staffyeji,billinsertype)            
 select @compid,fifthsalerinid,1,financedate,salecardno,cardtypename,payamt,1,salebillid,paymode,fifthsaleamt*payamt/isnull(salekeepamt,1),fifthsalecashamt*payamt/isnull(salekeepamt,1) ,ISNULL(billinsertype,0)           
 from #msalecardinfo a,cardtypenameinfo c           
 where  isnull(fifthsaleamt,0)<>0  and ISNULL(fifthsalerinid,'')<>''   
    and salecardtype=cardtypeno   
    --卖卡第六销售人员            
 insert #allstaff_work_detail(compid,person_inid,action_id,srvdate,code,name,billamt,ccount,billid,paycode,staffshareyeji,staffyeji,billinsertype)            
 select @compid,sixthsalerinid,1,financedate,salecardno,cardtypename,payamt,1,salebillid,paymode,sixthsaleamt*payamt/isnull(salekeepamt,1),sixthsalecashamt*payamt/isnull(salekeepamt,1) ,ISNULL(billinsertype,0)           
 from #msalecardinfo a,cardtypenameinfo c           
 where  isnull(sixthsaleamt,0)<>0  and ISNULL(sixthsalerinid,'')<>''   
    and salecardtype=cardtypeno   
    --卖卡第七销售人员            
 insert #allstaff_work_detail(compid,person_inid,action_id,srvdate,code,name,billamt,ccount,billid,paycode,staffshareyeji,staffyeji,billinsertype)            
 select @compid,seventhsalerinid,1,financedate,salecardno,cardtypename,payamt,1,salebillid,paymode,seventhsaleamt*payamt/isnull(salekeepamt,1),seventhsalecashamt*payamt/isnull(salekeepamt,1) ,ISNULL(billinsertype,0)           
 from #msalecardinfo a ,cardtypenameinfo c          
 where  isnull(seventhsaleamt,0)<>0 and ISNULL(seventhsalerinid,'')<>''   
    and salecardtype=cardtypeno    
    --卖卡第八销售人员            
 insert #allstaff_work_detail(compid,person_inid,action_id,srvdate,code,name,billamt,ccount,billid,paycode,staffshareyeji,staffyeji,billinsertype)            
 select @compid,eighthsalerinid,1,financedate,salecardno,cardtypename,payamt,1,salebillid,paymode,eighthsaleamt*payamt/isnull(salekeepamt,1),eighthsalecashamt*payamt/isnull(salekeepamt,1) ,ISNULL(billinsertype,0)           
 from #msalecardinfo a ,cardtypenameinfo c          
 where  isnull(eighthsaleamt,0)<>0 and ISNULL(eighthsalerinid,'')<>''   
    and salecardtype=cardtypeno   
    --卖卡第九销售人员  ,cardtypenameinfo c             
 insert #allstaff_work_detail(compid,person_inid,action_id,srvdate,code,name,billamt,ccount,billid,paycode,staffshareyeji,staffyeji,billinsertype)            
 select @compid,ninthsalerinid,1,financedate,salecardno,cardtypename,payamt,1,salebillid,paymode,ninthsaleamt*payamt/isnull(salekeepamt,1),ninthsalecashamt*payamt/isnull(salekeepamt,1) ,ISNULL(billinsertype,0)           
 from #msalecardinfo a ,cardtypenameinfo c          
 where isnull(ninthsaleamt,0)<>0 and ISNULL(ninthsalerinid,'')<>''   
    and salecardtype=cardtypeno   
    --卖卡第十销售人员            
 insert #allstaff_work_detail(compid,person_inid,action_id,srvdate,code,name,billamt,ccount,billid,paycode,staffshareyeji,staffyeji,billinsertype)            
 select @compid,tenthsalerinid,1,financedate,salecardno,cardtypename,payamt,1,salebillid,paymode,tenthsaleamt*payamt/isnull(salekeepamt,1),tenthsalecashamt*payamt/isnull(salekeepamt,1) ,ISNULL(billinsertype,0)           
 from #msalecardinfo a  ,cardtypenameinfo c         
 where isnull(tenthsaleamt,0)<>0 and ISNULL(tenthsalerinid,'')<>''   
	...
	--美容经理/顾问
	insert #allstaff_work_detail(compid,person_inid,action_id,srvdate,code,name,billamt,ccount,billid,paycode,staffshareyeji,staffyeji,billinsertype)            
 select @compid,beautyManagerinid,1,financedate,salecardno,cardtypename,payamt,1,salebillid,paymode,0,beautyPerf ,ISNULL(billinsertype,0)           
 from #msalecardinfo a  ,cardtypenameinfo c         
 where isnull(beautyPerf,0)<>0 and ISNULL(beautyManagerinid,'')<>''   
    and salecardtype=cardtypeno  


	insert #allstaff_work_detail(compid,person_inid,action_id,srvdate,code,name,billamt,ccount,billid,paycode,staffshareyeji,staffyeji,billinsertype)            
 select @compid,consultantinid,1,financedate,salecardno,cardtypename,payamt,1,salebillid,paymode,0,consultantPerf ,ISNULL(billinsertype,0)           
 from #msalecardinfo a  ,cardtypenameinfo c         
 where isnull(consultantPerf,0)<>0 and ISNULL(consultantinid,'')<>''   
    and salecardtype=cardtypeno  


	insert #allstaff_work_detail(compid,person_inid,action_id,srvdate,code,name,billamt,ccount,billid,paycode,staffshareyeji,staffyeji,billinsertype)            
 select @compid,consultant1inid,1,financedate,salecardno,cardtypename,payamt,1,salebillid,paymode,0,consultant1Perf ,ISNULL(billinsertype,0)           
 from #msalecardinfo a  ,cardtypenameinfo c         
 where isnull(consultant1Perf,0)<>0 and ISNULL(consultant1inid,'')<>''   
    and salecardtype=cardtypeno  
 ...
 insert #mcardrechargeinfo(rechargecompid,rechargebillid,rechargedate,rechargetype,rechargecardno,rechargecardtype,firstsalerid,firstsalerinid,firstsaleamt,secondsalerid,secondsalerinid,secondsaleamt,  
                     ...
                     ninthsalerid,ninthsalerinid,ninthsaleamt,tenthsalerid,tenthsalerinid,tenthsaleamt,
                     firstsalecashamt,secondsalecashamt,thirdsalecashamt,fourthsalecashamt,fifthsalecashamt,sixthsalecashamt,seventhsalecashamt,eighthsalecashamt,ninthsalecashamt,tenthsalecashamt,
                     financedate,rechargekeepamt,paymode,payamt,billinsertype,beautyManager,beautyManagerinid,consultant,consultantinid,beautyPerf,consultantPerf,consultant1Perf,consultant1,consultant1inid)  
 select rechargecompid,rechargebillid,rechargedate,rechargetype,rechargecardno,rechargecardtype,firstsalerid,firstsalerinid,firstsaleamt,secondsalerid,secondsalerinid,secondsaleamt,  
                     ...
                     ninthsalerid,ninthsalerinid,ninthsaleamt,tenthsalerid,tenthsalerinid,tenthsaleamt,
                     firstsalecashamt,secondsalecashamt,thirdsalecashamt,fourthsalecashamt,fifthsalecashamt,sixthsalecashamt,seventhsalecashamt,eighthsalecashamt,ninthsalecashamt,tenthsalecashamt,
                     financedate,rechargekeepamt,paymode,payamt ,case when isnull(@sp102,'0')='1' then ISNULL(billinsertype,0) else 0 end,beautyManager,beautyManagerinid,consultant,consultantinid,beautyPerf,consultantPerf,consultant1Perf,consultant1,consultant1inid
 ...
 where rechargecardno=cardno and ISNULL(rechargetype,0)=1  
  --卖卡第一销售人员            
 insert #allstaff_work_detail(compid,person_inid,action_id,srvdate,code,name,billamt,ccount,billid,paycode,staffshareyeji,staffyeji,billinsertype)            
 select @compid,firstsalerinid,2,financedate,rechargecardno,cardtypename,payamt,1,rechargebillid,paymode,firstsaleamt*payamt/isnull(rechargekeepamt,1),firstsalecashamt*payamt/isnull(rechargekeepamt,1) ,ISNULL(billinsertype,0)           
 from #mcardrechargeinfo a  ,cardtypenameinfo c           
 where isnull(firstsaleamt,0)<>0    and ISNULL(firstsalerinid,'')<>''         
    and rechargecardtype=cardtypeno  
    --卖卡第二销售人员            
 insert #allstaff_work_detail(compid,person_inid,action_id,srvdate,code,name,billamt,ccount,billid,paycode,staffshareyeji,staffyeji,billinsertype)            
 select @compid,secondsalerinid,2,financedate,rechargecardno,cardtypename,payamt,1,rechargebillid,paymode,secondsaleamt*payamt/isnull(rechargekeepamt,1),secondsalecashamt*payamt/isnull(rechargekeepamt,1),ISNULL(billinsertype,0)            
 from #mcardrechargeinfo a  ,cardtypenameinfo c           
 where isnull(secondsaleamt,0)<>0   and ISNULL(secondsalerinid,'')<>''            
     and rechargecardtype=cardtypeno      
    --卖卡第三销售人员            
 insert #allstaff_work_detail(compid,person_inid,action_id,srvdate,code,name,billamt,ccount,billid,paycode,staffshareyeji,staffyeji,billinsertype)            
 select @compid,thirdsalerinid,2,financedate,rechargecardno,cardtypename,payamt,1,rechargebillid,paymode,thirdsaleamt*payamt/isnull(rechargekeepamt,1),thirdsalecashamt*payamt/isnull(rechargekeepamt,1) ,ISNULL(billinsertype,0)           
 from #mcardrechargeinfo a   ,cardtypenameinfo c          
 where  isnull(thirdsaleamt,0)<>0 and ISNULL(thirdsalerinid,'')<>''  
     and rechargecardtype=cardtypeno  
    --卖卡第四销售人员            
 insert #allstaff_work_detail(compid,person_inid,action_id,srvdate,code,name,billamt,ccount,billid,paycode,staffshareyeji,staffyeji,billinsertype)            
 select @compid,fourthsalerinid,2,financedate,rechargecardno,cardtypename,payamt,1,rechargebillid,paymode,fourthsaleamt*payamt/isnull(rechargekeepamt,1),fourthsalecashamt*payamt/isnull(rechargekeepamt,1),ISNULL(billinsertype,0)            
 from #mcardrechargeinfo a    ,cardtypenameinfo c         
 where  isnull(fourthsaleamt,0)<>0 and ISNULL(fourthsalerinid,'')<>''  
     and rechargecardtype=cardtypeno  
    --卖卡第五销售人员            
 insert #allstaff_work_detail(compid,person_inid,action_id,srvdate,code,name,billamt,ccount,billid,paycode,staffshareyeji,staffyeji,billinsertype)            
 select @compid,fifthsalerinid,2,financedate,rechargecardno,cardtypename,payamt,1,rechargebillid,paymode,fifthsaleamt*payamt/isnull(rechargekeepamt,1),fifthsalecashamt*payamt/isnull(rechargekeepamt,1) ,ISNULL(billinsertype,0)           
 from #mcardrechargeinfo a  ,cardtypenameinfo c           
 where  isnull(fifthsaleamt,0)<>0 and ISNULL(fifthsalerinid,'')<>''  
     and rechargecardtype=cardtypeno  
    --卖卡第六销售人员            
 insert #allstaff_work_detail(compid,person_inid,action_id,srvdate,code,name,billamt,ccount,billid,paycode,staffshareyeji,staffyeji,billinsertype)            
 select @compid,sixthsalerinid,2,financedate,rechargecardno,cardtypename,payamt,1,rechargebillid,paymode,sixthsaleamt*payamt/isnull(rechargekeepamt,1),sixthsalecashamt*payamt/isnull(rechargekeepamt,1),ISNULL(billinsertype,0)           
 from #mcardrechargeinfo a ,cardtypenameinfo c         
 where isnull(sixthsaleamt,0)<>0 and ISNULL(sixthsalerinid,'')<>''  
    and rechargecardtype=cardtypeno   
    --卖卡第七销售人员            
 insert #allstaff_work_detail(compid,person_inid,action_id,srvdate,code,name,billamt,ccount,billid,paycode,staffshareyeji,staffyeji,billinsertype)            
 select @compid,seventhsalerinid,2,financedate,rechargecardno,cardtypename,payamt,1,rechargebillid,paymode,seventhsaleamt*payamt/isnull(rechargekeepamt,1),seventhsalecashamt*payamt/isnull(rechargekeepamt,1),ISNULL(billinsertype,0)            
 from #mcardrechargeinfo a ,cardtypenameinfo c            
 where isnull(seventhsaleamt,0)<>0 and ISNULL(seventhsalerinid,'')<>''  
     and rechargecardtype=cardtypeno  
    --卖卡第八销售人员            
 insert #allstaff_work_detail(compid,person_inid,action_id,srvdate,code,name,billamt,ccount,billid,paycode,staffshareyeji,staffyeji,billinsertype)            
 select @compid,eighthsalerinid,2,financedate,rechargecardno,cardtypename,payamt,1,rechargebillid,paymode,eighthsaleamt*payamt/isnull(rechargekeepamt,1),eighthsalecashamt*payamt/isnull(rechargekeepamt,1) ,ISNULL(billinsertype,0)           
 from #mcardrechargeinfo a  ,cardtypenameinfo c           
 where isnull(eighthsaleamt,0)<>0 and ISNULL(eighthsalerinid,'')<>''  
     and rechargecardtype=cardtypeno  
    --卖卡第九销售人员            
 insert #allstaff_work_detail(compid,person_inid,action_id,srvdate,code,name,billamt,ccount,billid,paycode,staffshareyeji,staffyeji,billinsertype)            
 select @compid,ninthsalerinid,2,financedate,rechargecardno,cardtypename,payamt,1,rechargebillid,paymode,ninthsaleamt*payamt/isnull(rechargekeepamt,1),ninthsalecashamt*payamt/isnull(rechargekeepamt,1) ,ISNULL(billinsertype,0)           
 from #mcardrechargeinfo a  ,cardtypenameinfo c           
 where  isnull(ninthsaleamt,0)<>0  and ISNULL(ninthsalerinid,'')<>''  
     and rechargecardtype=cardtypeno  
    --卖卡第十销售人员            
 insert #allstaff_work_detail(compid,person_inid,action_id,srvdate,code,name,billamt,ccount,billid,paycode,staffshareyeji,staffyeji,billinsertype)            
 select @compid,tenthsalerinid,2,financedate,rechargecardno,cardtypename,payamt,1,rechargebillid,paymode,tenthsaleamt*payamt/isnull(rechargekeepamt,1),tenthsalecashamt*payamt/isnull(rechargekeepamt,1) ,ISNULL(billinsertype,0)           
 from #mcardrechargeinfo a  ,cardtypenameinfo c           
 where  isnull(tenthsaleamt,0)<>0  and ISNULL(tenthsalerinid,'')<>''  
    and rechargecardtype=cardtypeno  
	...
	insert #allstaff_work_detail(compid,person_inid,action_id,srvdate,code,name,billamt,ccount,billid,paycode,staffshareyeji,staffyeji,billinsertype)            
 select @compid,consultantinid,88,financedate,rechargecardno,cardtypename,payamt,1,rechargebillid,paymode,0,consultantPerf,ISNULL(billinsertype,0)           
 from #mcardrechargeinfo a  ,cardtypenameinfo c           
 where  isnull(consultantPerf,0)<>0  and ISNULL(consultantinid,'')<>''  
    and rechargecardtype=cardtypeno 
	...
	insert #allstaff_work_detail(compid,person_inid,action_id,srvdate,code,name,billamt,ccount,billid,paycode,staffshareyeji,staffyeji,billinsertype)            
 select @compid,beautyManagerinid,88,financedate,rechargecardno,cardtypename,payamt,1,rechargebillid,paymode,0,beautyPerf,ISNULL(billinsertype,0)           
 from #mcardrechargeinfo a  ,cardtypenameinfo c           
 where  isnull(beautyPerf,0)<>0  and ISNULL(beautyManagerinid,'')<>''  
    and rechargecardtype=cardtypeno 
	...
	insert #allstaff_work_detail(compid,person_inid,action_id,srvdate,code,name,billamt,ccount,billid,paycode,staffshareyeji,staffyeji,billinsertype)            
 select @compid,consultant1inid,88,financedate,rechargecardno,cardtypename,payamt,1,rechargebillid,paymode,0,consultant1Perf,ISNULL(billinsertype,0)           
 from #mcardrechargeinfo a  ,cardtypenameinfo c           
 where  isnull(consultant1Perf,0)<>0  and ISNULL(consultant1inid,'')<>''  
    and rechargecardtype=cardtypeno 
 ...
 insert #mcardchangeinfo(changecompid,changebillid,changetype,changedate,changeaftercardno,changeaftercardtype,firstsalerid,firstsalerinid,firstsaleamt,secondsalerid,secondsalerinid,secondsaleamt,  
                     ...
                     ninthsalerid,ninthsalerinid,ninthsaleamt,tenthsalerid,tenthsalerinid,tenthsaleamt,
                     firstsalecashamt,secondsalecashamt,thirdsalecashamt,fourthsalecashamt,fifthsalecashamt,sixthsalecashamt,seventhsalecashamt,eighthsalecashamt,ninthsalecashamt,tenthsalecashamt,
                     financedate,changefillamt,paymode,payamt,billinsertype,beautyManager,beautyManagerinid,consultant,consultantinid,beautyPerf,consultantPerf,consultant1Perf,consultant1,consultant1inid)  
 select changecompid,changebillid,changetype,changedate,changeaftercardno,changeaftercardtype,firstsalerid,firstsalerinid,firstsaleamt,secondsalerid,secondsalerinid,secondsaleamt,  
                     ...
                     ninthsalerid,ninthsalerinid,ninthsaleamt,tenthsalerid,tenthsalerinid,tenthsaleamt,
                     firstsalecashamt,secondsalecashamt,thirdsalecashamt,fourthsalecashamt,fifthsalecashamt,sixthsalecashamt,seventhsalecashamt,eighthsalecashamt,ninthsalecashamt,tenthsalecashamt,
                     financedate,changefillamt,paymode,payamt ,case when isnull(@sp102,'0')='1' then ISNULL(billinsertype,0) else 0 end,beautyManager,beautyManagerinid,consultant,consultantinid,beautyPerf,consultantPerf,consultant1Perf,consultant1,consultant1inid
    ...
    where changebillid=paybillid and changecompid=paycompid and paybilltype in ('ZK','TK')  
      ...
      --卖卡第一销售人员            
 insert #allstaff_work_detail(compid,person_inid,action_id,srvdate,code,name,billamt,ccount,billid,paycode,staffshareyeji,staffyeji,billinsertype)            
 select @compid,firstsalerinid,3,financedate,changeaftercardno,cardtypename,case when isnull(changetype,0)=8  then (-1)*payamt else payamt end ,1,changebillid,paymode,case when isnull(changetype,0)=8  then (-1)*firstsaleamt*payamt/isnull(changefillamt,1) else   firstsaleamt*payamt/isnull(changefillamt,1) end,case when isnull(changetype,0)=8  then (-1)*firstsalecashamt*payamt/isnull(changefillamt,1) else   firstsalecashamt*payamt/isnull(changefillamt,1) end,ISNULL(billinsertype,0)           
 from     #mcardchangeinfo a  left join cardtypenameinfo c  on changeaftercardtype=cardtypeno   
 where isnull(firstsaleamt,0)<>0   and ISNULL(firstsalerinid,'')<>''   
  
    --卖卡第二销售人员            
 insert #allstaff_work_detail(compid,person_inid,action_id,srvdate,code,name,billamt,ccount,billid,paycode,staffshareyeji,staffyeji,billinsertype)            
 select @compid,secondsalerinid,3,financedate,changeaftercardno,cardtypename,case when isnull(changetype,0)=8  then (-1)*payamt else payamt end,1,changebillid,paymode,case when isnull(changetype,0)=8  then (-1)*secondsaleamt*payamt/isnull(changefillamt,1) else   secondsaleamt*payamt/isnull(changefillamt,1) end,case when isnull(changetype,0)=8  then (-1)*secondsalecashamt*payamt/isnull(changefillamt,1) else   secondsalecashamt*payamt/isnull(changefillamt,1) end ,ISNULL(billinsertype,0)       
 from     #mcardchangeinfo a  left join cardtypenameinfo c  on changeaftercardtype=cardtypeno   
 where isnull(secondsaleamt,0)<>0    and ISNULL(secondsalerinid,'')<>''              
  
    --卖卡第三销售人员            
 insert #allstaff_work_detail(compid,person_inid,action_id,srvdate,code,name,billamt,ccount,billid,paycode,staffshareyeji,staffyeji,billinsertype)            
 select @compid,thirdsalerinid,3,financedate,changeaftercardno,cardtypename,case when isnull(changetype,0)=8  then (-1)*payamt else payamt end,1,changebillid,paymode,case when isnull(changetype,0)=8  then (-1)*thirdsaleamt*payamt/isnull(changefillamt,1) else   thirdsaleamt*payamt/isnull(changefillamt,1) end,case when isnull(changetype,0)=8  then (-1)*thirdsalecashamt*payamt/isnull(changefillamt,1) else   thirdsalecashamt*payamt/isnull(changefillamt,1) end,ISNULL(billinsertype,0)     
 from     #mcardchangeinfo a  left join cardtypenameinfo c  on changeaftercardtype=cardtypeno   
 where isnull(thirdsaleamt,0)<>0  and ISNULL(thirdsalerinid,'')<>''              
  
    --卖卡第四销售人员            
 insert #allstaff_work_detail(compid,person_inid,action_id,srvdate,code,name,billamt,ccount,billid,paycode,staffshareyeji,staffyeji,billinsertype)            
 select @compid,fourthsalerinid,3,financedate,changeaftercardno,cardtypename,case when isnull(changetype,0)=8  then (-1)*payamt else payamt end,1,changebillid,paymode,case when isnull(changetype,0)=8  then (-1)*fourthsaleamt*payamt/isnull(changefillamt,1) else   fourthsaleamt*payamt/isnull(changefillamt,1) end,case when isnull(changetype,0)=8  then (-1)*fourthsalecashamt*payamt/isnull(changefillamt,1) else   fourthsalecashamt*payamt/isnull(changefillamt,1) end,ISNULL(billinsertype,0)         
 from     #mcardchangeinfo a  left join cardtypenameinfo c  on changeaftercardtype=cardtypeno   
 where isnull(fourthsaleamt,0)<>0  and ISNULL(fourthsalerinid,'')<>''              
  
    --卖卡第五销售人员            
 insert #allstaff_work_detail(compid,person_inid,action_id,srvdate,code,name,billamt,ccount,billid,paycode,staffshareyeji,staffyeji,billinsertype)            
 select @compid,fifthsalerinid,3,financedate,changeaftercardno,cardtypename,case when isnull(changetype,0)=8  then (-1)*payamt else payamt end,1,changebillid,paymode,case when isnull(changetype,0)=8  then (-1)*fifthsaleamt*payamt/isnull(changefillamt,1) else   fifthsaleamt*payamt/isnull(changefillamt,1) end,case when isnull(changetype,0)=8  then (-1)*fifthsalecashamt*payamt/isnull(changefillamt,1) else   fifthsalecashamt*payamt/isnull(changefillamt,1) end ,ISNULL(billinsertype,0)    
 from     #mcardchangeinfo a  left join cardtypenameinfo c  on changeaftercardtype=cardtypeno   
 where isnull(fifthsaleamt,0)<>0  and ISNULL(fifthsalerinid,'')<>''              
  
    --卖卡第六销售人员            
 insert #allstaff_work_detail(compid,person_inid,action_id,srvdate,code,name,billamt,ccount,billid,paycode,staffshareyeji,staffyeji,billinsertype)            
 select @compid,sixthsalerinid,3,financedate,changeaftercardno,cardtypename,case when isnull(changetype,0)=8  then (-1)*payamt else payamt end,1,changebillid,paymode,case when isnull(changetype,0)=8  then (-1)*sixthsaleamt*payamt/isnull(changefillamt,1) else   sixthsaleamt*payamt/isnull(changefillamt,1) end,case when isnull(changetype,0)=8  then (-1)*sixthsalecashamt*payamt/isnull(changefillamt,1) else   sixthsalecashamt*payamt/isnull(changefillamt,1) end ,ISNULL(billinsertype,0)         
 from     #mcardchangeinfo a  left join cardtypenameinfo c  on changeaftercardtype=cardtypeno   
 where isnull(sixthsaleamt,0)<>0 and ISNULL(sixthsalerinid,'')<>''              
     
    --卖卡第七销售人员            
 insert #allstaff_work_detail(compid,person_inid,action_id,srvdate,code,name,billamt,ccount,billid,paycode,staffshareyeji,staffyeji,billinsertype)            
 select @compid,seventhsalerinid,3,financedate,changeaftercardno,cardtypename,case when isnull(changetype,0)=8  then (-1)*payamt else payamt end,1,changebillid,paymode,case when isnull(changetype,0)=8  then (-1)*seventhsaleamt*payamt/isnull(changefillamt,1) else   seventhsaleamt*payamt/isnull(changefillamt,1) end,case when isnull(changetype,0)=8  then (-1)*seventhsalecashamt*payamt/isnull(changefillamt,1) else   seventhsalecashamt*payamt/isnull(changefillamt,1) end,ISNULL(billinsertype,0)            
 from     #mcardchangeinfo a  left join cardtypenameinfo c  on changeaftercardtype=cardtypeno   
 where  isnull(seventhsaleamt,0)<>0 and ISNULL(seventhsalerinid,'')<>''      
     
    --卖卡第八销售人员            
 insert #allstaff_work_detail(compid,person_inid,action_id,srvdate,code,name,billamt,ccount,billid,paycode,staffshareyeji,staffyeji,billinsertype)            
 select @compid,eighthsalerinid,3,financedate,changeaftercardno,cardtypename,case when isnull(changetype,0)=8  then (-1)*payamt else payamt end,1,changebillid,paymode,case when isnull(changetype,0)=8  then (-1)*eighthsaleamt*payamt/isnull(changefillamt,1) else   eighthsaleamt*payamt/isnull(changefillamt,1) end ,case when isnull(changetype,0)=8  then (-1)*eighthsalecashamt*payamt/isnull(changefillamt,1) else   eighthsalecashamt*payamt/isnull(changefillamt,1) end,ISNULL(billinsertype,0)    
 from     #mcardchangeinfo a  left join cardtypenameinfo c  on changeaftercardtype=cardtypeno   
 where isnull(eighthsaleamt,0)<>0  and ISNULL(eighthsalerinid,'')<>''    
     
    --卖卡第九销售人员            
 insert #allstaff_work_detail(compid,person_inid,action_id,srvdate,code,name,billamt,ccount,billid,paycode,staffshareyeji,staffyeji,billinsertype)            
 select @compid,ninthsalerinid,3,financedate,changeaftercardno,cardtypename,case when isnull(changetype,0)=8  then (-1)*payamt else payamt end,1,changebillid,paymode,case when isnull(changetype,0)=8  then (-1)*ninthsaleamt*payamt/isnull(changefillamt,1) else  ninthsaleamt*payamt/isnull(changefillamt,1) end,case when isnull(changetype,0)=8  then (-1)*ninthsalecashamt*payamt/isnull(changefillamt,1) else  ninthsalecashamt*payamt/isnull(changefillamt,1) end ,ISNULL(billinsertype,0)    
 from     #mcardchangeinfo a  left join cardtypenameinfo c  on changeaftercardtype=cardtypeno   
 where isnull(ninthsaleamt,0)<>0 and ISNULL(ninthsalerinid,'')<>''    
     
    --卖卡第十销售人员            
 insert #allstaff_work_detail(compid,person_inid,action_id,srvdate,code,name,billamt,ccount,billid,paycode,staffshareyeji,staffyeji,billinsertype)            
 select @compid,tenthsalerinid,3,financedate,changeaftercardno,cardtypename,case when isnull(changetype,0)=8  then (-1)*payamt else payamt end,1,changebillid,paymode,case when isnull(changetype,0)=8  then (-1)*tenthsaleamt*payamt/isnull(changefillamt,1) else   tenthsaleamt*payamt/isnull(changefillamt,1) end, case when isnull(changetype,0)=8  then (-1)*tenthsalecashamt*payamt/isnull(changefillamt,1) else   tenthsalecashamt*payamt/isnull(changefillamt,1) end ,ISNULL(billinsertype,0)    
 from     #mcardchangeinfo a  left join cardtypenameinfo c  on changeaftercardtype=cardtypeno   
 where isnull(tenthsaleamt,0)<>0  and ISNULL(tenthsalerinid,'')<>''    
     
 --美容经理/顾问
 insert #allstaff_work_detail(compid,person_inid,action_id,srvdate,code,name,billamt,ccount,billid,paycode,staffshareyeji,staffyeji,billinsertype)            
 select @compid,beautyManagerinid,88,financedate,changeaftercardno,cardtypename,payamt,1,changebillid,paymode,0,beautyPerf,ISNULL(billinsertype,0)    
 from     #mcardchangeinfo a  left join cardtypenameinfo c  on changeaftercardtype=cardtypeno   
 where isnull(beautyPerf,0)<>0  and ISNULL(beautyManagerinid,'')<>''   


 insert #allstaff_work_detail(compid,person_inid,action_id,srvdate,code,name,billamt,ccount,billid,paycode,staffshareyeji,staffyeji,billinsertype)            
 select @compid,consultantinid,88,financedate,changeaftercardno,cardtypename,payamt,1,changebillid,paymode,0,consultantPerf,ISNULL(billinsertype,0)    
 from     #mcardchangeinfo a  left join cardtypenameinfo c  on changeaftercardtype=cardtypeno   
 where isnull(consultantPerf,0)<>0  and ISNULL(consultantinid,'')<>''   
  ...
  insert #allstaff_work_detail(compid,person_inid,action_id,srvdate,code,name,billamt,ccount,billid,paycode,staffshareyeji,staffyeji,billinsertype)            
 select @compid,consultant1inid,88,financedate,changeaftercardno,cardtypename,payamt,1,changebillid,paymode,0,consultant1Perf,ISNULL(billinsertype,0)    
 from     #mcardchangeinfo a  left join cardtypenameinfo c  on changeaftercardtype=cardtypeno   
 where isnull(consultant1Perf,0)<>0  and ISNULL(consultant1inid,'')<>''   
 ...
 insert #mproexchangeinfo(changecompid,changebillid,changedate,changecardno,changecardtype,firstsalerid,firstsalerinid,firstsaleamt,secondsalerid,secondsalerinid,secondsaleamt,  
                     thirdsalerid,thirdsalerinid,thirdsaleamt,fourthsalerid,fourthsalerinid,fourthsaleamt,financedate,changeproamt,paymode,payamt,changeproid,procount )     
    select a.changecompid,a.changebillid,changedate,changecardno,changecardtype,firstsalerid,firstsalerinid,firstsaleamt,secondsalerid,secondsalerinid,secondsaleamt,  
                     thirdsalerid,thirdsalerinid,thirdsaleamt,fourthsalerid,fourthsalerinid,fourthsaleamt,financedate,changeproamt,changepaymode,changebycashamt,changeproid,procount   
 ...
 where isnull(fourthsaleamt,0)<>0 and ISNULL(fourthsalerinid,'')<>''               
  ...
  --疗程兑换 建发疗程补贴30提成 25 (只给烫染师)
  
        --卖卡第一销售人员            
 insert #allstaff_work_detail(compid,person_inid,action_id,srvdate,code,name,billamt,ccount,billid,paycode,staffyeji)            
 select @compid,firstsalerinid,25,financedate,changecardno,changecardtype,payamt,1,changebillid,paymode,ISNULL(procount,0)          
 from #mproexchangeinfo a        
 where isnull(firstsaleamt,0)<>0   and ISNULL(firstsalerinid,'')<>'' and ISNULL(changeproid,'') in ('380093800','3610024')
 
      
    --卖卡第二销售人员            
 insert #allstaff_work_detail(compid,person_inid,action_id,srvdate,code,name,billamt,ccount,billid,paycode,staffyeji)            
 select @compid,secondsalerinid,25,financedate,changecardno,changecardtype,payamt,1,changebillid,paymode,ISNULL(procount,0)   
 from #mproexchangeinfo a        
 where  isnull(secondsaleamt,0)<>0  and ISNULL(secondsalerinid,'')<>'' and ISNULL(thirdsalerinid,'')=''  and ISNULL(changeproid,'') in ('380093800','3610024')    
              
 
 --卖卡第三销售人员            
 insert #allstaff_work_detail(compid,person_inid,action_id,srvdate,code,name,billamt,ccount,billid,paycode,staffyeji)            
 select @compid,thirdsalerinid,25,financedate,changecardno,changecardtype,payamt,1,changebillid,paymode,ISNULL(procount,0)   
 from #mproexchangeinfo a        
 where  isnull(thirdsaleamt,0)<>0  and ISNULL(thirdsalerinid,'')<>'' and ISNULL(secondsalerinid,'')=''  and ISNULL(changeproid,'') in ('380093800','3610024')   
 
          --卖卡第一销售人员            
 insert #allstaff_work_detail(compid,person_inid,action_id,srvdate,code,name,billamt,ccount,billid,paycode,staffyeji)            
 select @compid,firstsalerinid,35,financedate,changecardno,changecardtype,payamt,1,changebillid,paymode,ISNULL(procount,0)          
 from #mproexchangeinfo a        
 where isnull(firstsalerinid,'')<>''   and ISNULL(firstsalerinid,'')<>'' and ISNULL(changeproid,'')='4610047'  and isnull(financedate,'')<='20140831'
 ...
 where isnull(eighthsaleamt,0)<>0  
  ...
  recommendempinid		varchar(20)		NULL	,	--推荐员工  
    )  
    ...
    csfirstsaler,csfirsttype,csfirstinid,csfirstshare,cssecondsaler,cssecondtype,cssecondinid,cssecondshare,csthirdsaler,csthirdtype,csthirdinid,csthirdshare,diyongcardno,tiaomacardno,csitemstate,costpricetype,recommendempinid)  
 ...
 and (isnull(cssecondsaler,'')<>''  or  isnull(csthirdsaler,'')<>'' or isnull(csfirstsaler,'')<>'' )     
  ...
  insert #allstaff_work_detail(compid,person_inid,action_id,srvdate,code,name,billamt,ccount,billid,paycode,staffyeji,cardid,cardtype,csitemstate,costpricetype)            
  select cscompid,csfirstinid,isnull(convert(int,isnull(csfirsttype,'2')),1)+6,financedate,csitemno,prjname,csitemamt,csitemcount,csbillid,  
      cspaymode,csitemamt,cscardno,   case when cspaymode  in ('12','11') then diyongcardno when cspaymode='13' then tiaomacardno  else cscardtype end,csitemstate,costpricetype    
  ...
  select cscompid,csthirdinid,isnull(convert(int,isnull(csthirdtype,'2')),1)+21,financedate,csitemno,goodsname,csitemamt,csitemcount,csbillid,cspaymode,csthirdshare,cscardno,cscardtype  
   ...
   insert #allstaff_work_detail(compid,person_inid,action_id,srvdate,code,name,billamt,ccount,billid,paycode,staffyeji,cardid,cardtype,csitemstate)                
   select cscompid,recommendempinid,32,financedate,'','','',1,csbillid,'','',cscardno,cscardtype,0      
   from #mconsumeinfo b  
    where ISNULL(recommendempinid,'')<>'' and ISNULL(csitemno,'')<>'4600014' and isnull (csfirsttype,0)=3
      group by cscompid,recommendempinid,financedate,csbillid,cscardno, cscardtype
  
	    insert #allstaff_work_detail(compid,person_inid,action_id,srvdate,code,name,billamt,ccount,billid,paycode,staffyeji,cardid,cardtype,csitemstate)                
   select cscompid,recommendempinid,32,financedate,'','','',1,csbillid,'','',cscardno,cscardtype,0      
   from #mconsumeinfo b ,staffinfo c
    where  ISNULL(recommendempinid,'')<>'' and ISNULL(csitemno,'')='4600014' and isnull (csfirsttype,0)=3
      and ISNULL(c.manageno,'')=b.recommendempinid and ISNULL(c.stafftype,0)=0
      and ((ISNULL(c.department,'')<>'004' and ISNULL(financedate,'')<='20140831') or ISNULL(financedate,'')>'20140831')
      group by cscompid,recommendempinid,financedate,csbillid,cscardno, cscardtype
      
    insert #allstaff_work_detail(compid,person_inid,action_id,srvdate,code,name,billamt,ccount,billid,paycode,staffyeji,cardid,cardtype,csitemstate)                
   select cscompid,recommendempinid,36,financedate,'','','',1,csbillid,'','',cscardno,cscardtype,0      
   from #mconsumeinfo b ,staffinfo c
    where  ISNULL(recommendempinid,'')<>'' and ISNULL(csitemno,'')='4600014' and isnull (csfirsttype,0)=3
      and ISNULL(c.manageno,'')=b.recommendempinid and ISNULL(c.stafftype,0)=0 and ISNULL(c.department,'')='004'
       and ISNULL(financedate,'')<='20140831'
      group by cscompid,recommendempinid,financedate,csbillid,cscardno, cscardtype
      
        
   insert #allstaff_work_detail(compid,person_inid,action_id,srvdate,code,name,billamt,ccount,billid,paycode,staffyeji,cardid,cardtype,csitemstate,costpricetype)            
  select cscompid,csfirstinid,37,financedate,csitemno,prjname,0,csitemcount,csbillid,  
      cspaymode,csitemamt,cscardno,   case when cspaymode  in ('12','11') then diyongcardno when cspaymode='13' then tiaomacardno  else cscardtype end,csitemstate,costpricetype    
   from #mconsumeinfo b, projectnameinfo c  ,staffinfo d         
      where  b.csitemno = c.prjno and csinfotype=1  and prjreporttype in ('02','03')
	  and ISNULL(d.manageno,'') = b.csfirstinid and ISNULL(d.stafftype,0)=0 and ISNULL(d.position,'') in ('003','006')       
      and isnull(csitemamt,0)<>0      and ISNULL(csfirstsaler,'')<>''  and ISNULL(b.cssecondsaler,'')='' and ISNULL(b.csthirdsaler,'')='' 
      and ISNULL(financedate,'')>'20140831'
