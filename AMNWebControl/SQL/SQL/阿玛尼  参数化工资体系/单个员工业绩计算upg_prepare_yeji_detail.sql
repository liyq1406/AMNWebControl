...
begin     
 ...
 select salecompid,salebillid,saledate,salecardno,salecardtype,firstsalerid,firstsalerinid,firstsaleamt,secondsalerid,secondsalerinid,secondsaleamt,      
                     ...
                     ninthsalerid,ninthsalerinid,ninthsaleamt,tenthsalerid,tenthsalerinid,tenthsaleamt,
                     firstsalecashamt,secondsalecashamt,thirdsalecashamt,fourthsalecashamt,fifthsalecashamt,sixthsalecashamt,seventhsalecashamt,eighthsalecashamt,ninthsalecashamt,tenthsalecashamt,
                     financedate,salekeepamt,paymode,payamt,case when isnull(@sp102,'0')='1' then ISNULL(billinsertype,0) else 0 end  
 ...
 --卖卡第一销售人员                
 insert #work_detail(compid,person_inid,action_id,srvdate,code,name,billamt,ccount,billid,paycode,staffshareyeji,staffyeji,billinsertype)                
 ...
 select rechargecompid,rechargebillid,rechargedate,rechargecardno,rechargecardtype,rechargetype,firstsalerid,firstsalerinid,firstsaleamt,secondsalerid,secondsalerinid,secondsaleamt,      
                     ...
                     ninthsalerid,ninthsalerinid,ninthsaleamt,tenthsalerid,tenthsalerinid,tenthsaleamt,
                     firstsalecashamt,secondsalecashamt,thirdsalecashamt,fourthsalecashamt,fifthsalecashamt,sixthsalecashamt,seventhsalecashamt,eighthsalecashamt,ninthsalecashamt,tenthsalecashamt,
                     financedate,rechargekeepamt,paymode,payamt ,case when isnull(@sp102,'0')='1' then ISNULL(billinsertype,0) else 0 end  
 ...
 select changecompid,changebillid,changetype,changedate,changeaftercardno,changeaftercardtype,firstsalerid,firstsalerinid,firstsaleamt,secondsalerid,secondsalerinid,secondsaleamt,      
                     ...
                     ninthsalerid,ninthsalerinid,ninthsaleamt,tenthsalerid,tenthsalerinid,tenthsaleamt,
                     firstsalecashamt,secondsalecashamt,thirdsalecashamt,fourthsalecashamt,fifthsalecashamt,sixthsalecashamt,seventhsalecashamt,eighthsalecashamt,ninthsalecashamt,tenthsalecashamt,
                     financedate,changefillamt,paymode,payamt,case when isnull(@sp102,'0')='1' then ISNULL(billinsertype,0) else 0 end   
 ...
 and a.firstsalerinid >= @fromempinno                
 and a.firstsalerinid <= @toempinno      
 ...
 and  a.secondsalerinid >= @fromempinno                
 and a.secondsalerinid <= @toempinno
 ...
 and  a.thirdsalerinid >= @fromempinno                
 and a.thirdsalerinid <= @toempinno
 ...
 select salecompid,salebillid,saledate,salecooperid,slaepaymode,salecostcardno,salecostcardtype,firstsalerid,firstsalerinid,firstsaleamt,secondsalerid,secondsalerinid,secondsaleamt,      
                     thirdsalerid,thirdsalerinid,thirdsaleamt,fourthsalerid,fourthsalerinid,fourthsaleamt,fifthsalerid,fifthsalerinid,fifthsaleamt,      
                     sixthsalerid,sixthsalerinid,sixthsaleamt,seventhsalerid,seventhsalerinid,seventhsaleamt,eighthsalerid,eighthsalerinid,eighthsaleamt,      
                     financedate,salecostproamt,paymode,payamt        from mcooperatesaleinfo, dpayinfo      
 ...
 and (isnull(cssecondsaler,'')<>''  or  isnull(csthirdsaler,'')<>'' or isnull(csfirstsaler,'')<>'' )         
  ...
  insert #work_detail(compid,person_inid,action_id,srvdate,code,name,billamt,ccount,billid,paycode,staffyeji,cardid,cardtype,csitemstate,costpricetype)                
  ...
  select cscompid,csthirdinid,isnull(convert(int,isnull(csthirdtype,'2')),1)+12,financedate,csitemno,prjname,csitemamt,csitemcount,csbillid,      
   ...
   and b.csthirdinid <= @toempinno                
      and isnull(csitemamt,0)<>0  and ISNULL(csthirdsaler,'')<>''      
       ...
       -- 产品大工 16，17，18      
  insert #work_detail(compid,person_inid,action_id,srvdate,code,name,billamt,ccount,billid,paycode,staffyeji,cardid,cardtype,csitemstate)                
  select cscompid,csfirstinid,17,financedate,csitemno,goodsname,csitemamt,csitemcount,csbillid,cspaymode,csfirstshare,cscardno,cscardtype,csitemstate      
   ...
   and b.csfirstinid <= @toempinno                
     ...
     -- 产品中工 19，20，21      
  insert #work_detail(compid,person_inid,action_id,srvdate,code,name,billamt,ccount,billid,paycode,staffyeji,cardid,cardtype,csitemstate)                
  select cscompid,cssecondinid,20,financedate,csitemno,goodsname,csitemamt,csitemcount,csbillid,cspaymode,cssecondshare,cscardno,cscardtype ,csitemstate     
   from #mconsumeinfo b, goodsnameinfo c               
      where  b.csitemno = c.goodsno and csinfotype=2      
      and b.cssecondinid >= @fromempinno                
   and b.cssecondinid <= @toempinno                
      ...
      -- 产品小工 22，23，24      
  insert #work_detail(compid,person_inid,action_id,srvdate,code,name,billamt,ccount,billid,paycode,staffyeji,cardid,cardtype,csitemstate)                
  select cscompid,csthirdinid,23,financedate,csitemno,goodsname,csitemamt,csitemcount,csbillid,cspaymode,csthirdshare,cscardno,cscardtype,csitemstate      
   from #mconsumeinfo b, goodsnameinfo c               
      where  b.csitemno = c.goodsno and csinfotype=2      
      and b.csthirdinid >= @fromempinno               
   and b.csthirdinid <= @toempinno                
   ...
   from #mconsumeinfo b  
    where b.recommendempinid >= @fromempinno               
      and b.recommendempinid <= @toempinno                
      and ISNULL(recommendempinid,'')<>'' and ISNULL(csitemno,'')<>'4600014' and isnull (csfirsttype,0)=3
