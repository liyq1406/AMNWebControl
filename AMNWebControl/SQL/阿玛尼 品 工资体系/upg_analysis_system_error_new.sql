...
begin                                      
 ...
 where @compid=compno                      
  ...
  declare @mfstaffsharecashamt  float           
  declare @mrstaffsharecashamt  float                  
 ...
 (                
  ...
  tenthsalecashamt		float					NULL,   --第十销售分享金额(实际现金业绩)              
    ...
    insert #msalecardinfo(salecompid,salebillid,saledate,salecardno,salecardtype,firstsalerid,firstsalerinid,firstsaleamt,secondsalerid,secondsalerinid,secondsaleamt,                
                     ...
                     financedate,salekeepamt,paymode,payamt,billinsertype)                
 select salecompid,salebillid,saledate,salecardno,salecardtype,firstsalerid,firstsalerinid,firstsaleamt,secondsalerid,secondsalerinid,secondsaleamt,                
                     ...
                     ninthsalerid,ninthsalerinid,ninthsaleamt,tenthsalerid,tenthsalerinid,tenthsaleamt,
                     firstsalecashamt,secondsalecashamt,thirdsalecashamt,fourthsalecashamt,fifthsalecashamt,sixthsalecashamt,seventhsalecashamt,eighthsalecashamt,ninthsalecashamt,tenthsalecashamt,
                     financedate,salekeepamt,'',0,ISNULL(billinsertype,0)                
    from msalecardinfo                
  ...
  declare @e0003_firstsaleamt float, @e0003_secondsaleamt float, @e0003_thirdsaleamt float,                
    ...
    @e0003_firstsalecashamt float, @e0003_secondsalecashamt float, @e0003_thirdsalecashamt float,                
    @e0003_fourthsalecashamt float, @e0003_fifthsalecashamt float, @e0003_sixthsalecashamt float,                 
    @e0003_seventhsalecashamt float, @e0003_eighthsalecashamt float, @e0003_ninthsalecashamt float,@e0003_tenthsalecashamt float,@e0003_salekeepamt float                                
  ...
  select salebillid,salecardno,                
    isnull(firstsalerid,''),isnull(secondsalerid,''),isnull(thirdsalerid,''),isnull(fourthsalerid,''),isnull(fifthsalerid,''),isnull(sixthsalerid,''),isnull(seventhsalerid,''),isnull(eighthsalerid,''),isnull(ninthsalerid,''),isnull(tenthsalerid,''),     
     firstsaleamt,secondsaleamt,thirdsaleamt,fourthsaleamt,fifthsaleamt,sixthsaleamt,seventhsaleamt,eighthsaleamt,ninthsaleamt,tenthsaleamt,
      firstsalecashamt,secondsalecashamt,thirdsalecashamt,fourthsalecashamt,fifthsalecashamt,sixthsalecashamt,seventhsalecashamt,eighthsalecashamt,ninthsalecashamt,tenthsalecashamt,salekeepamt,ISNULL(billinsertype,0)                
     from #msalecardinfo                                         
  ...
  @e0003_ninthsalerid,@e0003_tenthsalerid,                              
        ...
        @e0003_firstsalecashamt,@e0003_secondsalecashamt,@e0003_thirdsalecashamt,@e0003_fourthsalecashamt,                
        @e0003_fifthsalecashamt,@e0003_sixthsalecashamt,@e0003_seventhsalecashamt,@e0003_eighthsalecashamt,                 
        @e0003_ninthsalecashamt,@e0003_tenthsalecashamt,@e0003_salekeepamt,@billinsertype                            
  ...
  begin                  
   ...
   set @mfstaffsharecashamt=0             
   set @mrstaffsharecashamt=0            
   ...
   set @e0003_bill_msalecardinfo=''                
   --第一销售                
	if(isnull(@e0003_firstsalerid,'')<>'' and (ISNULL(@e0003_firstsaleamt,0)>0 or ISNULL(@e0003_firstsalecashamt,0) >0 ) )                 
	begin                
		...
		begin                
			...
			set @mfstaffsharecashamt=@mfstaffsharecashamt+ISNULL(@e0003_firstsalecashamt,0)                   
			set @mfstaffsharecount=@mfstaffsharecount+1                
		end           
		if  exists( select 1 from #emp_deperror where @e0003_firstsalerid=empid and emppos  in ('004','00401','00402','00103'))                
		begin                
			set @mrstaffshareamt=@mrstaffshareamt+ISNULL(@e0003_firstsaleamt,0) 
			set @mrstaffsharecashamt=@mrstaffsharecashamt+ISNULL(@e0003_firstsalecashamt,0)         
		end                   
	...
	--第二销售                
	if(isnull(@e0003_secondsalerid,'')<>'' and ( ISNULL(@e0003_secondsaleamt,0)>0 or ISNULL(@e0003_secondsalecashamt,0)>0) )                 
	begin                
		...
		begin                
			...
			set @mfstaffsharecashamt=@mfstaffsharecashamt+ISNULL(@e0003_secondsalecashamt,0)            
			set @mfstaffsharecount=@mfstaffsharecount+1                
		end           
		if  exists( select 1 from #emp_deperror where @e0003_secondsalerid=empid and emppos  in ('004','00401','00402','00103'))                
		begin                
			set @mrstaffshareamt=@mrstaffshareamt+ISNULL(@e0003_secondsaleamt,0)  
			set @mrstaffsharecashamt=@mrstaffsharecashamt+ISNULL(@e0003_secondsalecashamt,0)        
		end                    
	...
	--第三销售                
	if(isnull(@e0003_thirdsalerid,'')<>'' and ( ISNULL(@e0003_thirdsaleamt,0)>0 or ISNULL(@e0003_thirdsalecashamt,0)>0) )                 
	begin                
		...
		begin                
			...
			set @mfstaffsharecashamt=@mfstaffsharecashamt+ISNULL(@e0003_thirdsalecashamt,0)               
			set @mfstaffsharecount=@mfstaffsharecount+1                
		end          
		if  exists( select 1 from #emp_deperror where @e0003_thirdsalerid=empid and emppos  in ('004','00401','00402','00103'))                
		begin                
			set @mrstaffshareamt=@mrstaffshareamt+ISNULL(@e0003_thirdsaleamt,0)
			set @mrstaffsharecashamt=@mrstaffsharecashamt+ISNULL(@e0003_thirdsalecashamt,0)          
		end                    
	...
	--第四销售                
	if(isnull(@e0003_fourthsalerid,'')<>'' and ( ISNULL(@e0003_fourthsaleamt,0)>0 or ISNULL(@e0003_fourthsalecashamt,0)>0) )                 
	begin                
		...
		begin                
			...
			set @mfstaffsharecashamt=@mfstaffsharecashamt+ISNULL(@e0003_fourthsalecashamt,0)          
			set @mfstaffsharecount=@mfstaffsharecount+1                
		end          
		if  exists( select 1 from #emp_deperror where @e0003_fourthsalerid=empid and emppos  in ('004','00401','00402','00103'))                
		begin                
			set @mrstaffshareamt=@mrstaffshareamt+ISNULL(@e0003_fourthsaleamt,0)   
			set @mrstaffsharecashamt=@mrstaffsharecashamt+ISNULL(@e0003_fourthsalecashamt,0)       
		end                  
	...
	--第五销售                
	if(isnull(@e0003_fifthsalerid,'')<>'' and ( ISNULL(@e0003_fifthsaleamt,0)>0 or ISNULL(@e0003_fifthsalecashamt,0)>0 ) )                 
	begin                
		...
		begin                
			...
			set @mfstaffsharecashamt=@mfstaffsharecashamt+ISNULL(@e0003_fifthsalecashamt,0)               
			set @mfstaffsharecount=@mfstaffsharecount+1                
		end          
		if  exists( select 1 from #emp_deperror where @e0003_fifthsalerid=empid and emppos  in ('004','00401','00402','00103'))                
		begin                
			set @mrstaffshareamt=@mrstaffshareamt+ISNULL(@e0003_fifthsaleamt,0)  
			set @mrstaffsharecashamt=@mrstaffsharecashamt+ISNULL(@e0003_fifthsalecashamt,0)        
		end                  
	...
	--第六销售                
	if(isnull(@e0003_sixthsalerid,'')<>'' and ( ISNULL(@e0003_sixthsaleamt,0)>0 or  ISNULL(@e0003_sixthsalecashamt,0)>0 ) )                 
	begin                
		...
		begin                
			...
			set @mfstaffsharecashamt=@mfstaffsharecashamt+ISNULL(@e0003_sixthsalecashamt,0)               
			set @mfstaffsharecount=@mfstaffsharecount+1                
		end          
		if  exists( select 1 from #emp_deperror where @e0003_sixthsalerid=empid and emppos  in ('004','00401','00402','00103'))                
		begin                
			set @mrstaffshareamt=@mrstaffshareamt+ISNULL(@e0003_sixthsaleamt,0)  
			set @mrstaffsharecashamt=@mrstaffsharecashamt+ISNULL(@e0003_sixthsalecashamt,0)        
		end                   
	...
	--第七销售                
	if(isnull(@e0003_seventhsalerid,'')<>'' and ( ISNULL(@e0003_seventhsaleamt,0)>0 or ISNULL(@e0003_seventhsalecashamt,0)>0) )                 
	begin                
		...
		begin                
			...
			set @mfstaffsharecashamt=@mfstaffsharecashamt+ISNULL(@e0003_seventhsalecashamt,0)                
			set @mfstaffsharecount=@mfstaffsharecount+1                
		end          
		if  exists( select 1 from #emp_deperror where @e0003_seventhsalerid=empid and emppos  in ('004','00401','00402','00103'))                
		begin                
			set @mrstaffshareamt=@mrstaffshareamt+ISNULL(@e0003_seventhsaleamt,0)  
			set @mrstaffsharecashamt=@mrstaffsharecashamt+ISNULL(@e0003_seventhsalecashamt,0)        
		end                  
	...
	--第八销售                
	if(isnull(@e0003_eighthsalerid,'')<>'' and ( ISNULL(@e0003_eighthsaleamt,0)>0 or ISNULL(@e0003_eighthsalecashamt,0)>0) )                 
	begin                
		...
		begin                
			...
			set @mfstaffsharecashamt=@mfstaffsharecashamt+ISNULL(@e0003_eighthsalecashamt,0)                
			set @mfstaffsharecount=@mfstaffsharecount+1                
		end          
		if  exists( select 1 from #emp_deperror where @e0003_eighthsalerid=empid and emppos  in ('004','00401','00402','00103'))                
		begin                
			set @mrstaffshareamt=@mrstaffshareamt+ISNULL(@e0003_eighthsaleamt,0) 
			set @mrstaffsharecashamt=@mrstaffsharecashamt+ISNULL(@e0003_eighthsalecashamt,0)         
		end                  
	...
	--第九销售                
	if(isnull(@e0003_ninthsalerid,'')<>'' and ( ISNULL(@e0003_ninthsaleamt,0)>0 or ISNULL(@e0003_ninthsalecashamt,0)>0) )                 
	begin                
		...
		begin                
			...
			set @mfstaffsharecashamt=@mfstaffsharecashamt+ISNULL(@e0003_ninthsalecashamt,0)               
			set @mfstaffsharecount=@mfstaffsharecount+1                
		end          
		if  exists( select 1 from #emp_deperror where @e0003_ninthsalerid=empid and emppos  in ('004','00401','00402','00103'))                
		begin                
			set @mrstaffshareamt=@mrstaffshareamt+ISNULL(@e0003_ninthsaleamt,0)
			set @mrstaffsharecashamt=@mrstaffsharecashamt+ISNULL(@e0003_ninthsalecashamt,0)          
		end                  
	...
	--第十销售                
	if(isnull(@e0003_tenthsalerid,'')<>'' and ( ISNULL(@e0003_tenthsaleamt,0)>0 or ISNULL(@e0003_tenthsalecashamt,0)>0) )                 
	begin                
		...
		begin                
			...
			set @mfstaffsharecashamt=@mfstaffsharecashamt+ISNULL(@e0003_tenthsalecashamt,0)                
			set @mfstaffsharecount=@mfstaffsharecount+1                
		end           
		if  exists( select 1 from #emp_deperror where @e0003_tenthsalerid=empid and emppos  in ('004','00401','00402','00103'))                
		begin                
			set @mrstaffshareamt=@mrstaffshareamt+ISNULL(@e0003_tenthsaleamt,0) 
			set @mrstaffsharecashamt=@mrstaffsharecashamt+ISNULL(@e0003_tenthsalecashamt,0)         
		end                  
	...
	if(ISNULL(@billinsertype,0)=3)
	begin
		if(convert(numeric(20,1),ISNULL(@mrstaffsharecashamt,0)+ISNULL(@mfstaffsharecashamt,0))<>convert(numeric(20,1),ISNULL(@e0003_salekeepamt,0)))                
				set @e0003_bill_msalecardinfo=isnull(@e0003_bill_msalecardinfo,'')+'卡金业绩没有完全分享'    
	end   
 ...
 insert #mcardrechargeinfo(rechargecompid,rechargebillid,rechargedate,rechargetype,rechargecardno,rechargecardtype,firstsalerid,firstsalerinid,firstsaleamt,secondsalerid,secondsalerinid,secondsaleamt,                
                     ...
                     ninthsalerid,ninthsalerinid,ninthsaleamt,tenthsalerid,tenthsalerinid,tenthsaleamt,
                     firstsalecashamt,secondsalecashamt,thirdsalecashamt,fourthsalecashamt,fifthsalecashamt,sixthsalecashamt,seventhsalecashamt,eighthsalecashamt,ninthsalecashamt,tenthsalecashamt,
                     financedate,rechargekeepamt,paymode,payamt,billinsertype)                
 select rechargecompid,rechargebillid,rechargedate,rechargetype,rechargecardno,rechargecardtype,firstsalerid,firstsalerinid,firstsaleamt,secondsalerid,secondsalerinid,secondsaleamt,                
                     ...
                     ninthsalerid,ninthsalerinid,ninthsaleamt,tenthsalerid,tenthsalerinid,tenthsaleamt,
                     firstsalecashamt,secondsalecashamt,thirdsalecashamt,fourthsalecashamt,fifthsalecashamt,sixthsalecashamt,seventhsalecashamt,eighthsalecashamt,ninthsalecashamt,tenthsalecashamt,
                     financedate,rechargekeepamt,'',0,isnull(billinsertype,0)                
  ...
  declare @e0003_firstsaleamt_cz float, @e0003_secondsaleamt_cz float, @e0003_thirdsaleamt_cz float,                
    ...
    @e0003_firstsalecashamt_cz float, @e0003_secondsalecashamt_cz float, @e0003_thirdsalecashamt_cz float,                
    @e0003_fourthsalecashamt_cz float, @e0003_fifthsalecashamt_cz float, @e0003_sixthsalecashamt_cz float,                 
    @e0003_seventhsalecashamt_cz float, @e0003_eighthsalecashamt_cz float, @e0003_ninthsalecashamt_cz float,@e0003_tenthsalecashamt_cz float,
    @e0003_rechargekeepamt_cz float                   
  ...
  select rechargebillid,rechargecardno,                 
	...
	firstsaleamt,secondsaleamt,thirdsaleamt,fourthsaleamt,fifthsaleamt,sixthsaleamt,seventhsaleamt,eighthsaleamt,ninthsaleamt,tenthsaleamt,
	firstsalecashamt,secondsalecashamt,thirdsalecashamt,fourthsalecashamt,fifthsalecashamt,sixthsalecashamt,seventhsalecashamt,eighthsalecashamt,ninthsalecashamt,tenthsalecashamt,
	rechargekeepamt,isnull(billinsertype,0)                
  from #mcardrechargeinfo                              
  ...
  @e0003_ninthsalerid_cz,@e0003_tenthsalerid_cz,                              
        ...
        @e0003_firstsalecashamt_cz,@e0003_secondsalecashamt_cz,@e0003_thirdsalecashamt_cz,@e0003_fourthsalecashamt_cz,                
        @e0003_fifthsalecashamt_cz,@e0003_sixthsalecashamt_cz,@e0003_seventhsalecashamt_cz,@e0003_eighthsalecashamt_cz,                 
        @e0003_ninthsalecashamt_cz,@e0003_tenthsalecashamt_cz,@e0003_rechargekeepamt_cz,@billinsertype                               
  ...
  begin                         
   ...
   set @totalshareamt=0             
	...
	--第一销售                
	if(isnull(@e0003_firstsalerid_cz,'')<>'' and ( ISNULL(@e0003_firstsaleamt_cz,0)>0 or ISNULL(@e0003_firstsalecashamt_cz,0)>0) )                 
	begin                
		...
		begin                
			...
			set @mfstaffsharecashamt=@mfstaffsharecashamt+ISNULL(@e0003_firstsalecashamt_cz,0)               
			set @mfstaffsharecount=@mfstaffsharecount+1                
		end          
		if  exists( select 1 from #emp_deperror where @e0003_firstsalerid_cz=empid and emppos  in ('004','00401','00402','00103'))                
		begin                
			set @mrstaffshareamt=@mrstaffshareamt+ISNULL(@e0003_firstsaleamt_cz,0) 
			set @mrstaffsharecashamt=@mrstaffsharecashamt+ISNULL(@e0003_firstsalecashamt_cz,0)           
		end                     
	...
	--第二销售                
	if(isnull(@e0003_secondsalerid_cz,'')<>'' and ( ISNULL(@e0003_secondsaleamt_cz,0)>0 or ISNULL(@e0003_secondsalecashamt_cz,0)>0 ))                 
	begin                
		...
		begin                
			...
			set @mfstaffsharecashamt=@mfstaffsharecashamt+ISNULL(@e0003_secondsalecashamt_cz,0)               
			set @mfstaffsharecount=@mfstaffsharecount+1                
		end          
		if  exists( select 1 from #emp_deperror where @e0003_secondsalerid_cz=empid and emppos  in ('004','00401','00402','00103'))                
		begin                
			set @mrstaffshareamt=@mrstaffshareamt+ISNULL(@e0003_secondsaleamt_cz,0)  
			set @mrstaffsharecashamt=@mrstaffsharecashamt+ISNULL(@e0003_secondsalecashamt_cz,0)             
		end                  
	...
	--第三销售                
	if(isnull(@e0003_thirdsalerid_cz,'')<>'' and ( ISNULL(@e0003_thirdsaleamt_cz,0)>0 or ISNULL(@e0003_thirdsalecashamt_cz,0)>0 ) )                 
	begin                
		...
		begin                
			...
			set @mfstaffsharecashamt=@mfstaffsharecashamt+ISNULL(@e0003_thirdsalecashamt_cz,0)            
			set @mfstaffsharecount=@mfstaffsharecount+1                
		end          
		if  exists( select 1 from #emp_deperror where @e0003_thirdsalerid_cz=empid and emppos  in ('004','00401','00402','00103'))                
		begin                
			set @mrstaffshareamt=@mrstaffshareamt+ISNULL(@e0003_thirdsaleamt_cz,0) 
			set @mrstaffsharecashamt=@mrstaffsharecashamt+ISNULL(@e0003_thirdsalecashamt_cz,0)           
		end                   
	...
	--第四销售                
	if(isnull(@e0003_fourthsalerid_cz,'')<>'' and  ( ISNULL(@e0003_fourthsaleamt_cz,0)>0  or ISNULL(@e0003_fourthsalecashamt_cz,0)>0 ) )                 
	begin                
		if  exists( select 1 from #emp_deperror where @e0003_fourthsalerid_cz=empid and emppos  in ('00102','003','006','007','00701','00702'))
		begin                
			set @mfstaffshareamt=@mfstaffshareamt+ISNULL(@e0003_fourthsaleamt_cz,0) 
			set @mfstaffsharecashamt=@mfstaffsharecashamt+ISNULL(@e0003_fourthsalecashamt_cz,0)               
			set @mfstaffsharecount=@mfstaffsharecount+1                
		end          
		if  exists( select 1 from #emp_deperror where @e0003_fourthsalerid_cz=empid and emppos  in ('004','00401','00402','00103'))                
		begin                
			set @mrstaffshareamt=@mrstaffshareamt+ISNULL(@e0003_fourthsaleamt_cz,0) 
			set @mrstaffsharecashamt=@mrstaffsharecashamt+ISNULL(@e0003_fourthsalecashamt_cz,0)             
		end                  
	...
	--第五销售   
	if(isnull(@e0003_fifthsalerid_cz,'')<>'' and  ( ISNULL(@e0003_fifthsaleamt_cz,0)>0 or ISNULL(@e0003_fifthsalecashamt_cz,0) >0 ))                 
	begin                
		...
		begin                
			...
			set @mfstaffsharecashamt=@mfstaffsharecashamt+ISNULL(@e0003_fifthsalecashamt_cz,0)                 
			set @mfstaffsharecount=@mfstaffsharecount+1                
		end          
		if  exists( select 1 from #emp_deperror where @e0003_fifthsalerid_cz=empid and emppos  in ('004','00401','00402','00103'))                
		begin                
			set @mrstaffshareamt=@mrstaffshareamt+ISNULL(@e0003_fifthsaleamt_cz,0) 
			set @mrstaffsharecashamt=@mrstaffsharecashamt+ISNULL(@e0003_fifthsalecashamt_cz,0)            
		end                  
	...
	--第六销售                
	if(isnull(@e0003_sixthsalerid_cz,'')<>'' and ( ISNULL(@e0003_sixthsaleamt_cz,0)>0 or ISNULL(@e0003_sixthsalecashamt_cz,0)>0 ))                 
	begin                
		...
		begin                
			...
			set @mfstaffsharecashamt=@mfstaffsharecashamt+ISNULL(@e0003_sixthsalecashamt_cz,0)               
			set @mfstaffsharecount=@mfstaffsharecount+1                
		end          
		if  exists( select 1 from #emp_deperror where @e0003_sixthsalerid_cz=empid and emppos  in ('004','00401','00402','00103'))                
		begin                
			set @mrstaffshareamt=@mrstaffshareamt+ISNULL(@e0003_sixthsaleamt_cz,0) 
			set @mrstaffsharecashamt=@mrstaffsharecashamt+ISNULL(@e0003_sixthsalecashamt_cz,0)           
		end                  
	...
	--第七销售                
	if(isnull(@e0003_seventhsalerid_cz,'')<>'' and ( ISNULL(@e0003_seventhsaleamt_cz,0)>0  or ISNULL(@e0003_seventhsalecashamt_cz,0)>0 ) )                 
	begin                
		...
		begin                
			...
			set @mfstaffsharecashamt=@mfstaffsharecashamt+ISNULL(@e0003_seventhsalecashamt_cz,0)                
			set @mfstaffsharecount=@mfstaffsharecount+1                
		end          
		if  exists( select 1 from #emp_deperror where @e0003_seventhsalerid_cz=empid and emppos  in ('004','00401','00402','00103'))                
		begin                
			set @mrstaffshareamt=@mrstaffshareamt+ISNULL(@e0003_seventhsaleamt_cz,0) 
			set @mrstaffsharecashamt=@mrstaffsharecashamt+ISNULL(@e0003_seventhsalecashamt_cz,0)           
		end                  
	...
	--第八销售                
	if(isnull(@e0003_eighthsalerid_cz,'')<>'' and ( ISNULL(@e0003_eighthsaleamt_cz,0)>0 or  ISNULL(@e0003_eighthsaleamt_cz,0)>0 ) )                 
	begin                
		...
		begin                
			...
			set @mfstaffsharecashamt=@mfstaffsharecashamt+ISNULL(@e0003_eighthsalecashamt_cz,0)             
			set @mfstaffsharecount=@mfstaffsharecount+1                
		end          
		if  exists( select 1 from #emp_deperror where @e0003_eighthsalerid_cz=empid and emppos  in ('004','00401','00402','00103'))                
		begin                
			set @mrstaffshareamt=@mrstaffshareamt+ISNULL(@e0003_eighthsaleamt_cz,0)  
			set @mrstaffsharecashamt=@mrstaffsharecashamt+ISNULL(@e0003_eighthsalecashamt_cz,0)           
		end                   
	...
	--第九销售                
	if(isnull(@e0003_ninthsalerid_cz,'')<>'' and ( ISNULL(@e0003_ninthsaleamt_cz,0)>0 or ISNULL(@e0003_ninthsalecashamt_cz,0) >0 ))                 
	begin                
		...
		begin                
			...
			set @mfstaffsharecashamt=@mfstaffsharecashamt+ISNULL(@e0003_ninthsalecashamt_cz,0)         
			set @mfstaffsharecount=@mfstaffsharecount+1                
		end          
		if  exists( select 1 from #emp_deperror where @e0003_ninthsalerid_cz=empid and emppos  in ('004','00401','00402','00103'))                
		begin                
			set @mrstaffshareamt=@mrstaffshareamt+ISNULL(@e0003_ninthsaleamt_cz,0) 
			set @mrstaffsharecashamt=@mrstaffsharecashamt+ISNULL(@e0003_ninthsalecashamt_cz,0)           
		end                  
	...
	--第十销售                
	if(isnull(@e0003_tenthsalerid_cz,'')<>'' and ( ISNULL(@e0003_tenthsaleamt_cz,0)>0 or ISNULL(@e0003_tenthsalecashamt_cz,0)>0 ))                 
	begin                
		...
		begin                
			...
			set @mfstaffsharecashamt=@mfstaffsharecashamt+ISNULL(@e0003_tenthsalecashamt_cz,0)                
			set @mfstaffsharecount=@mfstaffsharecount+1                
		end          
		if  exists( select 1 from #emp_deperror where @e0003_tenthsalerid_cz=empid and emppos  in ('004','00401','00402','00103'))                
		begin                
			set @mrstaffshareamt=@mrstaffshareamt+ISNULL(@e0003_tenthsaleamt_cz,0)  
			set @mrstaffsharecashamt=@mrstaffsharecashamt+ISNULL(@e0003_tenthsalecashamt_cz,0)              
		end                  
	...
	if(ISNULL(@billinsertype,0)=3)
	begin
		if(convert(numeric(20,1),ISNULL(@mfstaffsharecashamt,0)+ISNULL(@mrstaffsharecashamt,0))<>convert(numeric(20,1),ISNULL(@e0003_rechargekeepamt_cz,0)))                
				set @e0003_bill_mcardrechargeinfo=isnull(@e0003_bill_mcardrechargeinfo,'')+'卡金业绩没有完全分享'  
	end
 ...
 insert #mcardchangeinfo(changecompid,changebillid,changetype,changedate,changeaftercardno,changeaftercardtype,firstsalerid,firstsalerinid,firstsaleamt,secondsalerid,secondsalerinid,secondsaleamt,                
                     ...
                     ninthsalerid,ninthsalerinid,ninthsaleamt,tenthsalerid,tenthsalerinid,tenthsaleamt,
                     firstsalecashamt,secondsalecashamt,thirdsalecashamt,fourthsalecashamt,fifthsalecashamt,sixthsalecashamt,seventhsalecashamt,eighthsalecashamt,ninthsalecashamt,tenthsalecashamt,
                     financedate,changefillamt,paymode,payamt,billinsertype)                
 select changecompid,changebillid,changetype,changedate,changeaftercardno,changeaftercardtype,firstsalerid,firstsalerinid,firstsaleamt,secondsalerid,secondsalerinid,secondsaleamt,                
                     ...
                     ninthsalerid,ninthsalerinid,ninthsaleamt,tenthsalerid,tenthsalerinid,tenthsaleamt,
                     firstsalecashamt,secondsalecashamt,thirdsalecashamt,fourthsalecashamt,fifthsalecashamt,sixthsalecashamt,seventhsalecashamt,eighthsalecashamt,ninthsalecashamt,tenthsalecashamt,
                     financedate,changefillamt,'',0,ISNULL(billinsertype,0)                
    from mcardchangeinfo                
    where  changecompid=@compid and financedate between @fromdate and @todate and changetype in (0,1,2,6,7) and ISNULL(changefillamt,0)<>0 and ISNULL(salebakflag,0)=0       and ISNULL(backflag,0)=0               
	...
	begin                                        
		...
		declare @e0003_firstsaleamt_zk float, @e0003_secondsaleamt_zk float, @e0003_thirdsaleamt_zk float,                
				...
				@e0003_firstsalecashamt_zk float, @e0003_secondsalecashamt_zk float, @e0003_thirdsalecashamt_zk float,                
				@e0003_fourthsalecashamt_zk float, @e0003_fifthsalecashamt_zk float, @e0003_sixthsalecashamt_zk float,                 
				@e0003_seventhsalecashamt_zk float, @e0003_eighthsalecashamt_zk float, @e0003_ninthsalecashamt_zk float,@e0003_tenthsalecashamt_zk float,
				@e0003_changefillamt_zk float                   
  ...
  select changebillid,                 
	...
	firstsaleamt,secondsaleamt,thirdsaleamt,fourthsaleamt,fifthsaleamt,sixthsaleamt,seventhsaleamt,eighthsaleamt,ninthsaleamt,tenthsaleamt,
	firstsalecashamt,secondsalecashamt,thirdsalecashamt,fourthsalecashamt,fifthsalecashamt,sixthsalecashamt,seventhsalecashamt,eighthsalecashamt,ninthsalecashamt,tenthsalecashamt,
	changefillamt,ISNULL(billinsertype,0)                
  from #mcardchangeinfo                              
  ...
  fetch cur_#mcardchangeinfoerr3 into  @e0003_changebillid,                
    ...
    @e0003_firstsalecashamt_zk,@e0003_secondsalecashamt_zk,@e0003_thirdsalecashamt_zk,@e0003_fourthsalecashamt_zk,                
    @e0003_fifthsalecashamt_zk,@e0003_sixthsalecashamt_zk,@e0003_seventhsalecashamt_zk,@e0003_eighthsalecashamt_zk,                 
    @e0003_ninthsalecashamt_zk,@e0003_tenthsalecashamt_zk,
    @e0003_changefillamt_zk,@billinsertype                                     
  while(@@fetch_status=0)                                        
  begin                  
   set @e0003_bill_mcardchangeinfo=''                
   set @mfstaffshareamt=0    
   ...
   set @totalshareamt=0           
	...
	--第一销售                
	if(isnull(@e0003_firstsalerid_zk,'')<>'' and  ( ISNULL(@e0003_firstsaleamt_zk,0)>0 or ISNULL(@e0003_firstsalecashamt_zk,0)>0 ))                 
	begin                
		...
		begin                
			...
			set @mfstaffsharecashamt=@mfstaffsharecashamt+ISNULL(@e0003_firstsalecashamt_zk,0)               
			set @mfstaffsharecount=@mfstaffsharecount+1                
		end            
		if  exists( select 1 from #emp_deperror where @e0003_firstsalerid_zk=empid and emppos  in ('004','00401','00402','00103'))                
		begin                
			set @mrstaffshareamt=@mrstaffshareamt+ISNULL(@e0003_firstsaleamt_zk,0) 
			set @mrstaffsharecashamt=@mrstaffsharecashamt+ISNULL(@e0003_firstsalecashamt_zk,0)                 
		end                 
	...
	--第二销售                
	if(isnull(@e0003_secondsalerid_zk,'')<>'' and ( ISNULL(@e0003_secondsaleamt_zk,0)>0 or ISNULL(@e0003_secondsalecashamt_zk,0)>0 ) )                 
	begin                
		...
		begin                
			...
			set @mfstaffsharecashamt=@mfstaffsharecashamt+ISNULL(@e0003_secondsalecashamt_zk,0)               
			set @mfstaffsharecount=@mfstaffsharecount+1                
		end          
		if  exists( select 1 from #emp_deperror where @e0003_secondsalerid_zk=empid and emppos  in ('004','00401','00402','00103'))                
		begin                
			set @mrstaffshareamt=@mrstaffshareamt+ISNULL(@e0003_secondsaleamt_zk,0)   
			set @mrstaffsharecashamt=@mrstaffsharecashamt+ISNULL(@e0003_secondsalecashamt_zk,0)             
		end                  
	...
	--第三销售                
	if(isnull(@e0003_thirdsalerid_zk,'')<>'' and ( ISNULL(@e0003_thirdsaleamt_zk,0)>0 or ISNULL(@e0003_thirdsalecashamt_zk,0)>0 ) )                 
	begin                
		...
		begin                
			...
			set @mfstaffsharecashamt=@mfstaffsharecashamt+ISNULL(@e0003_thirdsalecashamt_zk,0)             
			set @mfstaffsharecount=@mfstaffsharecount+1                
		end          
		if  exists( select 1 from #emp_deperror where @e0003_thirdsalerid_zk=empid and emppos  in ('004','00401','00402','00103'))                
		begin                
			set @mrstaffshareamt=@mrstaffshareamt+ISNULL(@e0003_thirdsaleamt_zk,0)  
			set @mrstaffsharecashamt=@mrstaffsharecashamt+ISNULL(@e0003_thirdsalecashamt_zk,0)                
		end                  
	...
	--第四销售                
	if(isnull(@e0003_fourthsalerid_zk,'')<>'' and ( ISNULL(@e0003_fourthsaleamt_zk,0)>0 or ISNULL(@e0003_fourthsalecashamt_zk,0)>0 ))                 
	begin                
		...
		begin                
			...
			set @mfstaffsharecashamt=@mfstaffsharecashamt+ISNULL(@e0003_fourthsalecashamt_zk,0)               
			set @mfstaffsharecount=@mfstaffsharecount+1                
		end          
		if  exists( select 1 from #emp_deperror where @e0003_fourthsalerid_zk=empid and emppos  in ('004','00401','00402','00103'))                
		begin                
			set @mrstaffshareamt=@mrstaffshareamt+ISNULL(@e0003_fourthsaleamt_zk,0)   
			set @mrstaffsharecashamt=@mrstaffsharecashamt+ISNULL(@e0003_fourthsalecashamt_zk,0)                
		end                  
	...
	--第五销售                
	if(isnull(@e0003_fifthsalerid_zk,'')<>'' and ( ISNULL(@e0003_fifthsaleamt_zk,0)>0 or ISNULL(@e0003_fifthsalecashamt_zk,0)>0 ) )                 
	begin                
		...
		begin                
			...
			set @mfstaffsharecashamt=@mfstaffsharecashamt+ISNULL(@e0003_fifthsalecashamt_zk,0)               
			set @mfstaffsharecount=@mfstaffsharecount+1                
		end          
		if  exists( select 1 from #emp_deperror where @e0003_fifthsalerid_zk=empid and emppos  in ('004','00401','00402','00103'))                
		begin                
			set @mrstaffshareamt=@mrstaffshareamt+ISNULL(@e0003_fifthsaleamt_zk,0)  
			set @mrstaffsharecashamt=@mrstaffsharecashamt+ISNULL(@e0003_fifthsalecashamt_zk,0)                
		end                  
	...
	--第六销售                
	if(isnull(@e0003_sixthsalerid_zk,'')<>'' and ( ISNULL(@e0003_sixthsaleamt_zk,0)>0 or ISNULL(@e0003_sixthsalecashamt_zk,0)>0 ) )                 
	begin                
		...
		begin                
			...
			set @mfstaffsharecashamt=@mfstaffsharecashamt+ISNULL(@e0003_sixthsalecashamt_zk,0)                 
			set @mfstaffsharecount=@mfstaffsharecount+1                
	end          
    if  exists( select 1 from #emp_deperror where @e0003_sixthsalerid_zk=empid and emppos  in ('004','00401','00402','00103'))                
    begin                
		set @mrstaffshareamt=@mrstaffshareamt+ISNULL(@e0003_sixthsaleamt_zk,0) 
		set @mrstaffsharecashamt=@mrstaffsharecashamt+ISNULL(@e0003_sixthsalecashamt_zk,0)               
    end                  
	...
	--第七销售           
	if(isnull(@e0003_seventhsalerid_zk,'')<>'' and ( ISNULL(@e0003_seventhsaleamt_zk,0)>0 or ISNULL(@e0003_seventhsalecashamt_zk,0)>0 ) )                 
	begin                
		...
		begin                
			...
			set @mfstaffsharecashamt=@mfstaffsharecashamt+ISNULL(@e0003_seventhsalecashamt_zk,0)               
			set @mfstaffsharecount=@mfstaffsharecount+1                
		end          
		if  exists( select 1 from #emp_deperror where @e0003_seventhsalerid_zk=empid and emppos  in ('004','00401','00402','00103'))                
		begin                
			set @mrstaffshareamt=@mrstaffshareamt+ISNULL(@e0003_seventhsaleamt_zk,0) 
			set @mrstaffsharecashamt=@mrstaffsharecashamt+ISNULL(@e0003_seventhsalecashamt_zk,0)               
		end                  
	...
	--第八销售                
	if(isnull(@e0003_eighthsalerid_zk,'')<>'' and ( ISNULL(@e0003_eighthsaleamt_zk,0)>0 or  ISNULL(@e0003_eighthsalecashamt_zk,0)>0 ))                 
	begin                
		...
		begin                
			...
			set @mfstaffsharecashamt=@mfstaffsharecashamt+ISNULL(@e0003_eighthsalecashamt_zk,0)                
			set @mfstaffsharecount=@mfstaffsharecount+1                
		end          
		if  exists( select 1 from #emp_deperror where @e0003_eighthsalerid_zk=empid and emppos  in ('004','00401','00402','00103'))                
		begin                
			set @mrstaffshareamt=@mrstaffshareamt+ISNULL(@e0003_eighthsaleamt_zk,0) 
			set @mrstaffsharecashamt=@mrstaffsharecashamt+ISNULL(@e0003_eighthsalecashamt_zk,0)                
		end                  
	...
	--第九销售                
	if(isnull(@e0003_ninthsalerid_zk,'')<>'' and ( ISNULL(@e0003_ninthsaleamt_zk,0)>0 or ISNULL(@e0003_ninthsalecashamt_zk,0)>0))                 
	begin                
		...
		begin                
			...
			set @mfstaffsharecashamt=@mfstaffsharecashamt+ISNULL(@e0003_ninthsalecashamt_zk,0)               
			set @mfstaffsharecount=@mfstaffsharecount+1                
		end          
		if  exists( select 1 from #emp_deperror where @e0003_ninthsalerid_zk=empid and emppos  in ('004','00401','00402','00103'))                
		begin                
			set @mrstaffshareamt=@mrstaffshareamt+ISNULL(@e0003_ninthsaleamt_zk,0)    
			set @mrstaffsharecashamt=@mrstaffsharecashamt+ISNULL(@e0003_ninthsalecashamt_zk,0)            
		end                  
	...
	--第十销售           
	if(isnull(@e0003_tenthsalerid_zk,'')<>'' and ( ISNULL(@e0003_tenthsaleamt_zk,0)>0 or ISNULL(@e0003_tenthsalecashamt_zk,0)>0 ))                 
	begin                
		...
		begin                
			...
			set @mfstaffsharecashamt=@mfstaffsharecashamt+ISNULL(@e0003_tenthsalecashamt_zk,0)               
			set @mfstaffsharecount=@mfstaffsharecount+1                
		end          
		if  exists( select 1 from #emp_deperror where @e0003_tenthsalerid_zk=empid and emppos  in ('004','00401','00402','00103'))                
		begin                
			set @mrstaffshareamt=@mrstaffshareamt+ISNULL(@e0003_tenthsaleamt_zk,0) 
			set @mrstaffsharecashamt=@mrstaffsharecashamt+ISNULL(@e0003_tenthsalecashamt_zk,0)               
		end                  
	...
	if(ISNULL(@billinsertype,0)=3)
	begin             
		if(convert(numeric(20,1),ISNULL(@mfstaffsharecashamt,0)+ISNULL(@mrstaffsharecashamt,0))<>convert(numeric(20,1),ISNULL(@e0003_changefillamt_zk,0)))                
			set @e0003_bill_mcardchangeinfo=isnull(@e0003_bill_mcardchangeinfo,'')+'卡金业绩没有完全分享'    
    end         
    if(@compid in ('006','047','033','014','041','046') and @todate between '20140501' and '20140515')          
    begin          
		if(convert(numeric(20,2),ISNULL(@mfstaffshareamt,0)/ISNULL(@totalshareamt,0))>0.5)          
   ...
   fetch cur_#mcardchangeinfoerr3 into  @e0003_changebillid,                
    ...
    @e0003_firstsalecashamt_zk,@e0003_secondsalecashamt_zk,@e0003_thirdsalecashamt_zk,@e0003_fourthsalecashamt_zk,                
    @e0003_fifthsalecashamt_zk,@e0003_sixthsalecashamt_zk,@e0003_seventhsalecashamt_zk,@e0003_eighthsalecashamt_zk,                 
    @e0003_ninthsalecashamt_zk,@e0003_tenthsalecashamt_zk,@e0003_changefillamt_zk ,@billinsertype                      
  end                                        
