...
begin    
 ...
 insert into #msalecardinfo(salecompid,salebillid,firstsalerinid,firstsaleamt,secondsalerinid,secondsaleamt,thirdsalerinid,thirdsaleamt,    
   ...
   eighthsalerinid,eighthsaleamt,ninthsalerinid,ninthsaleamt,tenthsalerinid,tenthsaleamt,financedate,salebakflag,billinsertype)                                         
 select salecompid,salebillid,firstsalerinid,firstsaleamt,secondsalerinid,secondsaleamt,thirdsalerinid,thirdsaleamt,    
   fourthsalerinid,fourthsaleamt,fifthsalerinid,fifthsaleamt, sixthsalerinid,sixthsaleamt,seventhsalerinid,seventhsaleamt,    
   eighthsalerinid,eighthsaleamt,ninthsalerinid,ninthsaleamt,tenthsalerinid,tenthsaleamt,financedate,salebakflag ,case when isnull(@sp102,'0')='1' then ISNULL(billinsertype,0) else 0 end                                      
 ...
 --------------------------------------------计算售卡业绩-------Start------------------------------------------------    
   ...
   select salecompid,case when empdep=@DEP_BEAUT_CODE  then '31'    
		...
		else 1 end )*isnull(firstsaleamt,0)),0)                                             
   ...
   select salecompid,case when empdep=@DEP_BEAUT_CODE  then '31'    
        ...
        case when isnull(billinsertype,0)=1  and empdep=@DEP_HAIR_CODE then 0  --美容卡金 美发人员分享为0
			  when isnull(billinsertype,0)=2  and empdep=@DEP_BEAUT_CODE then 0  --美发卡金 美容人员分享为0
		else 1 end )*isnull(secondsaleamt,0)),0)                                                                          
   from #emp_dep ,#msalecardinfo                                      
   ...
   select salecompid,case when empdep=@DEP_BEAUT_CODE  then '31'    
        ...
        case when isnull(billinsertype,0)=1  and empdep=@DEP_HAIR_CODE then 0  --美容卡金 美发人员分享为0
			  when isnull(billinsertype,0)=2  and empdep=@DEP_BEAUT_CODE then 0  --美发卡金 美容人员分享为0
		else 1 end )*isnull(thirdsaleamt,0)),0)                                                                          
   from #emp_dep ,#msalecardinfo                                      
   ...
   select salecompid,case when empdep=@DEP_BEAUT_CODE  then '31'    
        ...
        case when isnull(billinsertype,0)=1  and empdep=@DEP_HAIR_CODE then 0  --美容卡金 美发人员分享为0
			  when isnull(billinsertype,0)=2  and empdep=@DEP_BEAUT_CODE then 0  --美发卡金 美容人员分享为0
		else 1 end )*isnull(fourthsaleamt,0)),0)                                                                          
   from #emp_dep ,#msalecardinfo                                      
   ...
   select salecompid,case when empdep=@DEP_BEAUT_CODE  then '31'    
        ...
        case when isnull(billinsertype,0)=1  and empdep=@DEP_HAIR_CODE then 0  --美容卡金 美发人员分享为0
			  when isnull(billinsertype,0)=2  and empdep=@DEP_BEAUT_CODE then 0  --美发卡金 美容人员分享为0
		else 1 end )*isnull(fifthsaleamt,0)),0)                                                                         
   from #emp_dep ,#msalecardinfo                                      
   ...
   select salecompid,case when empdep=@DEP_BEAUT_CODE  then '31'    
        ...
        case when isnull(billinsertype,0)=1  and empdep=@DEP_HAIR_CODE then 0  --美容卡金 美发人员分享为0
			  when isnull(billinsertype,0)=2  and empdep=@DEP_BEAUT_CODE then 0  --美发卡金 美容人员分享为0
		else 1 end )*isnull(sixthsaleamt,0)),0)                                                                          
   from #emp_dep ,#msalecardinfo                                      
   ...
   select salecompid,case when empdep=@DEP_BEAUT_CODE  then '31'    
        ...
        case when isnull(billinsertype,0)=1  and empdep=@DEP_HAIR_CODE then 0  --美容卡金 美发人员分享为0
			  when isnull(billinsertype,0)=2  and empdep=@DEP_BEAUT_CODE then 0  --美发卡金 美容人员分享为0
		else 1 end )*isnull(seventhsaleamt,0)),0)                                                                          
   from #emp_dep ,#msalecardinfo                                      
   ...
   select salecompid,case when empdep=@DEP_BEAUT_CODE  then '31'    
        ...
        case when isnull(billinsertype,0)=1  and empdep=@DEP_HAIR_CODE then 0  --美容卡金 美发人员分享为0
			  when isnull(billinsertype,0)=2  and empdep=@DEP_BEAUT_CODE then 0  --美发卡金 美容人员分享为0
		else 1 end )*isnull(eighthsaleamt,0)),0)                                                                          
   from #emp_dep ,#msalecardinfo                                      
   ...
   select salecompid,case when empdep=@DEP_BEAUT_CODE  then '31'    
        ...
        case when isnull(billinsertype,0)=1  and empdep=@DEP_HAIR_CODE then 0  --美容卡金 美发人员分享为0
			  when isnull(billinsertype,0)=2  and empdep=@DEP_BEAUT_CODE then 0  --美发卡金 美容人员分享为0
		else 1 end )*isnull(ninthsaleamt,0)),0)                                                                          
   from #emp_dep ,#msalecardinfo                                      
   ...
   select salecompid,case when empdep=@DEP_BEAUT_CODE  then '31'    
        ...
        case when isnull(billinsertype,0)=1  and empdep=@DEP_HAIR_CODE then 0  --美容卡金 美发人员分享为0
			  when isnull(billinsertype,0)=2  and empdep=@DEP_BEAUT_CODE then 0  --美发卡金 美容人员分享为0
		else 1 end )*isnull(tenthsaleamt,0)),0)                                                                          
   from #emp_dep ,#msalecardinfo                                      
 ...
 --41.帐户异动美容类业绩；42.帐户异动美发类业绩；43.帐户异动总业绩                                      
  ...
  insert into #mcardrechargeinfo(rechargecompid,rechargebillid,rechargetype,firstsalerinid,firstsaleamt,secondsalerinid,secondsaleamt,thirdsalerinid,thirdsaleamt,    
   fourthsalerinid,fourthsaleamt,fifthsalerinid,fifthsaleamt, sixthsalerinid,sixthsaleamt,seventhsalerinid,seventhsaleamt,    
   eighthsalerinid,eighthsaleamt,ninthsalerinid,ninthsaleamt,tenthsalerinid,tenthsaleamt,financedate,salebakflag,backbillid,billinsertype)                                      
 select rechargecompid,rechargebillid,rechargetype,firstsalerinid,firstsaleamt,secondsalerinid,secondsaleamt,thirdsalerinid,thirdsaleamt,    
   fourthsalerinid,fourthsaleamt,fifthsalerinid,fifthsaleamt, sixthsalerinid,sixthsaleamt,seventhsalerinid,seventhsaleamt,    
   eighthsalerinid,eighthsaleamt,ninthsalerinid,ninthsaleamt,tenthsalerinid,tenthsaleamt,financedate,salebakflag,backbillid ,case when isnull(@sp102,'0')='1' then ISNULL(billinsertype,0) else 0 end                             
