...
begin     
 ...
 select salecompid,salebillid,saledate,salecardno,salecardtype,firstsalerid,firstsalerinid,firstsaleamt,secondsalerid,secondsalerinid,secondsaleamt,      
                     thirdsalerid,thirdsalerinid,thirdsaleamt,fourthsalerid,fourthsalerinid,fourthsaleamt,fifthsalerid,fifthsalerinid,fifthsaleamt,      
                     sixthsalerid,sixthsalerinid,sixthsaleamt,seventhsalerid,seventhsalerinid,seventhsaleamt,eighthsalerid,eighthsalerinid,eighthsaleamt,      
                     ninthsalerid,ninthsalerinid,ninthsaleamt,tenthsalerid,tenthsalerinid,tenthsaleamt,financedate,salekeepamt,paymode,payamt,case when isnull(@sp102,'0')='1' then ISNULL(billinsertype,0) else 0 end  
 ...
 --卖卡第一销售人员                
 insert #work_detail(compid,person_inid,action_id,srvdate,code,name,billamt,ccount,billid,paycode,staffyeji,billinsertype)                
 select @compid,firstsalerinid,1,financedate,salecardno,cardtypename,payamt,1,salebillid,paymode,firstsaleamt*payamt/isnull(salekeepamt,1),ISNULL(billinsertype,0)                
 ...
 and a.firstsalerinid <= @toempinno                
    ...
    --卖卡第二销售人员                
 insert #work_detail(compid,person_inid,action_id,srvdate,code,name,billamt,ccount,billid,paycode,staffyeji,billinsertype)                
 select @compid,secondsalerinid,1,financedate,salecardno,cardtypename,payamt,1,salebillid,paymode,secondsaleamt*payamt/isnull(salekeepamt,1) ,ISNULL(billinsertype,0)                
 from #msalecardinfo a,cardtypenameinfo c               
 ...
 and a.secondsalerinid <= @toempinno                
    ...
    --卖卡第三销售人员                
 insert #work_detail(compid,person_inid,action_id,srvdate,code,name,billamt,ccount,billid,paycode,staffyeji,billinsertype)                
 select @compid,thirdsalerinid,1,financedate,salecardno,cardtypename,payamt,1,salebillid,paymode,thirdsaleamt*payamt/isnull(salekeepamt,1),ISNULL(billinsertype,0)                 
 from #msalecardinfo a,cardtypenameinfo c                
 ...
 and a.thirdsalerinid <= @toempinno                
    ...
    --卖卡第四销售人员                
 insert #work_detail(compid,person_inid,action_id,srvdate,code,name,billamt,ccount,billid,paycode,staffyeji,billinsertype)                
 select @compid,fourthsalerinid,1,financedate,salecardno,cardtypename,payamt,1,salebillid,paymode,fourthsaleamt*payamt/isnull(salekeepamt,1),ISNULL(billinsertype,0)                 
 from #msalecardinfo a ,cardtypenameinfo c              
 ...
 and a.fourthsalerinid <= @toempinno                
    ...
    --卖卡第五销售人员                
 insert #work_detail(compid,person_inid,action_id,srvdate,code,name,billamt,ccount,billid,paycode,staffyeji,billinsertype)                
 select @compid,fifthsalerinid,1,financedate,salecardno,cardtypename,payamt,1,salebillid,paymode,fifthsaleamt*payamt/isnull(salekeepamt,1),ISNULL(billinsertype,0)                 
 from #msalecardinfo a,cardtypenameinfo c               
 ...
 and a.fifthsalerinid <= @toempinno                
    ...
    --卖卡第六销售人员                
 insert #work_detail(compid,person_inid,action_id,srvdate,code,name,billamt,ccount,billid,paycode,staffyeji,billinsertype)                
 select @compid,sixthsalerinid,1,financedate,salecardno,cardtypename,payamt,1,salebillid,paymode,sixthsaleamt*payamt/isnull(salekeepamt,1),ISNULL(billinsertype,0)                 
 from #msalecardinfo a,cardtypenameinfo c               
 ...
 and a.sixthsalerinid <= @toempinno                
    ...
    --卖卡第七销售人员                
 insert #work_detail(compid,person_inid,action_id,srvdate,code,name,billamt,ccount,billid,paycode,staffyeji,billinsertype)                
 select @compid,seventhsalerinid,1,financedate,salecardno,cardtypename,payamt,1,salebillid,paymode,seventhsaleamt*payamt/isnull(salekeepamt,1),ISNULL(billinsertype,0)                 
 from #msalecardinfo a ,cardtypenameinfo c              
 ...
 and a.seventhsalerinid <= @toempinno                
    ...
    --卖卡第八销售人员                
 insert #work_detail(compid,person_inid,action_id,srvdate,code,name,billamt,ccount,billid,paycode,staffyeji,billinsertype)                
 select @compid,eighthsalerinid,1,financedate,salecardno,cardtypename,payamt,1,salebillid,paymode,eighthsaleamt*payamt/isnull(salekeepamt,1) ,ISNULL(billinsertype,0)                
 from #msalecardinfo a ,cardtypenameinfo c              
 ...
 insert #work_detail(compid,person_inid,action_id,srvdate,code,name,billamt,ccount,billid,paycode,staffyeji,billinsertype)                
 select @compid,ninthsalerinid,1,financedate,salecardno,cardtypename,payamt,1,salebillid,paymode,ninthsaleamt*payamt/isnull(salekeepamt,1),ISNULL(billinsertype,0)                 
 from #msalecardinfo a ,cardtypenameinfo c              
 ...
 and a.ninthsalerinid <= @toempinno                
    ...
    --卖卡第十销售人员                
 insert #work_detail(compid,person_inid,action_id,srvdate,code,name,billamt,ccount,billid,paycode,staffyeji,billinsertype)                
 select @compid,tenthsalerinid,1,financedate,salecardno,cardtypename,payamt,1,salebillid,paymode,tenthsaleamt*payamt/isnull(salekeepamt,1),ISNULL(billinsertype,0)                 
 from #msalecardinfo a  ,cardtypenameinfo c             
 ...
 select rechargecompid,rechargebillid,rechargedate,rechargecardno,rechargecardtype,rechargetype,firstsalerid,firstsalerinid,firstsaleamt,secondsalerid,secondsalerinid,secondsaleamt,      
                     thirdsalerid,thirdsalerinid,thirdsaleamt,fourthsalerid,fourthsalerinid,fourthsaleamt,fifthsalerid,fifthsalerinid,fifthsaleamt,      
                     sixthsalerid,sixthsalerinid,sixthsaleamt,seventhsalerid,seventhsalerinid,seventhsaleamt,eighthsalerid,eighthsalerinid,eighthsaleamt,      
                     ninthsalerid,ninthsalerinid,ninthsaleamt,tenthsalerid,tenthsalerinid,tenthsaleamt,financedate,rechargekeepamt,paymode,payamt ,case when isnull(@sp102,'0')='1' then ISNULL(billinsertype,0) else 0 end  
 ...
 where rechargecardno=cardno and ISNULL(rechargetype,0)=1      
  ...
  --卖卡第一销售人员                
 insert #work_detail(compid,person_inid,action_id,srvdate,code,name,billamt,ccount,billid,paycode,staffyeji,billinsertype)                
 select @compid,firstsalerinid,2,financedate,rechargecardno,cardtypename,payamt,1,rechargebillid,paymode,firstsaleamt*payamt/isnull(rechargekeepamt,1),ISNULL(billinsertype,0)                
 ...
 and a.firstsalerinid <= @toempinno                
    ...
    --卖卡第二销售人员                
 insert #work_detail(compid,person_inid,action_id,srvdate,code,name,billamt,ccount,billid,paycode,staffyeji,billinsertype)                
 select @compid,secondsalerinid,2,financedate,rechargecardno,cardtypename,payamt,1,rechargebillid,paymode,secondsaleamt*payamt/isnull(rechargekeepamt,1) ,ISNULL(billinsertype,0)               
 from #mcardrechargeinfo a  ,cardtypenameinfo c               
 where a.secondsalerinid >= @fromempinno                
 and a.secondsalerinid <= @toempinno                
    and isnull(secondsaleamt,0)<>0                  
    ...
    --卖卡第三销售人员                
 insert #work_detail(compid,person_inid,action_id,srvdate,code,name,billamt,ccount,billid,paycode,staffyeji,billinsertype)                
 select @compid,thirdsalerinid,2,financedate,rechargecardno,cardtypename,payamt,1,rechargebillid,paymode,thirdsaleamt*payamt/isnull(rechargekeepamt,1),ISNULL(billinsertype,0)                
 from #mcardrechargeinfo a   ,cardtypenameinfo c              
 where a.thirdsalerinid >= @fromempinno                
 and a.thirdsalerinid <= @toempinno                
    and isnull(thirdsaleamt,0)<>0      
    ...
    --卖卡第四销售人员                
 insert #work_detail(compid,person_inid,action_id,srvdate,code,name,billamt,ccount,billid,paycode,staffyeji,billinsertype)                
 select @compid,fourthsalerinid,2,financedate,rechargecardno,cardtypename,payamt,1,rechargebillid,paymode,fourthsaleamt*payamt/isnull(rechargekeepamt,1),ISNULL(billinsertype,0)                
 from #mcardrechargeinfo a    ,cardtypenameinfo c             
 where a.fourthsalerinid >= @fromempinno                
 and a.fourthsalerinid <= @toempinno       
    and isnull(fourthsaleamt,0)<>0      
    ...
    --卖卡第五销售人员                
 insert #work_detail(compid,person_inid,action_id,srvdate,code,name,billamt,ccount,billid,paycode,staffyeji,billinsertype)                
 select @compid,fifthsalerinid,2,financedate,rechargecardno,cardtypename,payamt,1,rechargebillid,paymode,fifthsaleamt*payamt/isnull(rechargekeepamt,1),ISNULL(billinsertype,0)                
 from #mcardrechargeinfo a  ,cardtypenameinfo c               
 where a.fifthsalerinid >= @fromempinno                
 and a.fifthsalerinid <= @toempinno                
    and isnull(fifthsaleamt,0)<>0      
    ...
    --卖卡第六销售人员                
 insert #work_detail(compid,person_inid,action_id,srvdate,code,name,billamt,ccount,billid,paycode,staffyeji,billinsertype)                
 select @compid,sixthsalerinid,2,financedate,rechargecardno,cardtypename,payamt,1,rechargebillid,paymode,sixthsaleamt*payamt/isnull(rechargekeepamt,1),ISNULL(billinsertype,0)                
 from #mcardrechargeinfo a ,cardtypenameinfo c             
 where a.sixthsalerinid >= @fromempinno                
 and a.sixthsalerinid <= @toempinno                
    and isnull(sixthsaleamt,0)<>0      
    ...
    --卖卡第七销售人员                
 insert #work_detail(compid,person_inid,action_id,srvdate,code,name,billamt,ccount,billid,paycode,staffyeji,billinsertype)                
 select @compid,seventhsalerinid,2,financedate,rechargecardno,cardtypename,payamt,1,rechargebillid,paymode,seventhsaleamt*payamt/isnull(rechargekeepamt,1),ISNULL(billinsertype,0)                
 from #mcardrechargeinfo a ,cardtypenameinfo c                
 where a.seventhsalerinid >= @fromempinno                
 and a.seventhsalerinid <= @toempinno                
    and isnull(seventhsaleamt,0)<>0      
    ...
    --卖卡第八销售人员                
 insert #work_detail(compid,person_inid,action_id,srvdate,code,name,billamt,ccount,billid,paycode,staffyeji,billinsertype)                
 select @compid,eighthsalerinid,2,financedate,rechargecardno,cardtypename,payamt,1,rechargebillid,paymode,eighthsaleamt*payamt/isnull(rechargekeepamt,1),ISNULL(billinsertype,0)                
 from #mcardrechargeinfo a  ,cardtypenameinfo c               
 where a.eighthsalerinid >= @fromempinno                
 and a.eighthsalerinid <= @toempinno                
    and isnull(eighthsaleamt,0)<>0      
    ...
    --卖卡第九销售人员                
 insert #work_detail(compid,person_inid,action_id,srvdate,code,name,billamt,ccount,billid,paycode,staffyeji,billinsertype)                
 select @compid,ninthsalerinid,2,financedate,rechargecardno,cardtypename,payamt,1,rechargebillid,paymode,ninthsaleamt*payamt/isnull(rechargekeepamt,1),ISNULL(billinsertype,0)                
 from #mcardrechargeinfo a  ,cardtypenameinfo c               
 where a.ninthsalerinid >= @fromempinno                
 and a.ninthsalerinid <= @toempinno                
    and isnull(ninthsaleamt,0)<>0      
    ...
    --卖卡第十销售人员                
 insert #work_detail(compid,person_inid,action_id,srvdate,code,name,billamt,ccount,billid,paycode,staffyeji,billinsertype)                
 select @compid,tenthsalerinid,2,financedate,rechargecardno,cardtypename,payamt,1,rechargebillid,paymode,tenthsaleamt*payamt/isnull(rechargekeepamt,1),ISNULL(billinsertype,0)                
 from #mcardrechargeinfo a  ,cardtypenameinfo c               
 where a.tenthsalerinid >= @fromempinno                
 and a.tenthsalerinid <= @toempinno                
    and isnull(tenthsaleamt,0)<>0      
 ...
 select changecompid,changebillid,changetype,changedate,changeaftercardno,changeaftercardtype,firstsalerid,firstsalerinid,firstsaleamt,secondsalerid,secondsalerinid,secondsaleamt,      
                     thirdsalerid,thirdsalerinid,thirdsaleamt,fourthsalerid,fourthsalerinid,fourthsaleamt,fifthsalerid,fifthsalerinid,fifthsaleamt,      
                     sixthsalerid,sixthsalerinid,sixthsaleamt,seventhsalerid,seventhsalerinid,seventhsaleamt,eighthsalerid,eighthsalerinid,eighthsaleamt,      
                     ninthsalerid,ninthsalerinid,ninthsaleamt,tenthsalerid,tenthsalerinid,tenthsaleamt,financedate,changefillamt,paymode,payamt,case when isnull(@sp102,'0')='1' then ISNULL(billinsertype,0) else 0 end   
    ...
    where changebillid=paybillid and changecompid=paycompid and paybilltype in ('ZK','TK')      
      ...
      --卖卡第一销售人员                
 insert #work_detail(compid,person_inid,action_id,srvdate,code,name,billamt,ccount,billid,paycode,staffyeji,billinsertype)                
 select @compid,firstsalerinid,3,financedate,changeaftercardno,cardtypename,case when isnull(changetype,0)=8  then (-1)*payamt else payamt end,1,changebillid,paymode,case when isnull(changetype,0)=8  then (-1)*firstsaleamt*payamt/isnull(changefillamt,1) else   firstsaleamt*payamt/isnull(changefillamt,1) end     ,ISNULL(billinsertype,0)          
 ...
 and a.firstsalerinid <= @toempinno                
    ...
    --卖卡第二销售人员                
 insert #work_detail(compid,person_inid,action_id,srvdate,code,name,billamt,ccount,billid,paycode,staffyeji,billinsertype)                
 select @compid,secondsalerinid,3,financedate,changeaftercardno,cardtypename,case when isnull(changetype,0)=8  then (-1)*payamt else payamt end,1,changebillid,paymode,case when isnull(changetype,0)=8  then (-1)*secondsaleamt*payamt/isnull(changefillamt,1) else   secondsaleamt*payamt/isnull(changefillamt,1) end ,ISNULL(billinsertype,0)           
 from     #mcardchangeinfo a  left join cardtypenameinfo c  on changeaftercardtype=cardtypeno       
 where a.secondsalerinid >= @fromempinno                
 and a.secondsalerinid <= @toempinno                
    and isnull(secondsaleamt,0)<>0                  
    ...
    --卖卡第三销售人员                
 insert #work_detail(compid,person_inid,action_id,srvdate,code,name,billamt,ccount,billid,paycode,staffyeji,billinsertype)                
 select @compid,thirdsalerinid,3,financedate,changeaftercardno,cardtypename,case when isnull(changetype,0)=8  then (-1)*payamt else payamt end,1,changebillid,paymode,case when isnull(changetype,0)=8  then (-1)*thirdsaleamt*payamt/isnull(changefillamt,1) else   thirdsaleamt*payamt/isnull(changefillamt,1) end ,ISNULL(billinsertype,0)         
 from     #mcardchangeinfo a  left join cardtypenameinfo c  on changeaftercardtype=cardtypeno       
 where a.thirdsalerinid >= @fromempinno                
 and a.thirdsalerinid <= @toempinno                
    and isnull(thirdsaleamt,0)<>0      
    ...
    --卖卡第四销售人员                
 insert #work_detail(compid,person_inid,action_id,srvdate,code,name,billamt,ccount,billid,paycode,staffyeji,billinsertype)                
 select @compid,fourthsalerinid,3,financedate,changeaftercardno,cardtypename,case when isnull(changetype,0)=8  then (-1)*payamt else payamt end,1,changebillid,paymode,case when isnull(changetype,0)=8  then (-1)*fourthsaleamt*payamt/isnull(changefillamt,1) else   fourthsaleamt*payamt/isnull(changefillamt,1) end ,ISNULL(billinsertype,0)            
 from     #mcardchangeinfo a  left join cardtypenameinfo c  on changeaftercardtype=cardtypeno       
 where a.fourthsalerinid >= @fromempinno                
 and a.fourthsalerinid <= @toempinno                
    and isnull(fourthsaleamt,0)<>0      
    ...
    --卖卡第五销售人员                
 insert #work_detail(compid,person_inid,action_id,srvdate,code,name,billamt,ccount,billid,paycode,staffyeji,billinsertype)                
 select @compid,fifthsalerinid,3,financedate,changeaftercardno,cardtypename,case when isnull(changetype,0)=8  then (-1)*payamt else payamt end,1,changebillid,paymode,case when isnull(changetype,0)=8  then (-1)*fifthsaleamt*payamt/isnull(changefillamt,1) else   fifthsaleamt*payamt/isnull(changefillamt,1) end,ISNULL(billinsertype,0)         
 from     #mcardchangeinfo a  left join cardtypenameinfo c  on changeaftercardtype=cardtypeno       
 where a.fifthsalerinid >= @fromempinno                
 and a.fifthsalerinid <= @toempinno                
    and isnull(fifthsaleamt,0)<>0      
    ...
    --卖卡第六销售人员                
 insert #work_detail(compid,person_inid,action_id,srvdate,code,name,billamt,ccount,billid,paycode,staffyeji,billinsertype)                
 select @compid,sixthsalerinid,3,financedate,changeaftercardno,cardtypename,case when isnull(changetype,0)=8  then (-1)*payamt else payamt end,1,changebillid,paymode,case when isnull(changetype,0)=8  then (-1)*sixthsaleamt*payamt/isnull(changefillamt,1) else   sixthsaleamt*payamt/isnull(changefillamt,1) end ,ISNULL(billinsertype,0)             
 from     #mcardchangeinfo a  left join cardtypenameinfo c  on changeaftercardtype=cardtypeno       
 where a.sixthsalerinid >= @fromempinno                
 and a.sixthsalerinid <= @toempinno                
    and isnull(sixthsaleamt,0)<>0      
    ...
    --卖卡第七销售人员                
 insert #work_detail(compid,person_inid,action_id,srvdate,code,name,billamt,ccount,billid,paycode,staffyeji,billinsertype)                
 select @compid,seventhsalerinid,3,financedate,changeaftercardno,cardtypename,case when isnull(changetype,0)=8  then (-1)*payamt else payamt end,1,changebillid,paymode,case when isnull(changetype,0)=8  then (-1)*seventhsaleamt*payamt/isnull(changefillamt,1) else   seventhsaleamt*payamt/isnull(changefillamt,1) end ,ISNULL(billinsertype,0)              
 from     #mcardchangeinfo a  left join cardtypenameinfo c  on changeaftercardtype=cardtypeno       
 where a.seventhsalerinid >= @fromempinno                
 and a.seventhsalerinid <= @toempinno                
    and isnull(seventhsaleamt,0)<>0      
    ...
    --卖卡第八销售人员                
 insert #work_detail(compid,person_inid,action_id,srvdate,code,name,billamt,ccount,billid,paycode,staffyeji,billinsertype)                
 select @compid,eighthsalerinid,3,financedate,changeaftercardno,cardtypename,case when isnull(changetype,0)=8  then (-1)*payamt else payamt end,1,changebillid,paymode,case when isnull(changetype,0)=8  then (-1)*eighthsaleamt*payamt/isnull(changefillamt,1) else   eighthsaleamt*payamt/isnull(changefillamt,1) end   ,ISNULL(billinsertype,0)          
 from     #mcardchangeinfo a  left join cardtypenameinfo c  on changeaftercardtype=cardtypeno       
 where a.eighthsalerinid >= @fromempinno                
 and a.eighthsalerinid <= @toempinno                
    and isnull(eighthsaleamt,0)<>0      
    ...
    --卖卡第九销售人员                
 insert #work_detail(compid,person_inid,action_id,srvdate,code,name,billamt,ccount,billid,paycode,staffyeji,billinsertype)                
 select @compid,ninthsalerinid,3,financedate,changeaftercardno,cardtypename,case when isnull(changetype,0)=8  then (-1)*payamt else payamt end,1,changebillid,paymode,case when isnull(changetype,0)=8  then (-1)*ninthsaleamt*payamt/isnull(changefillamt,1) else  ninthsaleamt*payamt/isnull(changefillamt,1) end ,ISNULL(billinsertype,0)        
 from     #mcardchangeinfo a  left join cardtypenameinfo c  on changeaftercardtype=cardtypeno       
 where a.ninthsalerinid >= @fromempinno                
 and a.ninthsalerinid <= @toempinno                
    and isnull(ninthsaleamt,0)<>0      
    ...
    --卖卡第十销售人员                
 insert #work_detail(compid,person_inid,action_id,srvdate,code,name,billamt,ccount,billid,paycode,staffyeji,billinsertype)                
 select @compid,tenthsalerinid,3,financedate,changeaftercardno,cardtypename,case when isnull(changetype,0)=8  then (-1)*payamt else payamt end,1,changebillid,paymode,case when isnull(changetype,0)=8  then (-1)*tenthsaleamt*payamt/isnull(changefillamt,1) else   tenthsaleamt*payamt/isnull(changefillamt,1) end  ,ISNULL(billinsertype,0)       
 from     #mcardchangeinfo a  left join cardtypenameinfo c  on changeaftercardtype=cardtypeno       
 where a.tenthsalerinid >= @fromempinno                
 and a.tenthsalerinid <= @toempinno                
    and isnull(tenthsaleamt,0)<>0      
 ...
 from #mproexchangeinfo a        
 where isnull(firstsaleamt,0)<>0   and ISNULL(firstsalerinid,'')<>'' and ISNULL(changeproid,'')='380093800'  
 ...
 from #mproexchangeinfo a        
 where  isnull(secondsaleamt,0)<>0  and ISNULL(secondsalerinid,'')<>'' and ISNULL(thirdsalerinid,'')=''  and ISNULL(changeproid,'')='380093800'                    
 ...
 from #mproexchangeinfo a        
 where  isnull(thirdsaleamt,0)<>0  and ISNULL(thirdsalerinid,'')<>'' and ISNULL(secondsalerinid,'')=''  and ISNULL(changeproid,'')='380093800'                    
 ...
 and a.eighthsalerinid <= @toempinno                
    ...
    csfirstsaler,csfirsttype,csfirstinid,csfirstshare,cssecondsaler,cssecondtype,cssecondinid,cssecondshare,csthirdsaler,csthirdtype,csthirdinid,csthirdshare,diyongcardno,tiaomacardno,csitemstate,costpricetype)      
