...
begin    
  ...
  a.staffbasesalary=isnull(b.basesalary,0) ,    
      ...
      a.salaryflag=b.salaryflag,a.staffsocials=b.socialsecurity,a.staffmark=b.remark,a.staffsocialsource=b.socialsource,a.basestaffamt=5    
  ...
  update #staff_work_salary                                       
  set staffdebit=isnull((select sum(isnull(rewardamt,0)) from mstaffrewardinfo a,dstaffrewardinfo b where a.entrycompid=b.entrycompid and a.entrybillid=b.entrybillid and handcompid=@compid and billflag=1 and entrydate>=@fromdate and entrydate<=@todate and handstaffinid=staffinid and entrytype='02' ),0)                               
  ...
  update #staff_work_salary                                       
  set latdebit=isnull((select sum(isnull(rewardamt,0)) from mstaffrewardinfo a,dstaffrewardinfo b where a.entrycompid=b.entrycompid and a.entrybillid=b.entrybillid and handcompid=@compid and billflag=1 and entrydate>=@fromdate and entrydate<=@todate and handstaffinid=staffinid and entrytype='04' ),0)                                  
 
      
  --其他扣款                                    
                
  update #staff_work_salary                                       
  set otherdebit=isnull((select sum(isnull(rewardamt,0)) from mstaffrewardinfo a,dstaffrewardinfo b where a.entrycompid=b.entrycompid and a.entrybillid=b.entrybillid and handcompid=@compid and billflag=1 and entrydate>=@fromdate and entrydate<=@todate and handstaffinid=staffinid and entrytype='05' ),0)                                
  ...
  update #staff_work_salary                                       
  set studydebit=isnull((select sum(isnull(rewardamt,0)) from mstaffrewardinfo a,dstaffrewardinfo b where a.entrycompid=b.entrycompid and a.entrybillid=b.entrybillid and handcompid=@compid and billflag=1 and entrydate>=@fromdate and entrydate<=@todate and handstaffinid=staffinid and entrytype='09' ),0)                                
  ...
  update #staff_work_salary                                       
  set staffcost=isnull((select sum(isnull(rewardamt,0)) from mstaffrewardinfo a,dstaffrewardinfo b where a.entrycompid=b.entrycompid and a.entrybillid=b.entrybillid and handcompid=@compid and billflag=1 and entrydate>=@fromdate and entrydate<=@todate and handstaffinid=staffinid and entrytype='08' ),0)                                 
  
                           
  ----住宿                                    
  update #staff_work_salary                                       
  set staydebit=isnull((select sum(isnull(rewardamt,0)) from mstaffrewardinfo a,dstaffrewardinfo b where a.entrycompid=b.entrycompid and a.entrybillid=b.entrybillid and handcompid=@compid and billflag=1 and entrydate>=@fromdate and entrydate<=@todate and handstaffinid=staffinid and entrytype='07' ),0)                                 
  
      
  --奖励         
  update #staff_work_salary                                       
  set staffreward=isnull((select sum(isnull(rewardamt,0)) from mstaffrewardinfo a,dstaffrewardinfo b where a.entrycompid=b.entrycompid and a.entrybillid=b.entrybillid and handcompid=@compid and billflag=1 and entrydate>=@fromdate and entrydate<=@todate and handstaffinid=staffinid and entrytype='10' ),0)                               
  
   --差异调整        
  update #staff_work_salary                                       
  set staffamtchange=isnull((select sum(isnull(rewardamt,0)) from mstaffrewardinfo a,dstaffrewardinfo b where a.entrycompid=b.entrycompid and a.entrybillid=b.entrybillid and handcompid=@compid and billflag=1 and entrydate>=@fromdate and entrydate<=@todate and handstaffinid=staffinid and entrytype='11' ),0)                               
  ...
  update #staff_work_salary     
      set needpaysalary=ISNULL(stafftotalyeji,0)+ ISNULL(staffshopyeji,0)+    
         ...
         ISNULL(staffsocials,0)-ISNULL(basestaffamt,0)+ISNULL(basestaffpayamt,0)+isnull(staffamtchange,0)+isnull(stafftargetreward,0),    
  ...
  update #staff_work_salary set strCompName=compname,factpaysalary=factpaysalary-ISNULL(staydebit,0)-ISNULL(studydebit,0)-ISNULL(staffcost,0)    
  ...
  select strCompId,strCompName,staffno,staffinid,staffname,staffposition,staffpositionname,staffpcid,staffbankaccountno,workdays,computedays,    
         ...
         basestaffamt,staffsocialsource,staffamtchange,stafftargetreward,basestaffpayamt 
