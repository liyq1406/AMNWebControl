alter procedure upg_all_personal_comm_paymode_04(                                      
...
set @fuflag=@quan         
 ...
 begin      
  ...
  from #allstaff_work_analysis a      
   ...
   delete   allstaff_work_analysis_04 where compid=@compid and mmonth=@fromdate
   insert allstaff_work_analysis_04(compid,mmonth,person_inid,staffno,staffname,staffposition,oldcostcount,newcostcount,trcostcount,cashbigcost,cashsmallcost,cashhulicost,      
  ...
  select @compid,@fromdate, person_inid,staffno,staffname,staffposition,oldcostcount,newcostcount,trcostcount,cashbigcost,cashsmallcost,cashhulicost,      
    cardbigcost,cardsmallcost,cardhulicost,cardprocost,cardsgcost,cardpointcost,projectdycost,cashdycost,tmcardcost,      
    salegoodsamt,salecardsamt,prochangeamt,saletmkamt,qhpayinner,qhpayouter,jdpayinner,smpayinner,staffyeji,staffcashyeji      
