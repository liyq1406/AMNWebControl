...
<head>
	...
	<script type="text/javascript" src="<%=ContextPath%>/SupplierControl/SUC001/suc001.js"></script>
...
<body>
	<div class="l-loading" style="display:block;height:100%;" id="pageloading"></div> 
	 <div id="suc001layout" style="width:100%;margin:0 auto; margin-top:0px;  "> 
	    <div position="center"   id="designPanel"  style="width:100%;"> 
				...
				<table width="100%" border="0" cellspacing="1" cellpadding="0" style="font-size:12px;line-height:35px;">
					<tr height="178;">
						<td valign="top">
						<div style="width:800;float:left; clear:both; border:1px solid #ccc; overflow:auto;font-size:12px;margin-bottom: 5px;">
							<form name="dataForm" method="post"  id="dataForm">
								<table id="dataTable" width="100%" border="0" cellspacing="1" cellpadding="0" style="font-size:12px;line-height:35px;" >
									<tr>
										<td colspan="2">&nbsp;&nbsp;合同编号&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
										<input type="text" name="contractno" id="contractno" style="width:200;" readonly="readonly" value="${supplier.contractno}"/></td>
										<td colspan="2">
											...
											<input type="hidden" id="no" name="no" value="${supplier.no}" />
										</td>
									</tr>
									<tr>	
										<td>&nbsp;&nbsp;供应商名称</td>
										<td><input type="text" name="name" id="name" style="width:200;" readonly="readonly" value="${supplier.name}" /></td>
										<td>&nbsp;&nbsp;开始日期</td>
										<td><input type="text" name="startdate" id="startdate" style="width:200;" readonly="readonly" value="${supplier.startdate}" /></td>
									</tr>
									<tr>	
										<td>&nbsp;&nbsp;供应商电话</td>
										<td><input type="text" name="telephone" id="telephone" style="width:200;" readonly="readonly" value="${supplier.telephone}" /></td>
										<td>&nbsp;&nbsp;供应商传真</td>
										<td><input type="text" name="fax" id="fax" style="width:200;" readonly="readonly" value="${supplier.fax}" /></td>
									</tr>
									<tr>	
										<td>&nbsp;&nbsp;供应商地址</td>
										<td colspan="3"><input type="text" name="address" id="address" style="width:608;" readonly="readonly" value="${supplier.address}" /></td>
									</tr>
									<tr>	
										<td>&nbsp;&nbsp;登录编号</td>
										<td><input type="text" name="login" id="login" style="width:200;" readonly="readonly" value="${supplier.login}" /></td>
										<td>&nbsp;&nbsp;登陆密码</td>
										<td><input type="password" name="password" id="password" style="width:200;" readonly="readonly" value="${supplier.password}" /></td>
									</tr>
								</table>
							</form>
							</div>
  ...
  <!-- g data total ttt -->
	...
	<script language="JavaScript">
  	 	...
  	 	var supplierno="${sessionScope.supplier.no}";
		...
		if(checkNull(supplierno) == ""){
			$.ligerDialog.warn("当前系统链接已丢失,需要重新登录！");
