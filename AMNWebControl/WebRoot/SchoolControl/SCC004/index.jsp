...
<body>
	<div class="l-loading" style="display:block;height:100%;" id="pageloading"></div> 
	 <div id="scc004layout" style="width:100%;margin:0 auto; margin-top:0px;  "> 
					...
					<tr height="145">
						...
						<div  style="width:600;float:left; clear:both; border:1px solid #ccc; overflow:auto;font-size:12px;margin-bottom: 5px;">
								<table id="dataTable" width="100%" border="0" cellspacing="0" cellpadding="0" style="font-size:12px;line-height:28px;" >
									...
									<tr>	
										<td>&nbsp;&nbsp;&nbsp;姓名</td>
										<td><input type="text" name="curStaffinfo.staffname" id="staffname" style="width:110;margin-left: 5px;" readonly="readonly" /></td>
										<td>&nbsp;&nbsp;职位<select name="curStaffinfo.position" id="position" style="width:120;margin-left: 5px;" disabled="true"></select></td>
									</tr>
									<tr>	
										<td>&nbsp;&nbsp;&nbsp;身份证号码</td>
										<td><input type="text" name="curStaffinfo.pccid" id="pccid" style="width:140;" readonly="readonly" /></td>
										<td>&nbsp;&nbsp;手机<input type="text" name="curStaffinfo.mobilephone" id="mobilephone" style="width:120;margin-left: 5px;" readonly="readonly" /></td>
									</tr>
									<tr>	
										<td>&nbsp;&nbsp;&nbsp;工号</td>
										<td><input type="text" name="curStaffinfo.id.staffno" id="staffno" style="width:100;" readonly="readonly" /></td>
										<td>&nbsp;&nbsp;课程<select name="credit" id="credit" style="width:120;" disabled="true"></select>
											&nbsp;&nbsp;是否合格&nbsp;<select name="ispass" id="ispass" disabled="true"><option value="1">是</option><option value="0">否</option></select>
										</td>
									</tr>
									<tr>	
										<td>&nbsp;&nbsp;&nbsp;备注</td>
										<td colspan="2" nowrap="nowrap"><input type="text" name="remark" id="remark" style="width:300;" readonly="readonly" />
										<div id="listBtn" style="margin-right: 40px;float: right;"></div></td>
									</tr>
								</table>
							</div>
						</td>
