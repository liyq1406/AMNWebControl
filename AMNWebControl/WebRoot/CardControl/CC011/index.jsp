  	 ...
  	 <div id="cc011layout" style="width:100%; margin:0 auto; margin-top:4px; "> 
		 <div position="center"   id="designPanel"  style="width:100%;" > 
		 	<form name="consumCenterForm" method="post"  id="consumCenterForm">
				...
				<td valign="top" colspan="3" >	
					<table width="100%"  border="0" cellspacing="1" cellpadding="0" style="font-size:12px;line-height:20px" >
						<tr>
							...
							<td valign="top" height="200"  ><div id="commoninfodivdetial_WX" style="margin:0; padding:0;" ></div></td>
							<td valign="top" height="200"  ><div id="commoninfodivdetial_padInfo" style="margin:0; padding:0;display:none" ></div></td>
						</tr>
					</table>
				</td>
				</tr>
				...
				<tr>
					<td valign="top" colspan="3">
						<table width="100%"  border="0" cellspacing="0" cellpadding="0" style="font-size:12px;line-height:20px">
							<td valign="top" style="width: 30%;">
								<div id="toptoolbardetial1" style="margin-right: 1px;"></div> 
							</td>
							<td valign="top" style="width: 70%;">
								<div id="temptoolbardetial1"></div> 
							</td>
						</table>
					</td>
				</tr>
				...
				<input type="hidden" name="curMconsumeinfo.csphone" id="csphone"  />
				...
				<input type="hidden"  name="cardfaceamt" id="cardfaceamt"   />
				...
				<input type="hidden"  name="curMconsumeinfo.cardphone" id="cardphone"/>
				<input type="hidden"  id="type" name="type"/>
				<input type="hidden" name="HDPhone" id="HDPhone"/>
				<input type="hidden" name="curMconsumeinfo.ticketcode" id="ticketcode"/>
				</form>
					...
					<table id="texts" style="font: 12px;line-height: 16px; text-align: inherit" cellspacing="0" cellpadding="0" width="100%">
							...
							<tr>
										<td >
											...
											&nbsp;&nbsp;介绍人:&nbsp;&nbsp;
											<input type="text"name="whairRecommendEmpId" id="whairRecommendEmpId" readonly="true"  onchange="validateHairEmpid(this)"    style="width:60;" />
										</td>
						...
						<input type="hidden" name="paramSp108" id="paramSp108" />
						<input type="hidden" name="paramSp112" id="paramSp112" />
						<input type="hidden" name="paramSp113" id="paramSp113" />
						<input type="hidden" name="paramSp016" id="paramSp016" />
