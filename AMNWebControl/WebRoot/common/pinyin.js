...
for (var i=ascCode; (!spell[i] && i>0);) 
   i--;
//return spell[i];//这个是获得全拼（小写字母）
  return spell[i].substring(0,1).toUpperCase();//这个是获得汉字首字母，大写
}
//修改的方法
...
function toPinyin(str)
{
   ...
   for (var i=0; i<str.length; i++)
   {
    if (isEnKong1(str.charAt(i))) {
     pStr += str.charAt(i).toUpperCase();//除汉字外，其他值，如果是小写字母变成大写输出
  // pStr += str.charAt(i);//除汉字外其他原值输出
    }
    else{
