...
/* thumbnailWrapper */
.thumbnailWrapper{width:1050px;margin:10px auto 0 auto;color:#ffffff;text-align:center;font-family:'georgia';font-size: 12px;}
	...
	try
	{
		...
		for( var i=0;i<parent.Sysmodeinfo.length;i++)
		{
			if(parent.Sysmodeinfo[i].id.upmoduleno==curGroupType)
			{
				...
				imageurl="2.jpg";
				//if(curGroupType=="BC")
					//imageurl="BC/"+parent.Sysmodeinfo[i].id.curmoduleno+".jpg";
				createFunction(parent.Sysmodeinfo[i].moduleurl,parent.Sysmodeinfo[i].id.curmoduleno,parent.Sysmodeinfo[i].modulename,imageurl);
			}
		}
		urDivActive();
	}catch(e){alert(e.message)}
...
<body >
	<div id="sidebar">
      <div class="mainNav">
			...
			<ul class="nav">
				<li><a title="" href="javascript:showFunctionDetial('BaseInfoControl')"  ><img src="<%=ContextPath%>/fullScreen2/images/icons/mainnav/dashboard.png" alt="" /><span>基本设定</span></a>
				</li>
				<li><a  title="" href="javascript:showFunctionDetial('CardControl')" ><img src="<%=ContextPath%>/fullScreen2/images/icons/mainnav/forms.png" alt="" /><span>运营管理</span></a>
				</li>
				<li><a  title="" href="javascript:showFunctionDetial('PersonnelControl')"  ><img src="<%=ContextPath%>/fullScreen2/images/icons/mainnav/ui.png" alt="" /><span>人事管理</span></a>
					
				</li>
				<li><a  title="" href="javascript:showFunctionDetial('SellReportControl')"  ><img src="<%=ContextPath%>/fullScreen2/images/icons/mainnav/statistics.png" alt="" /><span>销售管理</span></a>
					
				</li>
				<li><a  title="" href="javascript:showFunctionDetial('InvoicingControl')"  ><img src="<%=ContextPath%>/fullScreen2/images/icons/mainnav/other.png" alt="" /><span>物流管理</span></a>
					
				</li>
				<li><a  title=""  href="javascript:showFunctionDetial('AdvancedOperations')"   ><img src="<%=ContextPath%>/fullScreen2/images/icons/mainnav/tables.png" alt="" /><span>高级操作</span></a> 
				</li>
				</li>
				<li><a  title=""  href="javascript:showFunctionDetial('BOOSREP')"   ><img src="<%=ContextPath%>/fullScreen2/images/icons/mainnav/tables.png" alt="" /><span>老板报表</span></a> 
				</li>
				<li><a  title=""  href="javascript:showFunctionDetial('SchoolControl')"   ><img src="<%=ContextPath%>/fullScreen2/images/icons/mainnav/forms.png" alt="" /><span>学校积分管理</span></a> 
				</li>
			</ul>
      </div>
       <div class="secNav"  >
    ...
    <script type="text/javascript">
    	showFunctionDetial("AdvancedOperations");
    </script>
</body>
</html>
