...
<head>
	...
	<script type="text/javascript" src="<%=ContextPath%>/BaseInfoControl/BC005/bc005.js"></script>
...
<div class="l-loading" style="display:block" id="pageloading"></div> 
  	 ...
  	 <div id="bc005layout" style="width:100%; margin:0 auto; margin-top:4px; "> 
				        ...
				        <div position="center"   id="designPanel"  style="width:100%;"> 
					           <div id="searchbar"> 
			    				...
			    				<input id="btnOK" type="button" value="查询产品信息" onclick="f_searchStaffInfo()" />
								</div>
