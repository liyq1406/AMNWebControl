...
<head>
	...
	<script type="text/javascript" src="<%=ContextPath%>/BaseInfoControl/BC007/bc007.js"></script>
...
<div class="l-loading" style="display:block" id="pageloading"></div> 
  	 ...
  	 <div id="bc007layout" style="width:100%; margin:0 auto; margin-top:4px; "> 
				        ...
				        <div position="center"   id="designPanel"  style="width:100%;" title="卡类型列表"> 
					           <div id="searchbar">
			    				关键字：<input id="txtSearchKey" type="text" />
			    				<input id="btnOK" type="button" value="查询卡类别信息" onclick="f_searchStaffInfo()" />
								</div>
								<div id="commoninfodivsecond" style="margin:0; padding:0"></div>
				        </div>
				        <div position="right"   id="lsPanel" title="转卡规则"> 
