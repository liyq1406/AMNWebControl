...
<body style="padding:6px; overflow:hidden;">
	<form name="curRZFrom" method="post"  id="curRZFrom">
		...
		<tr>
			...
			<td><font color="blue">合约到期日</font></td>
			<td><input type="text" id="contractdate" name="curStaffinfo.contractdate" style="width:140"  maxlength="18"/>
			<input type="hidden" id="qqno" name="curStaffinfo.qqno" /></td>
		</tr>
		<tr>
			<td>最高学历</td>
			<td>
		...
		<tr>
			<td>业绩属性</td>
			<td>
				<input type="radio" id="businessflag1" style="border:0px solid #99CC33; font-size:12px;line-height:14px; color:#333;"	name="curStaffinfo.businessflag" value="0"   checked="true" />非业务
				<input type="radio" id="businessflag2" style="border:0px solid #99CC33; font-size:12px;line-height:14px; color:#333;"	name="curStaffinfo.businessflag" value="1"/>业务
			</td>
			<td>业绩方式</td>
			<td>
