...
<head>
	...
	<script type="text/javascript" src="<%=ContextPath%>/common/amnreport.js"></script>
 	<script type="text/javascript" src="<%=ContextPath%>/BaseInfoControl/BC012/bc012OutPageKDD.js"></script>
...
<body style="padding:6px; overflow:hidden;">
	<form name="curRZFrom" method="post"  id="curRZFrom">
		...
		<tr>
			<td  width="120">
			<font color="blue">原门店</font></td>
			<td><input type="text" id="appchangecompid" name="curStaffchangeinfo.appchangecompid" style="width:120" maxlength="20" readonly="true"/></td>
			<td><font color="red">新门店</font></td>
			<td><input type="text" id="aftercompid" name="curStaffchangeinfo.aftercompid" style="width:140" maxlength="20" /></td>
		</tr>
		...
		<tr>
			...
			<td><input type="text" id="afterstaffno" name="curStaffchangeinfo.afterstaffno" style="width:140" maxlength="20" /></td>
		</tr>
		<tr>
		...
		<tr>
			<td colspan="4"  valign="top"><div id="commoninfodivBDDate"></div></td>
		</tr>
		</table>
