	...
	$(function ()
   	{
   		try
   		{
            ...
            var gwgzData=null;
            if(parent.curRecord.id.compno=="001")
            	gwgzData=parent.parent.gainCommonInfoByCodeByUse("GZGW",0,2);
            else
            	gwgzData=parent.parent.gainCommonInfoByCodeByUse("GZGW",0,1);
   	...
   	function comfirmbill()
   	{
   		...
   		if(document.getElementById("businessflag2").checked==true)
   		{
   			if(document.getElementById("compno").value!="001")
   			{
   				if(document.getElementById("staffno").value.length!=6)
   	   			{
   	   				$.ligerDialog.warn("业务人员的工号长度必须为6位!");
   	   				return;
   	   			}
   			}
