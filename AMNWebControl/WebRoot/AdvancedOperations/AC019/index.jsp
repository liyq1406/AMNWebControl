...
<head>
	...
	<script type="text/javascript" src="<%=ContextPath%>/AdvancedOperations/AC019/ac019.js"></script>
...
<div class="l-loading" style="display:block" id="pageloading"></div> 
  	 <div id="ac019layout" style="width:100%; margin:0 auto; margin-top:4px; ">
	  	...
	  	<div position="center"   id="designPanel"  style="width:100%;"> 
	  		<div id="AC019tab" style="width:100%; height:100%;  float:left; clear:both; border:1px solid #ccc; overflow:auto;font-size:12px;  "> 
				<div title="考勤机员工列表" style=" ;font-size:12px;" >
					<table width="100%" height="100%" border="0" cellspacing="1" cellpadding="0" style="font-size:12px;">
						<tr>
							<td width="650"><div id="commoninfodivCompMachine" style="margin:0; padding:0"></div></td>
							<td><div id="commoninfodivMStaffDate" style="margin:0; padding:0"></div></td>
						</tr>
					</table>
