...
<head>
	...
	<script type="text/javascript" src="<%=ContextPath%>/AdvancedOperations/AC017/ac017.js"></script>
...
<div class="l-loading" style="display:block" id="pageloading"></div> 
  	 ...
  	 <div id="ac017layout" style="width:100%; margin:0 auto; margin-top:4px; ">
	  	<div position="center"   id="designPanel"  style="width:100%;"> 
			...
			<tr>
				 ...
				 <td width="60"><div id="searchButton"></div></td>
				  <td width="160"><div id="excelButtonA"></div></td>
				  <td width="160"><div id="excelButtonB"></div></td>
			...
			<td colspan="6" valign="top">
				...
				<td  valign="top">
					<div id="toptoolbardetialA"></div>
					<div id="toptoolbardetialB"></div>
