					 ...
					 <div id="AC008Tab" style="width:700px; height:95%;  float:left; clear:both; border:1px solid #ccc; overflow:auto;font-size:12px;  "> 
				  	 ...
				  	 <table width="100%"  border="1" cellspacing="1" cellpadding="0" style="font-size:12px;line-height:20px" >
						<tr>
							...
							<td>
								<select id="billinsertype" name="curReEditBillInfo.billinsertype" style="width:100"   >
							...
							<td colspan="3"><input type="text" name="curReEditBillInfo.strMemberName" id="strMemberName"  readonly="true" style="width:120;" onchange="validateSalecardno(this)"  validate="{required:true,minlength:1,maxlength:18,notnull:false}"/></td>
							...
							<td>兑换项目</td>
							<td  colspan="3"><input type="text"  name="strPrjName" id="strPrjName"  readonly="true" style="width:200;"  /></td>
							</tr>
							...
							<td>分享金额</td>
							<td><input type="text"  name="curReEditBillInfo.firstsaleamt" id="firstsaleamt"   style="width:140;" onchange="validatePrice(this)"/></td>
							...
							<td>分享金额</td>
							<td><input type="text"  name="curReEditBillInfo.secondsaleamt" id="secondsaleamt"  style="width:140;" onchange="validatePrice(this)"/></td>
							</tr>
							...
							<td>分享金额</td>
							<td><input type="text"  name="curReEditBillInfo.thirdsaleamt" id="thirdsaleamt"  style="width:140;" onchange="validatePrice(this)"/></td>
							</tr>
							...
							<td>分享金额</td>
							<td><input type="text"  name="curReEditBillInfo.fourthsaleamt" id="fourthsaleamt"  style="width:140;" onchange="validatePrice(this)"/></td>
							</tr>
							<tr>
							...
							<td>分享金额</td>
							<td><input type="text"  name="curReEditBillInfo.fifthsaleamt" id="fifthsaleamt"  style="width:140;" onchange="validatePrice(this)"/></td>
							</tr>
							<tr>
							...
							<td>分享金额</td>
							<td><input type="text"  name="curReEditBillInfo.sixthsaleamt" id="sixthsaleamt"  style="width:140;" onchange="validatePrice(this)"/></td>
							</tr>
							...
							<td>分享金额</td>
							<td><input type="text"  name="curReEditBillInfo.seventhsaleamt" id="seventhsaleamt"  style="width:140;" onchange="validatePrice(this)"/></td>
							</tr>
							<tr>
							...
							<td>分享金额</td>
							<td><input type="text"  name="curReEditBillInfo.eighthsaleamt" id="eighthsaleamt"  style="width:140;" onchange="validatePrice(this)"/></td>
							</tr>
							<tr>
							...
							<td>第九销售</td>
							<td><input type="text" name="ninthsalerid" id="ninthsalerid"  readonly="true" style="width:140;" onchange="checkStaffValuex(this)"/></td>
							<td>分享金额</td>
							<td><input type="text"  name="curReEditBillInfo.ninthsaleamt" id="ninthsaleamt"  style="width:140;" onchange="validatePrice(this)"/></td>
							</tr>
							<tr>
							...
							<td>第十销售</td>
							<td><input type="text" name="tenthsalerid" id="tenthsalerid"  readonly="true" style="width:140;" onchange="checkStaffValuex(this)"/></td>
							<td>分享金额</td>
							<td><input type="text"  name="curReEditBillInfo.tenthsaleamt" id="tenthsaleamt"  style="width:140;" onchange="validatePrice(this)"/></td>
							</tr>
	
							<tr><td colspan="5" align="center"> <div id="editCurRootInfo"></div></td></tr>
							</table>
							</div>
						</td>
					</tr>
						...
						<input name="curReEditBillInfo.firstsalerid" 	id="firstsalerid_h" type="hidden"/>
						<input name="curReEditBillInfo.secondsalerid" 	id="secondsalerid_h" type="hidden"/>
						<input name="curReEditBillInfo.thirdsalerid" 	id="thirdsalerid_h" type="hidden"/>
						<input name="curReEditBillInfo.fourthsalerid" 	id="fourthsalerid_h" type="hidden"/>
						<input name="curReEditBillInfo.fifthsalerid" 	id="fifthsalerid_h" type="hidden"/>
						<input name="curReEditBillInfo.sixthsalerid" 	id="sixthsalerid_h" type="hidden"/>
						<input name="curReEditBillInfo.seventhsalerid" 	id="seventhsalerid_h" type="hidden"/>
						<input name="curReEditBillInfo.eighthsalerid" 	id="eighthsalerid_h" type="hidden"/>
						<input name="curReEditBillInfo.ninthsalerid" 	id="ninthsalerid_h" type="hidden"/>
						<input name="curReEditBillInfo.tenthsalerid" 	id="tenthsalerid_h" type="hidden"/>
					</div>
