...
<head>
	...
	<script type="text/javascript" src="<%=ContextPath%>/AdvancedOperations/AC016/ac016.js"></script>
...
<div class="l-loading" style="display:block" id="pageloading"></div> 
  	 ...
  	 <div id="ac016layout" style="width:100%; margin:0 auto; margin-top:4px; ">
	  	<div position="center"   id="designPanel"  style="width:100%;"> 
			...
			<tr>
				 ...
				 <td width="110">
				  ...
				  <td width="140">社保<select id="socialsourceflag" name="socialsourceflag"  style="width:80">	
				 	<option value="0">所有</option>
				 	<option value="1">维沙</option>
				 	<option value="3">非维沙</option>
				 	<option value="2">无社保</option>
				 </select> </td>
				 <td width="120"><div id="searchButton"></div></td>
				 <td width="120" ><div id="excelButton"></div></td>
				 <td ><input type="checkbox" id="shortExcep" checked="true"/><font color="red">A3</font></td>
			</tr>
		 ...
		 <div position="right"   id="lsPanel" title="缺勤信息"> 
		 	<div id="disabsenceStaffdiv"></div>
		 </div>
	</div> 
