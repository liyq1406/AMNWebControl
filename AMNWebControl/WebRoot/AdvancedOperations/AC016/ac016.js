	...
	var strCurDate="";
	   ...
	   {
	   		  //布局
            ac016layout= $("#ac016layout").ligerLayout({ allowBottomResize: false, allowLeftResize: false,isRightCollapse:true });
           	var height = $(".l-layout-center").height();
           	var centerWidth = ac016layout.centerWidth
    ...
    {	
    	...
    	params=params+"&socialsourceflag="+document.getElementById("socialsourceflag").value;
     	var requestUrl ="ac016/loadDataSet.action"; 
		...
		function loadDataSetExcel()
		{
			...
			var excelDialog=$.ligerDialog.open({url: contextURL+'/ac016/loadac016Excel.action?'+params });
	...
	function loadCurStaffAbsenceinfo(data, rowindex, rowobj)
	{
    		...
    		params=params+"&strToDate="+strToDate;	
    		params=params+"&socialsourceflag="+document.getElementById("socialsourceflag").value;
     		var requestUrl ="ac016/loadStaffAbsence.action"; 
     ...
     function loadStaffAbsenceMessage(request)
    {
    	try
        {
    		...
    		lsStaffabsenceinfo=responsetext.lsStaffabsenceinfo;
	   		shownewPayDialogmanager=$.ligerDialog.open({ height: null, url: contextURL+'/PersonnelControl/ac016/staffAbsence.jsp', width: 750, showMax: false, showToggle: false, showMin: false, isResize: false, title: '员工缺勤登记' });
	   	}catch(e){alert(e.message);}
    }
	...
	function markOneDataSet()
	{
    	...
    	var requestUrl ="ac016/markOneDataSet.action"; 
	...
	function dmarkOneDataSet()
	{
		...
		params =params+"&strStaffInNo="+curRecord.staffinid;
    	params =params+"&strCurMonth="+document.getElementById("strToDate").value.substring(0,4)+document.getElementById("strToDate").value.substring(5,7);	
    	var requestUrl ="ac016/dmarkOneDataSet.action"; 
	...
	function comfrimstopAbsence()
	{
    	...
    	var requestUrl ="ac016/comfrimstopAbsence.action"; 
