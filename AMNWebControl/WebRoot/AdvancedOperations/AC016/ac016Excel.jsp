...
<jsp:directive.page import="com.amani.action.AdvancedOperations.AC016Action"/>
<jsp:directive.page import="com.amani.service.AdvancedOperations.AC016Service"/>
<%
...
<%
	try{
		...
		AC016Action action=new AC016Action();
		...
		action.setAc016Service((AC016Service)request.getAttribute("AC016Service"));
