...
<head>
	...
	<script type="text/javascript" src="<%=ContextPath%>/InvoicingControl/IC001/ic002.js"></script>
		<style type="text/css">
...
<script language="JavaScript">
	 ...
	 function viewTicketReport()	{
	   ...
	   if(opener.document.getElementById("revicetype2").checked==true){
	   	document.getElementById("shop_print").innerHTML="门店";
	   ...
	   if(opener.document.getElementById("revicetype2").checked==true){
	   	document.getElementById("shop_prints").innerHTML="门店";
	...
	function addRow_print(goodsClass,goodspricetype,outergoodsname,outercount,outerunit,outerprice,outerrate,outeramt,outgoodsno)
    {
	   ...
	   adjustAlignCenter("print_goodss",7);
	   adjustAlignCenter("print_goodss",4);
    }
