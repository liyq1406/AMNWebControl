...
<head>
	...
	<script type="text/javascript" src="<%=ContextPath%>/InvoicingControl/IC020/ic020.js"></script>
	<style type="text/css">
	  	...
	  	<div position="center" style="width:100%;"> 
	  		<table id="dataTable" border="0" cellspacing="1" cellpadding="0" style="font-size:12px;line-height:25px;">
				<tr>
				 	...
				 	<td width="85"><select name="projectKind" id="projectKind"  style="width:80;">
												<option value="003">003菲灵</option>
												</select></td>
					<td width="30">状态</td>
				 	<td><select name="status" id="status"  style="width:80;" >
				 								<option value="-1">所有</option>
												<option value="2">已分单</option>
