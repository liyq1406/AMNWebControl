...
<head>
	...
	<script type="text/javascript" src="<%=ContextPath%>/InvoicingControl/IC004/ic004.js"></script>
...
<body onLoad="initMap()">
	<div class="l-loading" style="display:block;height:100%;" id="pageloading"></div> 
	 <div id="ic004layout" style="width:100%;margin:0 auto; margin-top:0px;  "> 
							...
							<div  style="width:735; height:98%; float:left; clear:both; border:1px solid #ccc; overflow:auto;font-size:12px;  ">
									<table width="100%" border="0" cellspacing="1" cellpadding="0" style="font-size:12px;line-height:28px;" >
										<tr>
											...
											&nbsp;&nbsp;<input type="text"name="curMgoodsouter.boutercompname" id="boutercompname"   readonly="true" style="width:100;" />
											<input type="hidden" name="curMgoodsouter.orderbilltype" id="orderbilltype"  />
											</td>
										...
										<tr>
											...
											<td ><select name="curMgoodsouter.outerwareid" id="outerwareid"    style="width:120;" ><option value="03">自用品仓库</option><option value="05">总部行政仓库</option><option value="06">现金仓库</option></select></td>
									
											
											<td>&nbsp;&nbsp;<font color="blue">出库方式</font></td>
											<td colspan="2">  <input type="text" id="outertype" name="outertype" /> </td>
											
										</tr>
										
										<tr>	
											<td >&nbsp;&nbsp;出库日期</td>
											<td ><input type="text"name="curMgoodsouter.outerdate" id="outerdate"   readonly="true" style="width:120;" validate="{required:true,maxlength:10,notnull:false}"/>
											...
											<td colspan="2">
												...
												<input type="radio" id="revicetype2" name="curMgoodsouter.revicetype" value="2" style="border:0" onclick="changeReviceType()"/>门店
										...
										<tr>	
											<td >&nbsp;&nbsp;审核人员</td>
											<td><input type="text"name="curMgoodsouter.outeropationerid" id="outeropationerid"   readonly="true" style="width:120;" validate="{notnull:false}"/>
											<input type="hidden"name="curMgoodsouter.outeropationername" id="outeropationername"  />
										...
										<tr height="30">
											...
											&nbsp;&nbsp;数量
											<input type="text"name="winsergoodscount" id="winsergoodscount"    style="width:30;" onchange="loadGoodsGrid(this)"/>
											&nbsp;&nbsp;单价
											<input type="text"name="winsergoodsprice" id="winsergoodsprice"   readonly="true" style="width:30;" />
											&nbsp;&nbsp;当前库存
											<input type="text"name="wcurgoodsstock" id="wcurgoodsstock"   readonly="true" style="width:30;" />
											...
											<input type="hidden"name="wfrombarcode" id="wfrombarcode"  />
											<input type="hidden"name="wtobarcode" id="wtobarcode"   />
