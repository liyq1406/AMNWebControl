...
<script language="JavaScript">
	...
	try
	{
	   ...
	   { 
		   ...
		   sumClassGtb08f=maskAmt(sumClassGtb08f*1+opener.lsDgoodssendinfos[i].downordercount*1*opener.lsDgoodssendinfos[i].sendgoodprice,2);
	       ...
	       maskAmt(opener.lsDgoodssendinfos[i].downordercount*1*opener.lsDgoodssendinfos[i].sendgoodprice,2),
