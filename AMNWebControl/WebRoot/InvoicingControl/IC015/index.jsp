...
<head>
	...
	<script type="text/javascript" src="<%=ContextPath%>/InvoicingControl/IC015/ic015.js"></script>
...
<div class="l-loading" style="display:block" id="pageloading"></div> 
  	 ...
  	 <div id="ic015layout" style="width:100%; margin:0 auto; margin-top:4px; ">
	  	<div position="center"   id="designPanel"  style="width:100%;"> 
			...
			<tr>
				 ...
				 <td width="80">物品编号：</td>
				 <td >
						<input id="strGoodsNo" type="text" style="width:140"/>
				 </td>
				 <td width="80">物品条码：</td>
				 <td >
						<input id="strGoodsBarNo" type="text" style="width:140"/>
				 </td>
				<td width="80">条码状态：</td>
				 <td >
						<select id="iBarState"  style="width:140">
							<option value="-1">所有</option>
							<option value="0">生成</option>
							<option value="1">入库</option>
							<option value="2">发货/出库</option>
				 ...
				 <td>
				 	<div id="addProdDateButton"></div>
				 </td>
			</tr>
			<tr><td style="border-bottom:1px #000000 dashed" colspan="8"></td></tr>

			</table>
			<div id="commoninfodivGoodsBarStockDate" style="margin:0; padding:0"></div>
		</div>
