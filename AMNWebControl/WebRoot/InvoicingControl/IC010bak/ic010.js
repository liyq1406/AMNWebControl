    ...
    $(function ()
	   ...
	   {  
        	...
        	commoninfodivdetial=$("#commoninfodivdetial").ligerGrid({
                ...
                { display: '产品名称', 	name: 'sendgoodsname',  			width:250,align: 'left' },
                ...
                onDblClickRow : function (data, rowindex, rowobj)
                {
                  ...
                  toolbar: { items: [
	                		 { text: '<font color="blue">单一产品条码</font>:&nbsp;<input type="text" id="onebarNo" name="onebarNo" style="width:140" onchange="validateOneBar(this)"/> '},
          ...
          /* commoninfodivdetial_pcinser=$("#commoninfodivdetial_pcinser").ligerGrid({
           ...
           commoninfodivdetial_barcode=$("#commoninfodivdetial_barcode").ligerGrid({
                ...
                { display: '起始条码', 	name: 'frombarcode',  			width:110,align: 'left' },
                { display: '结束条码', 	name: 'tobarcode', 				width:110,align: 'left'},
