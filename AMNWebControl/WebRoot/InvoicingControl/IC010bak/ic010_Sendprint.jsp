...
<script language="JavaScript">
	...
	try
	{
	   ...
	   { 
	       ...
	       sumClassGtb06f=sumClassGtb06f*1+opener.lsDgoodssendinfos[i].sendgoodscount*1;
		   sumClassGtb08f=ForDight(sumClassGtb08f*1+opener.lsDgoodssendinfos[i].sendgoodscount*1*opener.lsDgoodssendinfos[i].sendgoodprice,1);
	       ...
	       opener.lsDgoodssendinfos[i].sendgoodscount,opener.lsDgoodssendinfos[i].sendgoodsunit,
	       opener.lsDgoodssendinfos[i].sendgoodprice,opener.lsDgoodssendinfos[i].sendgoodrate,
	       ForDight(opener.lsDgoodssendinfos[i].sendgoodscount*1*opener.lsDgoodssendinfos[i].sendgoodprice,1),
	       opener.lsDgoodssendinfos[i].sendgoodsno);
	       
	       sumGtb06f+=ForDight(opener.lsDgoodssendinfos[i].sendgoodscount*1*opener.lsDgoodssendinfos[i].sendgoodprice*1,1);
	       sumGtb08f+=ForDight(opener.lsDgoodssendinfos[i].sendgoodscount*1,1);
	   }
	   if(goodsClass!="")
	   {
	   		addRow_print(goodsClass,"小计", "--",sumClassGtb06f ,"--", "--","--",sumClassGtb08f,"--");
