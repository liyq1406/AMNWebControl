...
<head>
	...
	<script type="text/javascript" src="<%=ContextPath%>/InvoicingControl/IC013/ic013.js"></script>
...
<div class="l-loading" style="display:block" id="pageloading"></div> 
  	 ...
  	 <div id="ic013layout" style="width:100%; margin:0 auto; margin-top:4px; ">
	  	<div position="center"   id="designPanel"  style="width:100%;"> 
			...
			<tr>
				 ...
				 <td >物品编号：</td>
				 <td >
						<input id="strFromGoodsNo" type="text" style="width:120"/>
						－
						<input id="strToGoodsNo" type="text" style="width:120"/>
				 </td>
			...
			<div id="IC013Tab" style="width:100%; height:95%;  float:left; clear:both; border:1px solid #ccc; overflow:auto;font-size:12px;  "> 
				<div title="入库明细表" style=" ;font-size:12px;" >
					<div id="commoninfodivGoodsInserDate" style="margin:0; padding:0"></div>
				</div>
				<div title="入库分类明细表" style=";font-size:12px;" >
