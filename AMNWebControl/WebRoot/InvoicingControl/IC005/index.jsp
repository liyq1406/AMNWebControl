...
<head>
	...
	<script type="text/javascript" src="<%=ContextPath%>/InvoicingControl/IC005/ic005.js"></script>
...
<div class="l-loading" style="display:block" id="pageloading"></div> 
  	 ...
  	 <div id="ic005layout" style="width:100%; margin:0 auto; margin-top:4px; ">
	  	<div position="center"   id="designPanel"  style="width:100%;"> 
			...
			<tr>
				 ...
				 <td  width="40">物品</td>
				 <td >
						<input id="strFromGoodsNo" type="text" style="width:100"/>
						－
						<input id="strToGoodsNo" type="text" style="width:100"/>
				 </td>
