...
<head>
	...
	<script type="text/javascript" src="<%=ContextPath%>/InvoicingControl/IC022/ic022.js"></script>
	<style type="text/css">
	  	...
	  	<div position="center" style="width:100%;"> 
	  		<table id="dataTable" border="0" cellspacing="1" cellpadding="0" style="font-size:12px;line-height:25px;">
				<tr>
				 	...
				 	<td width="27">产品</td>
				 	<%--<td width="228"><select name="projectKind" id="projectKind"  style="width:228;">
							<s:iterator value="goodsList" id="goods">
				 	<option value="<s:property value="#goods.attr1" />"><s:property value="#goods.attr1" />-<s:property value="#goods.attr2" /></option>
				 			</s:iterator>				
							</select></td>
				 	--%><td width="228"><input type="text" name="projectKind" id="projectKind"  style="width:228;" /></td>
