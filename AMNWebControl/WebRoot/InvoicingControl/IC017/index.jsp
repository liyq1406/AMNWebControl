...
<head>
	...
	<script type="text/javascript" src="<%=ContextPath%>/InvoicingControl/IC017/ic017.js"></script>
...
<div class="l-loading" style="display:block" id="pageloading"></div> 
  	 ...
  	 <div id="ic017layout" style="width:100%; margin:0 auto; margin-top:4px; ">
	  	<div position="center"   id="designPanel"  style="width:100%;"> 
			...
			<tr>
				 ...
				 <td width="110">
				  ...
				  <td width="60">产品大类</td>
			     <td width="110"><select id="searchGoodsType"  name="searchGoodsType" style="width:100"></select></td>
				 <td width="60">物品编号：</td>
				 <td  >
						<input id="strFromGoodsNo" type="text" style="width:70"/>
						－
						<input id="strToGoodsNo" type="text" style="width:70"/>
				 </td>
			...
			<div id="commoninfodivSearch" style="margin:0; padding:0"></div>
		</div>
