...
<head>
	...
	<script type="text/javascript" src="<%=ContextPath%>/PersonnelControl/PC007/pc007.js"></script>
...
<div class="l-loading" style="display:block" id="pageloading"></div> 
  	 ...
  	 <div id="pc007layout" style="width:100%; margin:0 auto; margin-top:4px; ">
	  	<div position="center"   id="designPanel"  style="width:100%;"> 
			...
			<table id="showTable"  border="0" cellspacing="1" cellpadding="0" style="font-size:12px;line-height:25px;" >
			<tr>
				<td valign="top"><div id="commoninfodivStaffDate" style="margin:0; padding:0"></div></td>
