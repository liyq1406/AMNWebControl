		...
		$(function ()
   		{
	     	...
	     	document.getElementById("leavestaffno").value=parent.curLoginUserNo;
	     	document.getElementById("leavestaffname").value=parent.curLoginUserName;
			...
			addOption("","",document.getElementById("fromtime"));
           	...
           	addOption("19:30","19:30",document.getElementById("fromtime"));
           	addOption("20:00","20:00",document.getElementById("fromtime"));
           	addOption("20:30","20:30",document.getElementById("fromtime"));
           	addOption("21:00","21:00",document.getElementById("fromtime"));
           	addOption("21:30","21:30",document.getElementById("fromtime"));
	     ...
	     function handStaffLeave()
	     {
	     	...
	     	/*try
	     	{
	    		...
	    		var requestUrl ="pc001/handStaffLeave.action";
