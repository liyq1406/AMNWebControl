...
<html xmlns="http://www.w3.org/1999/xhtml">
  ...
  <body style="margin:0;">
	...
	<tr>
		<td  height="30" align="center" ><font size="2" style="padding-top:2px;"><b>　<员工调动>审查表</b></font></td>
	</tr>

	</table>

	<table border="0" cellspacing="1" cellpadding="0" style=" font-size:16px; border:1px solid #000; padding:3px;line-height:28px;"  width="95%">
			<tr>
			...
			<tr >
			<td  colspan="2" align="left">&nbsp;&nbsp;&nbsp;身份证号码：<label id="staffpCDID">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</label></td>
			
			</tr>
				<tr >
			<td align="left">&nbsp;&nbsp;&nbsp;原门店：<label id="oldcompno">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</label></td>
			<td align="left">&nbsp;&nbsp;&nbsp;新门店：<label id="newcompno">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</label></td>
			</tr>
			<tr >
...
if(parent.curRecord.bchangetype==5)
	document.getElementById("changetype").innerHTML="本店调动";
else
	document.getElementById("changetype").innerHTML="跨店调动";
	
document.getElementById("oldcompno").innerHTML=parent.curRecord.appchangecompname;
document.getElementById("newcompno").innerHTML=parent.curRecord.aftercompname;	
...
document.getElementById("olddepartments").innerHTML=parent.parent.loadCommonControlValue('BMZL',0, parent.curRecord.beforedepartment);
document.getElementById("newdepartments").innerHTML=parent.parent.loadCommonControlValue('BMZL',0, parent.curRecord.afterdepartment);
document.getElementById("oldjobs").innerHTML=parent.parent.loadCommonControlValue('GZGW',0, parent.curRecord.beforepostation);
...
document.getElementById("newjobs").innerHTML=parent.parent.loadCommonControlValue('GZGW',0, parent.curRecord.afterpostation); 
...
document.getElementById("beforeyejitype").innerHTML=parent.parent.loadCommonControlValue('YJFS',0, parent.curRecord.beforeyejitype); 

document.getElementById("afteryejitype").innerHTML=parent.parent.loadCommonControlValue('YJFS',0, parent.curRecord.afteryejitype); 
