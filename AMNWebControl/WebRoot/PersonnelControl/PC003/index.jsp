...
<head>
	...
	<script type="text/javascript" src="<%=ContextPath%>/PersonnelControl/PC003/pc003.js"></script>
...
<div class="l-loading" style="display:block" id="pageloading"></div> 
  	 ...
  	 <div id="pc003layout" style="width:100%; margin:0 auto; margin-top:4px; ">
	  	<div position="center"   id="designPanel"  style="width:100%;"> 
				...
				<td  width="40">类型</td>
				 <td> 
				 	<select id="iSearchType" style="border:0px solid #99CC33; font-size:12px;line-height:14px; color:#333; width:100;"name="iSearchType" >
									...
									<option value="0">薪资调整</option>
									<option value="1">离职申请</option>
									<option value="2">入职申请</option>
									<option value="3">重回公司</option>
			...
			<td width="50%"><div id="comfirmValodateButton"></div></td>
			</tr>
			</table>		
		</div>
