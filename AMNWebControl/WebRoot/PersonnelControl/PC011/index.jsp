...
<head>
	...
	<script type="text/javascript" src="<%=ContextPath%>/PersonnelControl/PC011/pc011.js"></script>
...
<div class="l-loading" style="display:block" id="pageloading"></div> 
  	 ...
  	 <div id="pc011layout" style="width:100%; margin:0 auto; margin-top:4px; ">
	  	<div position="center"   id="designPanel"  style="width:100%;"> 
			...
			<tr>
				 ...
				 <td width="130">
						...
						<input id="strToDate" type="hidden"  />
				 </td>
