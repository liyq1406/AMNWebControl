...
<head>
	...
	<script type="text/javascript" src="<%=ContextPath%>/PersonnelControl/PC024/pc024.js"></script>
	<style type="text/css">
...
<body>
	...
	<div id="pc024layout" style="width:100%; margin:0 auto; margin-top:4px;">
	  		...
	  		<table id="showTable"  border="0" cellspacing="1" cellpadding="0" style="font-size:12px;line-height:25px;">
				<tr>
				 	<td width="600"><div><%@include file="/common/search.frag"%></div></td>
				  	<td width="150"><div id="searchButton"></div></td>
