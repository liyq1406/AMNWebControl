...
<head>
	...
	<script type="text/javascript" src="<%=ContextPath%>/PersonnelControl/PC008/pc008.js"></script>
...
<div class="l-loading" style="display:block" id="pageloading"></div> 
  	 ...
  	 <div id="pc008layout" style="width:100%; margin:0 auto; margin-top:4px; ">
	  	<div position="center"   id="designPanel"  style="width:100%;"> 
			...
			<tr>
				 ...
				 <td ><div id="searchButton"></div></td>
				  <td ><div id="markButton"></div></td>
				  <td ><div id="dmarkButton"></div></td>
