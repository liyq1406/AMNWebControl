...
<head>
	...
	<script type="text/javascript" src="<%=ContextPath%>/PersonnelControl/PC013/pc013.js"></script>
...
<div class="l-loading" style="display:block" id="pageloading"></div> 
  	 ...
  	 <div id="pc013layout" style="width:100%; margin:0 auto; margin-top:4px; ">
	  	<div position="center"   id="designPanel"  style="width:100%;"> 
			...
			<tr>
				 ...
				 <td width="130">
				  ...
				  <td width="80">显示类型：</td>
				  <td>
				  		<input id="targetcount"  name="targetcount" type="text" size="10"  value="100" onchange="validatePrice(this)" />
				  </td>
