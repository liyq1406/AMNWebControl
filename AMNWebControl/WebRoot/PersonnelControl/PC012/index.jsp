...
<head>
	...
	<script type="text/javascript" src="<%=ContextPath%>/PersonnelControl/PC012/pc012.js"></script>
...
<div class="l-loading" style="display:block" id="pageloading"></div> 
  	 ...
  	 <div id="pc012layout" style="width:100%; margin:0 auto; margin-top:4px; ">
