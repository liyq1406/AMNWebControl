...
<head>
	...
	<script type="text/javascript" src="<%=ContextPath%>/PersonnelControl/PC020/pc020.js"></script>
...
<div class="l-loading" style="display:block" id="pageloading"></div> 
  	 ...
  	 <div id="pc020layout" style="width:100%; margin:0 auto; margin-top:4px; ">
	  	<div position="center"   id="designPanel"  style="width:100%;"> 
			...
			<tr>
				 ...
				 <td width="40">类型：</td>
				  <td width="100">
				 	<select id="strSearchType" name="strSearchType" style="width:100"></select>
				 </td>	
				 <td width="100">
				 ...
				 <td width="40">员工：</td>
				 <td width="100">
						<input id="strSearchStaffNo" type="text" style="width:60" />
				 </td>
