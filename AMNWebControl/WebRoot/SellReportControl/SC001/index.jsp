...
<head>
	...
	<script type="text/javascript" src="<%=ContextPath%>/SellReportControl/SC001/sc001.js"></script>
...
<div class="l-loading" style="display:block" id="pageloading"></div> 
  	 ...
  	 <div id="sc001layout" style="width:100%; margin:0 auto; margin-top:4px; ">
	  	<div position="center"   id="designPanel"  style="width:100%;"> 
			...
			<tr>
				 ...
				 <td width="130">
				  ...
				  <td width="60">显示类型：</td>
				  <td>
				  		<select id="strSearchType" style="border:0px solid #99CC33; font-size:12px;line-height:14px; color:#333;"name="strSearchType" >
									<option value="1">按门店显示</option>
									<option value="2">按日期显示</option>
						</select>
				  </td>
