...
<head>
	...
	<script type="text/javascript" src="<%=ContextPath%>/SellReportControl/SC013/sc013.js"></script>
...
<div class="l-loading" style="display:block" id="pageloading"></div> 
  	 ...
  	 <div id="sc013layout" style="width:100%; margin:0 auto; margin-top:4px; ">
	  	<div position="center"   id="designPanel"  style="width:100%;"> 
			...
			<tr>
				 ...
				 <td width="80">查询年份：</td>
				 <td width="120">
				 <select id="strFromDate" name ="strFromDate" style="width:100">
			...
			<div id="SC013Tab" style="width:100%; height:95%;  float:left; clear:both; border:1px solid #ccc; overflow:auto;font-size:12px;  "> 
			<div title="分析明细表" style=" ;font-size:12px;" >
				<div id="commoninfodivPjDate" style="margin:0; padding:0"></div>		
			</div>
			<div title="门店分类业绩图形" style=";font-size:12px;" >
				<div id="containerCalssYeji" style="width: 100%; height: 600px; margin: 0 auto"></div>
			</div>
			<div title="门店数据分析" style=";font-size:12px;" >
				<div id="containerNum" style="width: 100%; height: 600px; margin: 0 auto"></div>
			</div>
			</div>
		</div>
