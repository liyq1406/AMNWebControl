...
<head>
	...
	<script type="text/javascript" src="<%=ContextPath%>/SellReportControl/SC007/sc007.js"></script>
...
<div class="l-loading" style="display:block" id="pageloading"></div> 
  	 ...
  	 <div id="sc007layout" style="width:100%; margin:0 auto; margin-top:4px; ">
	  	<div position="center"   id="designPanel"  style="width:100%;"> 
			...
			<tr>
				 ...
				 <td >前&nbsp;&nbsp;<input id="iBeforCount" type="text" style="width:25" value="10"/>&nbsp;&nbsp;名</td>
				 <td >项目金额&nbsp;&nbsp;
						<input id="dPrjFromCostAmt" type="text" style="width:50" value="0" />-
						<input id="dPrjToCostAmt" type="text" style="width:50" value="1000" />
				 </td>
				 <td >产品金额&nbsp;&nbsp;
						<input id="dGoodsFromCostAmt" type="text" style="width:50" value="0" />-
						<input id="dGoodsToCostAmt" type="text" style="width:50" value="1000" />
				 </td>
