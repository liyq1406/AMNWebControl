...
<head>
	...
	<script type="text/javascript" src="<%=ContextPath%>/SellReportControl/SC015/sc015.js"></script>
...
<div class="l-loading" style="display:block" id="pageloading"></div> 
  	 ...
  	 <div id="sc014layout" style="width:100%; margin:0 auto; margin-top:4px; ">
	  	<div position="center"   id="designPanel"  style="width:100%;"> 
			...
			<tr>
				 ...
				 <td width="130">
				 	查看类型:<select id="ntype"> 
				 		<option value="1" checked="checked" >按门店</option>
				 		<option value="2">按套餐</option>
				 	</select>
				 </td>
