...
<head>
	...
	<script type="text/javascript" src="<%=ContextPath%>/SellReportControl/SC012/sc012.js"></script>
...
<div class="l-loading" style="display:block" id="pageloading"></div> 
  	 ...
  	 <div id="sc012layout" style="width:100%; margin:0 auto; margin-top:4px; ">
	  	<div position="center"   id="designPanel"  style="width:100%;"> 
			...
			<tr>
				 ...
				 <td>
				  		<select id="searchType" style="border:0px solid #99CC33; font-size:12px;line-height:14px; color:#333;"name="searchType" >
									<option value="1">开卡</option>
									<option value="2">充值</option>
									<option value="3">折扣转卡</option>
									<option value="4">收购转卡</option>
									<option value="5">竞争转卡</option>
									<option value="6">老卡并老卡</option>
									<option value="7">老卡并新卡</option>
									<option value="8">退卡</option>
									<option value="9">疗程兑换</option>
									<option value="10">遗失补卡</option>
						</select>
				  </td>
